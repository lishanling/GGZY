...
namespace GGZY.DataService {
    ...
    public partial class AppV1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public AppV1() {
            this.Url = "http://218.66.59.166:11124/Credit_OpenService/AppV1.asmx";
        }
        ...
        public string SubmitPunishment(string token, string ticket, string org, string biz, string measure, string amountInvolved, string actualOrgUser, string timestamp, string sig) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginSubmitPunishment(string token, string ticket, string org, string biz, string measure, string amountInvolved, string actualOrgUser, string timestamp, string sig, System.AsyncCallback callback, object asyncState) {
        ...
        /// <remarks/>
        public void SubmitPunishmentAsync(string token, string ticket, string org, string biz, string measure, string amountInvolved, string actualOrgUser, string timestamp, string sig) {
            this.SubmitPunishmentAsync(token, ticket, org, biz, measure, amountInvolved, actualOrgUser, timestamp, sig, null);
        }
        
        /// <remarks/>
        public void SubmitPunishmentAsync(string token, string ticket, string org, string biz, string measure, string amountInvolved, string actualOrgUser, string timestamp, string sig, object userState) {
