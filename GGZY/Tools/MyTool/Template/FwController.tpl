...
{
    public partial class Fw@(Model.FriendlyClassName)Controller:BaseController
    {
        /// <summary>
        ...
        {
            var result = Fw.@(Model.FriendlyClassName)Service.PageList(model, condition);           
...
c1+=",";
        ...
        {
            var result = Fw.@(Model.FriendlyClassName)Service.ViewByPk(@c1);
            return JResult(result);
        }
        /// <summary>
        ...
        {
            var result = Fw.@(Model.FriendlyClassName)Service.Add(model);
            return JResult(result);
        }
        /// <summary>
        ...
        {
            var result = Fw.@(Model.FriendlyClassName)Service.Edit(model);
            return JResult(result);
        }
        /// <summary>
        ...
        {
            var result = Fw.@(Model.FriendlyClassName)Service.Delete(ids);
            return JResult(result); 
        }
    }
}