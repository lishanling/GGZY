...
{
    /// <summary>
    /// 实体类XX_QUALI_INQUERY_CLARI。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("XX_QUALI_INQUERY_CLARI")]
    [Serializable]
    public partial class XX_QUALI_INQUERY_CLARI : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "XX_QUALI_INQUERY_CLARI");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "XX_QUALI_INQUERY_CLARI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "XX_QUALI_INQUERY_CLARI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "XX_QUALI_INQUERY_CLARI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "XX_QUALI_INQUERY_CLARI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "XX_QUALI_INQUERY_CLARI", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "XX_QUALI_INQUERY_CLARI", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 相关统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODES = new Field("UNIFIED_DEAL_CODES", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "相关统一交易标识码");
            /// <summary>
			/// 文件编号
			/// </summary>
			public readonly static Field DOC_CODE = new Field("DOC_CODE", "XX_QUALI_INQUERY_CLARI", "文件编号");
            /// <summary>
			/// 文件名称
			/// </summary>
			public readonly static Field DOC_NAME = new Field("DOC_NAME", "XX_QUALI_INQUERY_CLARI", "文件名称");
            /// <summary>
			/// 申请资格
			/// </summary>
			public readonly static Field APPLICANT_QUALIFICATIONS = new Field("APPLICANT_QUALIFICATIONS", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "申请资格");
            /// <summary>
			/// 申请有效期
			/// </summary>
			public readonly static Field APPLICATION_VALID_TIME = new Field("APPLICATION_VALID_TIME", "XX_QUALI_INQUERY_CLARI", "申请有效期");
            /// <summary>
			/// 申请文件递交截止时间
			/// </summary>
			public readonly static Field DOC_SUBMIT_END_TIME = new Field("DOC_SUBMIT_END_TIME", "XX_QUALI_INQUERY_CLARI", "申请文件递交截止时间");
            /// <summary>
			/// 申请文件递交方法
			/// </summary>
			public readonly static Field DOC_SUBMIT_METHOD = new Field("DOC_SUBMIT_METHOD", "XX_QUALI_INQUERY_CLARI", "申请文件递交方法");
            /// <summary>
			/// 文件开启时间
			/// </summary>
			public readonly static Field DOC_OPEN_TIME = new Field("DOC_OPEN_TIME", "XX_QUALI_INQUERY_CLARI", "文件开启时间");
            /// <summary>
			/// 文件开启方式
			/// </summary>
			public readonly static Field DOC_OPEN_METHOD = new Field("DOC_OPEN_METHOD", "XX_QUALI_INQUERY_CLARI", "文件开启方式");
            /// <summary>
			/// 评审办法
			/// </summary>
			public readonly static Field EVALUATION_METHOD = new Field("EVALUATION_METHOD", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "评审办法");
            /// <summary>
			/// 对文件澄清与修改的主要内容
			/// </summary>
			public readonly static Field CLARIFY_CONTENT = new Field("CLARIFY_CONTENT", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "对文件澄清与修改的主要内容");
            /// <summary>
			/// 是否延期
			/// </summary>
			public readonly static Field IS_POSTPONE = new Field("IS_POSTPONE", "XX_QUALI_INQUERY_CLARI", "是否延期");
            /// <summary>
			/// 延期后开标时间
			/// </summary>
			public readonly static Field POST_OPEN_TIME = new Field("POST_OPEN_TIME", "XX_QUALI_INQUERY_CLARI", "延期后开标时间");
            /// <summary>
			/// 延期后开标地点
			/// </summary>
			public readonly static Field POST_OPEN_ADDRESS = new Field("POST_OPEN_ADDRESS", "XX_QUALI_INQUERY_CLARI", "延期后开标地点");
            /// <summary>
			/// 对资格预审澄清与修改的主要内容
			/// </summary>
			public readonly static Field TENDER_CLARIFY_CONTENT = new Field("TENDER_CLARIFY_CONTENT", "XX_QUALI_INQUERY_CLARI",DbType.AnsiString, null, "对资格预审澄清与修改的主要内容");
            /// <summary>
			/// 递交时间
			/// </summary>
			public readonly static Field TENDER_SUBMIT_TIME = new Field("TENDER_SUBMIT_TIME", "XX_QUALI_INQUERY_CLARI", "递交时间");
            /// <summary>
			/// 上传时间
			/// </summary>
			public readonly static Field SUBMIT_TIME = new Field("SUBMIT_TIME", "XX_QUALI_INQUERY_CLARI", "上传时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "XX_QUALI_INQUERY_CLARI", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "XX_QUALI_INQUERY_CLARI", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "XX_QUALI_INQUERY_CLARI", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "XX_QUALI_INQUERY_CLARI", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "XX_QUALI_INQUERY_CLARI", "公共服务平台标识码");
        }
        #endregion
	}
}