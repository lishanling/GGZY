...
{
    /// <summary>
    /// 实体类JT_GENRAL_CON_TENDER_FILE_01。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_GENRAL_CON_TENDER_FILE_01")]
    [Serializable]
    public partial class JT_GENRAL_CON_TENDER_FILE_01 : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_GENRAL_CON_TENDER_FILE_01");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_GENRAL_CON_TENDER_FILE_01", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 项目总工期
			/// </summary>
			public readonly static Field LIMITE_ALL_TIME = new Field("LIMITE_ALL_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "项目总工期");
            /// <summary>
			/// 工期单位
			/// </summary>
			public readonly static Field LIMITE_TIME_UNIT = new Field("LIMITE_TIME_UNIT", "JT_GENRAL_CON_TENDER_FILE_01", "工期单位");
            /// <summary>
			/// 第一信封随机确认方式
			/// </summary>
			public readonly static Field FIRST_ENVELOPES_CONFIRM = new Field("FIRST_ENVELOPES_CONFIRM", "JT_GENRAL_CON_TENDER_FILE_01", "第一信封随机确认方式");
            /// <summary>
			/// 中标候选人个数
			/// </summary>
			public readonly static Field WIN_BID_NUMBER = new Field("WIN_BID_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "中标候选人个数");
            /// <summary>
			/// 是否须施工资质企业名录
			/// </summary>
			public readonly static Field QUALI_REQUIRE1 = new Field("QUALI_REQUIRE1", "JT_GENRAL_CON_TENDER_FILE_01", "是否须施工资质企业名录");
            /// <summary>
			/// 是否须提供企业资质信息
			/// </summary>
			public readonly static Field QUALI_REQUIRE2 = new Field("QUALI_REQUIRE2", "JT_GENRAL_CON_TENDER_FILE_01", "是否须提供企业资质信息");
            /// <summary>
			/// 未发生安全事故的时间要求
			/// </summary>
			public readonly static Field REPUTATION_TIME1 = new Field("REPUTATION_TIME1", "JT_GENRAL_CON_TENDER_FILE_01", "未发生安全事故的时间要求");
            /// <summary>
			/// 未出现不良记录时间要求
			/// </summary>
			public readonly static Field REPUTATION_TIME2 = new Field("REPUTATION_TIME2", "JT_GENRAL_CON_TENDER_FILE_01", "未出现不良记录时间要求");
            /// <summary>
			/// 项目经理职称专业
			/// </summary>
			public readonly static Field MANAGER_TITLE = new Field("MANAGER_TITLE", "JT_GENRAL_CON_TENDER_FILE_01", "项目经理职称专业");
            /// <summary>
			/// 项目经理职称等级
			/// </summary>
			public readonly static Field MANAGER_TITLE_LEVEL = new Field("MANAGER_TITLE_LEVEL", "JT_GENRAL_CON_TENDER_FILE_01", "项目经理职称等级");
            /// <summary>
			/// 注册建造师专业名称
			/// </summary>
			public readonly static Field CONSTRUCTOR_MAJOR = new Field("CONSTRUCTOR_MAJOR", "JT_GENRAL_CON_TENDER_FILE_01", "注册建造师专业名称");
            /// <summary>
			/// 注册建造师等级
			/// </summary>
			public readonly static Field CONSTRUCTOR_MAJOR_LEVEL = new Field("CONSTRUCTOR_MAJOR_LEVEL", "JT_GENRAL_CON_TENDER_FILE_01", "注册建造师等级");
            /// <summary>
			/// 项目经理年龄
			/// </summary>
			public readonly static Field MANAGER_AGE = new Field("MANAGER_AGE", "JT_GENRAL_CON_TENDER_FILE_01", "项目经理年龄");
            /// <summary>
			/// 技术负责人职称专业
			/// </summary>
			public readonly static Field TECH_TITLE = new Field("TECH_TITLE", "JT_GENRAL_CON_TENDER_FILE_01", "技术负责人职称专业");
            /// <summary>
			/// 技术负责人职称等级
			/// </summary>
			public readonly static Field TECH_TITLE_LEVEL = new Field("TECH_TITLE_LEVEL", "JT_GENRAL_CON_TENDER_FILE_01", "技术负责人职称等级");
            /// <summary>
			/// 技术负责人年龄
			/// </summary>
			public readonly static Field TECH_AGE = new Field("TECH_AGE", "JT_GENRAL_CON_TENDER_FILE_01", "技术负责人年龄");
            /// <summary>
			/// E1值
			/// </summary>
			public readonly static Field E1_NUMBER = new Field("E1_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "E1值");
            /// <summary>
			/// E2值
			/// </summary>
			public readonly static Field E2_NUMBER = new Field("E2_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "E2值");
            /// <summary>
			/// 工期延误的违约金
			/// </summary>
			public readonly static Field DELAY_PENALTY = new Field("DELAY_PENALTY", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "工期延误的违约金");
            /// <summary>
			/// 逾期付款违约金的利率
			/// </summary>
			public readonly static Field LIQUID_DAMAGE_RATE = new Field("LIQUID_DAMAGE_RATE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "逾期付款违约金的利率");
            /// <summary>
			/// 进度付款证书最低限额
			/// </summary>
			public readonly static Field MINIMUM_LIMIT = new Field("MINIMUM_LIMIT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "进度付款证书最低限额");
            /// <summary>
			/// 缺陷责任期
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD = new Field("DEFECT_LIABILITY_PERIOD", "JT_GENRAL_CON_TENDER_FILE_01", "缺陷责任期");
            /// <summary>
			/// 总计划开工日期
			/// </summary>
			public readonly static Field BEGIN_ALL_DATE = new Field("BEGIN_ALL_DATE", "JT_GENRAL_CON_TENDER_FILE_01", "总计划开工日期");
            /// <summary>
			/// 计划交工日期
			/// </summary>
			public readonly static Field END_DATE = new Field("END_DATE", "JT_GENRAL_CON_TENDER_FILE_01", "计划交工日期");
            /// <summary>
			/// 资金落实情况
			/// </summary>
			public readonly static Field FUND_IMPLEMENTATION = new Field("FUND_IMPLEMENTATION", "JT_GENRAL_CON_TENDER_FILE_01", "资金落实情况");
            /// <summary>
			/// 项目总标段个数
			/// </summary>
			public readonly static Field TOTAL_SECTION_NUMBER = new Field("TOTAL_SECTION_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "项目总标段个数");
            /// <summary>
			/// 本次招标标段个数
			/// </summary>
			public readonly static Field TENDERER_BID_SECTION = new Field("TENDERER_BID_SECTION", "JT_GENRAL_CON_TENDER_FILE_01", "本次招标标段个数");
            /// <summary>
			/// 工程预算审核价
			/// </summary>
			public readonly static Field CONSTRUCTION_BUDGET_PRICE = new Field("CONSTRUCTION_BUDGET_PRICE", "JT_GENRAL_CON_TENDER_FILE_01", "工程预算审核价");
            /// <summary>
			/// 发包价
			/// </summary>
			public readonly static Field CONTRACT_PRICE = new Field("CONTRACT_PRICE", "JT_GENRAL_CON_TENDER_FILE_01", "发包价");
            /// <summary>
			/// 每个投标人最多投标标段数
			/// </summary>
			public readonly static Field CONTRACT_SEGMENT = new Field("CONTRACT_SEGMENT", "JT_GENRAL_CON_TENDER_FILE_01", "每个投标人最多投标标段数");
            /// <summary>
			/// 每个投标人最多中标标段数
			/// </summary>
			public readonly static Field TENDER_NUMBER = new Field("TENDER_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "每个投标人最多中标标段数");
            /// <summary>
			/// 保证金户名
			/// </summary>
			public readonly static Field MARGIN_NAME = new Field("MARGIN_NAME", "JT_GENRAL_CON_TENDER_FILE_01", "保证金户名");
            /// <summary>
			/// 保证金账号
			/// </summary>
			public readonly static Field MARGIN_NUMBER = new Field("MARGIN_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "保证金账号");
            /// <summary>
			/// 开户银行
			/// </summary>
			public readonly static Field MARGIN_BANK = new Field("MARGIN_BANK", "JT_GENRAL_CON_TENDER_FILE_01", "开户银行");
            /// <summary>
			/// 投标保证金递交截止时间
			/// </summary>
			public readonly static Field MARGIN_TIME = new Field("MARGIN_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "投标保证金递交截止时间");
            /// <summary>
			/// 采用电汇形式保证金计息方式
			/// </summary>
			public readonly static Field INTEREST_MODE = new Field("INTEREST_MODE", "JT_GENRAL_CON_TENDER_FILE_01", "采用电汇形式保证金计息方式");
            /// <summary>
			/// 保证金利息计算周期
			/// </summary>
			public readonly static Field INTEREST_CALCULATION_CYCLE = new Field("INTEREST_CALCULATION_CYCLE", "JT_GENRAL_CON_TENDER_FILE_01", "保证金利息计算周期");
            /// <summary>
			/// 年化利率
			/// </summary>
			public readonly static Field MONEY_RATE = new Field("MONEY_RATE", "JT_GENRAL_CON_TENDER_FILE_01", "年化利率");
            /// <summary>
			/// 其他发布媒体1
			/// </summary>
			public readonly static Field MEDIA1 = new Field("MEDIA1", "JT_GENRAL_CON_TENDER_FILE_01", "其他发布媒体1");
            /// <summary>
			/// 其他发布媒体2
			/// </summary>
			public readonly static Field MEDIA2 = new Field("MEDIA2", "JT_GENRAL_CON_TENDER_FILE_01", "其他发布媒体2");
            /// <summary>
			/// 评标办法评审因素和评审标准
			/// </summary>
			public readonly static Field EVALUATING_METHOD_STANDARD = new Field("EVALUATING_METHOD_STANDARD", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "评标办法评审因素和评审标准");
            /// <summary>
			/// 材料价格是否调整
			/// </summary>
			public readonly static Field MATERIAL_PRICE_ADJUSTED = new Field("MATERIAL_PRICE_ADJUSTED", "JT_GENRAL_CON_TENDER_FILE_01", "材料价格是否调整");
            /// <summary>
			/// 基期价格参考城市
			/// </summary>
			public readonly static Field BASE_PRICE_CITY = new Field("BASE_PRICE_CITY", "JT_GENRAL_CON_TENDER_FILE_01", "基期价格参考城市");
            /// <summary>
			/// 发布价参考城市
			/// </summary>
			public readonly static Field RELEASE_PRICE_CITY = new Field("RELEASE_PRICE_CITY", "JT_GENRAL_CON_TENDER_FILE_01", "发布价参考城市");
            /// <summary>
			/// 未涉及材料发布价参考城市
			/// </summary>
			public readonly static Field NO_RELEASE_PRICE_CITY = new Field("NO_RELEASE_PRICE_CITY", "JT_GENRAL_CON_TENDER_FILE_01", "未涉及材料发布价参考城市");
            /// <summary>
			/// 缺陷责任期
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD1 = new Field("DEFECT_LIABILITY_PERIOD1", "JT_GENRAL_CON_TENDER_FILE_01", "缺陷责任期");
            /// <summary>
			/// 是否需要人员到场
			/// </summary>
			public readonly static Field OPEN_BID_REQURE_CHOOSE = new Field("OPEN_BID_REQURE_CHOOSE", "JT_GENRAL_CON_TENDER_FILE_01", "是否需要人员到场");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "JT_GENRAL_CON_TENDER_FILE_01", "监督部门名称");
            /// <summary>
			/// 监督部门联系电话
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_PHONE = new Field("SUPERVISE_DEPT_PHONE", "JT_GENRAL_CON_TENDER_FILE_01", "监督部门联系电话");
            /// <summary>
			/// 监督部门地址
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ADDRESS = new Field("SUPERVISE_DEPT_ADDRESS", "JT_GENRAL_CON_TENDER_FILE_01", "监督部门地址");
            /// <summary>
			/// 监督部门邮编
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ZIP_CODE = new Field("SUPERVISE_DEPT_ZIP_CODE", "JT_GENRAL_CON_TENDER_FILE_01", "监督部门邮编");
            /// <summary>
			/// 交工验收质量要求
			/// </summary>
			public readonly static Field QUALITY_REQUIRE1 = new Field("QUALITY_REQUIRE1", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "交工验收质量要求");
            /// <summary>
			/// 竣工验收质量要求
			/// </summary>
			public readonly static Field QUALITY_REQUIRE2 = new Field("QUALITY_REQUIRE2", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "竣工验收质量要求");
            /// <summary>
			/// 联合体成员数量要求
			/// </summary>
			public readonly static Field SYNDICATED_NUMBER = new Field("SYNDICATED_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "联合体成员数量要求");
            /// <summary>
			/// 投标人提出问题的截止时间
			/// </summary>
			public readonly static Field QUESTION_TIME = new Field("QUESTION_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "投标人提出问题的截止时间");
            /// <summary>
			/// 投标人要求澄清招标文件的截止时间
			/// </summary>
			public readonly static Field BIDDER_NOTICE_TIME = new Field("BIDDER_NOTICE_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "投标人要求澄清招标文件的截止时间");
            /// <summary>
			/// 是否允许分包
			/// </summary>
			public readonly static Field SUBCONTRACT = new Field("SUBCONTRACT", "JT_GENRAL_CON_TENDER_FILE_01", "是否允许分包");
            /// <summary>
			/// 招标人书面澄清的时间
			/// </summary>
			public readonly static Field TENDER_NOTICE_TIME = new Field("TENDER_NOTICE_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "招标人书面澄清的时间");
            /// <summary>
			/// 招标文件修改截止时间
			/// </summary>
			public readonly static Field MODIFICATION_TIME = new Field("MODIFICATION_TIME", "JT_GENRAL_CON_TENDER_FILE_01", "招标文件修改截止时间");
            /// <summary>
			/// 近年财务状况的年份要求
			/// </summary>
			public readonly static Field FINANCIAL_YEAR_REQUIRE = new Field("FINANCIAL_YEAR_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "近年财务状况的年份要求");
            /// <summary>
			/// 近年完成的类似项目的年份要求
			/// </summary>
			public readonly static Field SIMILAR_PROJECT_YEAR_REQUIRE = new Field("SIMILAR_PROJECT_YEAR_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "近年完成的类似项目的年份要求");
            /// <summary>
			/// 发生的诉讼及仲裁情况的起始年份要求
			/// </summary>
			public readonly static Field LITIGATION_REQUIRE = new Field("LITIGATION_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01", "发生的诉讼及仲裁情况的起始年份要求");
            /// <summary>
			/// 近年发生的行贿犯罪记录查询的年份要求
			/// </summary>
			public readonly static Field BRIBERY_RECORD_YEAR = new Field("BRIBERY_RECORD_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "近年发生的行贿犯罪记录查询的年份要求");
            /// <summary>
			/// 投标文件副本份数
			/// </summary>
			public readonly static Field COPY_NUMBER = new Field("COPY_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "投标文件副本份数");
            /// <summary>
			/// 投标文件解密方式
			/// </summary>
			public readonly static Field DECRYPTION_TYPE = new Field("DECRYPTION_TYPE", "JT_GENRAL_CON_TENDER_FILE_01", "投标文件解密方式");
            /// <summary>
			/// 第二封信开标程序
			/// </summary>
			public readonly static Field SEC_ENVELOPES_OPEN = new Field("SEC_ENVELOPES_OPEN", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "第二封信开标程序");
            /// <summary>
			/// 评标委员会人数
			/// </summary>
			public readonly static Field ALL_EXPERT_NUM = new Field("ALL_EXPERT_NUM", "JT_GENRAL_CON_TENDER_FILE_01", "评标委员会人数");
            /// <summary>
			/// 招标人代表人数
			/// </summary>
			public readonly static Field TENDERER_NUM = new Field("TENDERER_NUM", "JT_GENRAL_CON_TENDER_FILE_01", "招标人代表人数");
            /// <summary>
			/// 专家人数
			/// </summary>
			public readonly static Field EXPERT_NUM = new Field("EXPERT_NUM", "JT_GENRAL_CON_TENDER_FILE_01", "专家人数");
            /// <summary>
			/// 评标专家确定方式
			/// </summary>
			public readonly static Field EXPERT_LIBRARY = new Field("EXPERT_LIBRARY", "JT_GENRAL_CON_TENDER_FILE_01", "评标专家确定方式");
            /// <summary>
			/// K值选定
			/// </summary>
			public readonly static Field K_NUMBER = new Field("K_NUMBER", "JT_GENRAL_CON_TENDER_FILE_01", "K值选定");
            /// <summary>
			/// 最高限价公布截止时间
			/// </summary>
			public readonly static Field HIGHEST_PRICE_DATE = new Field("HIGHEST_PRICE_DATE", "JT_GENRAL_CON_TENDER_FILE_01", "最高限价公布截止时间");
            /// <summary>
			/// 进入评标基准价计算的下限发布截止时间
			/// </summary>
			public readonly static Field LOWEST_PRICE_DATE = new Field("LOWEST_PRICE_DATE", "JT_GENRAL_CON_TENDER_FILE_01", "进入评标基准价计算的下限发布截止时间");
            /// <summary>
			/// 工程保险费率
			/// </summary>
			public readonly static Field PREMIUM_RATE1 = new Field("PREMIUM_RATE1", "JT_GENRAL_CON_TENDER_FILE_01", "工程保险费率");
            /// <summary>
			/// 第三方责任保险费率
			/// </summary>
			public readonly static Field PREMIUM_RATE2 = new Field("PREMIUM_RATE2", "JT_GENRAL_CON_TENDER_FILE_01", "第三方责任保险费率");
            /// <summary>
			/// 最低投保金额
			/// </summary>
			public readonly static Field INSURED_AMOUNT = new Field("INSURED_AMOUNT", "JT_GENRAL_CON_TENDER_FILE_01", "最低投保金额");
            /// <summary>
			/// 争议的最终解决方式
			/// </summary>
			public readonly static Field DISPUTE_DEAL_METHOD = new Field("DISPUTE_DEAL_METHOD", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "争议的最终解决方式");
            /// <summary>
			/// 仲裁委员会名称
			/// </summary>
			public readonly static Field ARB_COMMISSION_NAME = new Field("ARB_COMMISSION_NAME", "JT_GENRAL_CON_TENDER_FILE_01", "仲裁委员会名称");
            /// <summary>
			/// 资质最低条件
			/// </summary>
			public readonly static Field MINIMUM_QUALIFICATIONS = new Field("MINIMUM_QUALIFICATIONS", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "资质最低条件");
            /// <summary>
			/// 财务最低要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE = new Field("FINANCIAL_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "财务最低要求");
            /// <summary>
			/// 业绩最低要求
			/// </summary>
			public readonly static Field ACHIEVEMENT_REQUIRE = new Field("ACHIEVEMENT_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "业绩最低要求");
            /// <summary>
			/// 信誉最低要求
			/// </summary>
			public readonly static Field REPUTATION_REQUIRE = new Field("REPUTATION_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "信誉最低要求");
            /// <summary>
			/// 项目经理和技术负责人最低要求
			/// </summary>
			public readonly static Field QUALIFICATION_REQUIRE = new Field("QUALIFICATION_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "项目经理和技术负责人最低要求");
            /// <summary>
			/// 其他主要管理人员和技术人员最低要求
			/// </summary>
			public readonly static Field OTHER_QUALIFICATION_REQUIRE = new Field("OTHER_QUALIFICATION_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "其他主要管理人员和技术人员最低要求");
            /// <summary>
			/// 机械设备最低要求
			/// </summary>
			public readonly static Field EQUIPMENT_REQUIRE = new Field("EQUIPMENT_REQUIRE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "机械设备最低要求");
            /// <summary>
			/// 评标价
			/// </summary>
			public readonly static Field BID_EVALUATION = new Field("BID_EVALUATION", "JT_GENRAL_CON_TENDER_FILE_01", "评标价");
            /// <summary>
			/// 信用分
			/// </summary>
			public readonly static Field CREDIT = new Field("CREDIT", "JT_GENRAL_CON_TENDER_FILE_01", "信用分");
            /// <summary>
			/// 施工企业被评为信用等级AA的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_AA_YEAR = new Field("CREDIT_RATING_AA_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "施工企业被评为信用等级AA的年度");
            /// <summary>
			/// 施工企业被评为信用等级A的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_A_YEAR = new Field("CREDIT_RATING_A_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "施工企业被评为信用等级A的年度");
            /// <summary>
			/// 施工企业被评为信用等级B的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_B_YEAR = new Field("CREDIT_RATING_B_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "施工企业被评为信用等级B的年度");
            /// <summary>
			/// 施工企业未参加福建省交通建设市场信用考核的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_W_YEAR = new Field("CREDIT_RATING_W_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "施工企业未参加福建省交通建设市场信用考核的年度");
            /// <summary>
			/// 项目经理未参加福建省交通建设市场信用考核的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_BW_YEAR = new Field("CREDIT_RATING_BW_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "项目经理未参加福建省交通建设市场信用考核的年度");
            /// <summary>
			/// 施工企业被评为信用等级为C、D级的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_CD_YEAR = new Field("CREDIT_RATING_CD_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "施工企业被评为信用等级为C、D级的年度");
            /// <summary>
			/// 高速公路路基土建施工工程评为A级或AA级且未参与同年普通公路考核的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_AAAW_YEAR = new Field("CREDIT_RATING_AAAW_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "高速公路路基土建施工工程评为A级或AA级且未参与同年普通公路考核的年度");
            /// <summary>
			/// 普通公路建设项目或高速公路工程项目（未参与普通公路养护工程考核）信用考核被评为A、AA级的年度
			/// </summary>
			public readonly static Field CREDIT_RATING_AAA_YEAR = new Field("CREDIT_RATING_AAA_YEAR", "JT_GENRAL_CON_TENDER_FILE_01", "普通公路建设项目或高速公路工程项目（未参与普通公路养护工程考核）信用考核被评为A、AA级的年度");
            /// <summary>
			/// 是否更改专用合同条款
			/// </summary>
			public readonly static Field CHANGE = new Field("CHANGE", "JT_GENRAL_CON_TENDER_FILE_01", "是否更改专用合同条款");
            /// <summary>
			/// 一般约定
			/// </summary>
			public readonly static Field GENERAL_CONTRACT = new Field("GENERAL_CONTRACT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "一般约定");
            /// <summary>
			/// 监理人
			/// </summary>
			public readonly static Field SUPERVISOR = new Field("SUPERVISOR", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "监理人");
            /// <summary>
			/// 承包人
			/// </summary>
			public readonly static Field CONTRACTOR = new Field("CONTRACTOR", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "承包人");
            /// <summary>
			/// 材料和工程设备
			/// </summary>
			public readonly static Field MATERIAL_PROJECT_EQUIPMENT = new Field("MATERIAL_PROJECT_EQUIPMENT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "材料和工程设备");
            /// <summary>
			/// 施工设备和临时设施
			/// </summary>
			public readonly static Field CONSTRUCT_EQUIP_TEMP_FACIL = new Field("CONSTRUCT_EQUIP_TEMP_FACIL", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "施工设备和临时设施");
            /// <summary>
			/// 交通运输
			/// </summary>
			public readonly static Field TRANSPORTATION = new Field("TRANSPORTATION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "交通运输");
            /// <summary>
			/// 施工安全、治安保卫和环境保护
			/// </summary>
			public readonly static Field SAFE_SECURITY_ENVIRON_PRO = new Field("SAFE_SECURITY_ENVIRON_PRO", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "施工安全、治安保卫和环境保护");
            /// <summary>
			/// 进度计划
			/// </summary>
			public readonly static Field SCHEDULE = new Field("SCHEDULE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "进度计划");
            /// <summary>
			/// 开工和交工
			/// </summary>
			public readonly static Field COMMENCEMENT_COMPLETION = new Field("COMMENCEMENT_COMPLETION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "开工和交工");
            /// <summary>
			/// 工程质量
			/// </summary>
			public readonly static Field PROJECT_QUALITY = new Field("PROJECT_QUALITY", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "工程质量");
            /// <summary>
			/// 变更
			/// </summary>
			public readonly static Field MODIFICATION = new Field("MODIFICATION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "变更");
            /// <summary>
			/// 价格调整
			/// </summary>
			public readonly static Field PRICE_REGULATION = new Field("PRICE_REGULATION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "价格调整");
            /// <summary>
			/// 计量与支付
			/// </summary>
			public readonly static Field MEASUREMENT_PAYMENT = new Field("MEASUREMENT_PAYMENT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "计量与支付");
            /// <summary>
			/// 交工验收
			/// </summary>
			public readonly static Field COMPLETION_ACCEPTANCE = new Field("COMPLETION_ACCEPTANCE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "交工验收");
            /// <summary>
			/// 保险
			/// </summary>
			public readonly static Field INSURANCE = new Field("INSURANCE", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "保险");
            /// <summary>
			/// 违约
			/// </summary>
			public readonly static Field BREACH_CONTRACT = new Field("BREACH_CONTRACT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "违约");
            /// <summary>
			/// 争议的解决
			/// </summary>
			public readonly static Field DISPUTE_RESOLUTION = new Field("DISPUTE_RESOLUTION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "争议的解决");
            /// <summary>
			/// 耕地保护
			/// </summary>
			public readonly static Field LAND_PROTECTION = new Field("LAND_PROTECTION", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "耕地保护");
            /// <summary>
			/// 资料的份量与送交时限
			/// </summary>
			public readonly static Field DELIVERY_TIME_LIMIT = new Field("DELIVERY_TIME_LIMIT", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "资料的份量与送交时限");
            /// <summary>
			/// 其他文件与规定
			/// </summary>
			public readonly static Field OTHER_CONVENTIONS = new Field("OTHER_CONVENTIONS", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "其他文件与规定");
            /// <summary>
			/// 其他补充条款
			/// </summary>
			public readonly static Field SUPPLY_ITEM = new Field("SUPPLY_ITEM", "JT_GENRAL_CON_TENDER_FILE_01",DbType.AnsiString, null, "其他补充条款");
            /// <summary>
			/// 工程量清单
			/// </summary>
			public readonly static Field BILL_OF_QUANTITIES = new Field("BILL_OF_QUANTITIES", "JT_GENRAL_CON_TENDER_FILE_01", "工程量清单");
            /// <summary>
			/// 图纸
			/// </summary>
			public readonly static Field DRAWING = new Field("DRAWING", "JT_GENRAL_CON_TENDER_FILE_01", "图纸");
            /// <summary>
			/// 技术规范
			/// </summary>
			public readonly static Field TECHNICAL_SPECIFICATIONS = new Field("TECHNICAL_SPECIFICATIONS", "JT_GENRAL_CON_TENDER_FILE_01", "技术规范");
            /// <summary>
			/// 补充技术规范
			/// </summary>
			public readonly static Field SUPPLY_TECHNICAL_STANDARD = new Field("SUPPLY_TECHNICAL_STANDARD", "JT_GENRAL_CON_TENDER_FILE_01", "补充技术规范");
            /// <summary>
			/// 标后监管指南
			/// </summary>
			public readonly static Field ENCLOSURE1 = new Field("ENCLOSURE1", "JT_GENRAL_CON_TENDER_FILE_01", "标后监管指南");
            /// <summary>
			/// 招标代理合同
			/// </summary>
			public readonly static Field ENCLOSURE2 = new Field("ENCLOSURE2", "JT_GENRAL_CON_TENDER_FILE_01", "招标代理合同");
            /// <summary>
			/// 招标人授权招标代理签章协议书
			/// </summary>
			public readonly static Field ENCLOSURE3 = new Field("ENCLOSURE3", "JT_GENRAL_CON_TENDER_FILE_01", "招标人授权招标代理签章协议书");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_GENRAL_CON_TENDER_FILE_01", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_GENRAL_CON_TENDER_FILE_01", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_GENRAL_CON_TENDER_FILE_01", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_GENRAL_CON_TENDER_FILE_01", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_GENRAL_CON_TENDER_FILE_01", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_GENRAL_CON_TENDER_FILE_01", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_GENRAL_CON_TENDER_FILE_01", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_GENRAL_CON_TENDER_FILE_01", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_GENRAL_CON_TENDER_FILE_01", "M_TM");
        }
        #endregion
	}
}