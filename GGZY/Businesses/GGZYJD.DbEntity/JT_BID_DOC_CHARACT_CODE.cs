...
{
    /// <summary>
    /// 实体类JT_BID_DOC_CHARACT_CODE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_BID_DOC_CHARACT_CODE")]
    [Serializable]
    public partial class JT_BID_DOC_CHARACT_CODE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_BID_DOC_CHARACT_CODE");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_BID_DOC_CHARACT_CODE", "招标项目编号");
            /// <summary>
			/// 相关统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODES = new Field("UNIFIED_DEAL_CODES", "JT_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "相关统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "JT_BID_DOC_CHARACT_CODE", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "JT_BID_DOC_CHARACT_CODE", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "JT_BID_DOC_CHARACT_CODE", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "JT_BID_DOC_CHARACT_CODE", "投标人角色");
            /// <summary>
			/// 投标文件名称
			/// </summary>
			public readonly static Field BID_DOCUMENT_NAME = new Field("BID_DOCUMENT_NAME", "JT_BID_DOC_CHARACT_CODE", "投标文件名称");
            /// <summary>
			/// 投标文件大小
			/// </summary>
			public readonly static Field BID_DOCUMENT_SIDE = new Field("BID_DOCUMENT_SIDE", "JT_BID_DOC_CHARACT_CODE", "投标文件大小");
            /// <summary>
			/// 投标文件MD5码
			/// </summary>
			public readonly static Field BID_DOCUMENT_MD5 = new Field("BID_DOCUMENT_MD5", "JT_BID_DOC_CHARACT_CODE", "投标文件MD5码");
            /// <summary>
			/// 投标文件提交时间
			/// </summary>
			public readonly static Field TENDER_DOC_SUBMITTIME = new Field("TENDER_DOC_SUBMITTIME", "JT_BID_DOC_CHARACT_CODE", "投标文件提交时间");
            /// <summary>
			/// CPU序列号
			/// </summary>
			public readonly static Field CPU_ID = new Field("CPU_ID", "JT_BID_DOC_CHARACT_CODE", "CPU序列号");
            /// <summary>
			/// 硬盘序列号
			/// </summary>
			public readonly static Field HARD_DISK_SERIAL_NUMBER = new Field("HARD_DISK_SERIAL_NUMBER", "JT_BID_DOC_CHARACT_CODE", "硬盘序列号");
            /// <summary>
			/// 内存序列号
			/// </summary>
			public readonly static Field MEMORY_SERIAL_NUMBER = new Field("MEMORY_SERIAL_NUMBER", "JT_BID_DOC_CHARACT_CODE", "内存序列号");
            /// <summary>
			/// IP地址
			/// </summary>
			public readonly static Field NET_ID = new Field("NET_ID", "JT_BID_DOC_CHARACT_CODE", "IP地址");
            /// <summary>
			/// 网卡MAC地址
			/// </summary>
			public readonly static Field MAC_ADDRESS = new Field("MAC_ADDRESS", "JT_BID_DOC_CHARACT_CODE", "网卡MAC地址");
            /// <summary>
			/// 投标文件URL
			/// </summary>
			public readonly static Field TENDER_DOCUMENTS_URL = new Field("TENDER_DOCUMENTS_URL", "JT_BID_DOC_CHARACT_CODE", "投标文件URL");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_BID_DOC_CHARACT_CODE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_BID_DOC_CHARACT_CODE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_BID_DOC_CHARACT_CODE", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_BID_DOC_CHARACT_CODE", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_BID_DOC_CHARACT_CODE", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_BID_DOC_CHARACT_CODE", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_BID_DOC_CHARACT_CODE", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_BID_DOC_CHARACT_CODE", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_BID_DOC_CHARACT_CODE", "M_TM");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "JT_BID_DOC_CHARACT_CODE", "标段（包）编号");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field VALUATION_XML = new Field("VALUATION_XML", "JT_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "JT_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "标段（包）编号");
            /// <summary>
			/// 投标文件制作工具软硬件信息xml
			/// </summary>
			public readonly static Field MAKE_TOOL_XML = new Field("MAKE_TOOL_XML", "JT_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "投标文件制作工具软硬件信息xml");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_BID_DOC_CHARACT_CODE", "");
        }
        #endregion
	}
}