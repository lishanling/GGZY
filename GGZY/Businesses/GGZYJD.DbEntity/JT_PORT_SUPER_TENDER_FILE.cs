...
{
    /// <summary>
    /// 实体类JT_PORT_SUPER_TENDER_FILE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_PORT_SUPER_TENDER_FILE")]
    [Serializable]
    public partial class JT_PORT_SUPER_TENDER_FILE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_PORT_SUPER_TENDER_FILE");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_PORT_SUPER_TENDER_FILE", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 项目总工期
			/// </summary>
			public readonly static Field LIMITE_ALL_TIME = new Field("LIMITE_ALL_TIME", "JT_PORT_SUPER_TENDER_FILE", "项目总工期");
            /// <summary>
			/// 资金落实情况
			/// </summary>
			public readonly static Field FUND_IMPLEMENTATION = new Field("FUND_IMPLEMENTATION", "JT_PORT_SUPER_TENDER_FILE", "资金落实情况");
            /// <summary>
			/// 监理服务期
			/// </summary>
			public readonly static Field SUPERVISOR_DAYS = new Field("SUPERVISOR_DAYS", "JT_PORT_SUPER_TENDER_FILE", "监理服务期");
            /// <summary>
			/// 总标段个数
			/// </summary>
			public readonly static Field TOTAL_SECTION_NUMBER = new Field("TOTAL_SECTION_NUMBER", "JT_PORT_SUPER_TENDER_FILE", "总标段个数");
            /// <summary>
			/// 本次招标标段个数
			/// </summary>
			public readonly static Field TENDERER_SECTION_NUMBER = new Field("TENDERER_SECTION_NUMBER", "JT_PORT_SUPER_TENDER_FILE", "本次招标标段个数");
            /// <summary>
			/// 类似项目业绩要求
			/// </summary>
			public readonly static Field SUPER_SIMILAR_PROJECT = new Field("SUPER_SIMILAR_PROJECT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "类似项目业绩要求");
            /// <summary>
			/// 总监理工程师资质名称及等级
			/// </summary>
			public readonly static Field GENERAL_QUAL_LEVEL = new Field("GENERAL_QUAL_LEVEL", "JT_PORT_SUPER_TENDER_FILE", "总监理工程师资质名称及等级");
            /// <summary>
			/// 总监理师技术职称
			/// </summary>
			public readonly static Field GENERAL_TECH_TITLE = new Field("GENERAL_TECH_TITLE", "JT_PORT_SUPER_TENDER_FILE", "总监理师技术职称");
            /// <summary>
			/// 监理服务阶段
			/// </summary>
			public readonly static Field SUPERVISION_SERVICE_STAGE = new Field("SUPERVISION_SERVICE_STAGE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "监理服务阶段");
            /// <summary>
			/// 监理工作范围
			/// </summary>
			public readonly static Field SCOPE_SUPER_WORK = new Field("SCOPE_SUPER_WORK", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "监理工作范围");
            /// <summary>
			/// 资质条件
			/// </summary>
			public readonly static Field MINIMUM_QUALIFICATIONS = new Field("MINIMUM_QUALIFICATIONS", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "资质条件");
            /// <summary>
			/// 财务要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE = new Field("FINANCIAL_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "财务要求");
            /// <summary>
			/// 信誉要求
			/// </summary>
			public readonly static Field REPUTATION_REQUIRE = new Field("REPUTATION_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "信誉要求");
            /// <summary>
			/// 业绩要求
			/// </summary>
			public readonly static Field ACHIEVEMENT_REQUIRE = new Field("ACHIEVEMENT_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "业绩要求");
            /// <summary>
			/// 投标人提出问题的截止时间
			/// </summary>
			public readonly static Field QUESTION_TIME = new Field("QUESTION_TIME", "JT_PORT_SUPER_TENDER_FILE", "投标人提出问题的截止时间");
            /// <summary>
			/// 招标人书面澄清截止时间
			/// </summary>
			public readonly static Field TENDER_NOTICE_TIME = new Field("TENDER_NOTICE_TIME", "JT_PORT_SUPER_TENDER_FILE", "招标人书面澄清截止时间");
            /// <summary>
			/// 投标人要求澄清招标文件的截止时间
			/// </summary>
			public readonly static Field BIDDER_NOTICE_TIME = new Field("BIDDER_NOTICE_TIME", "JT_PORT_SUPER_TENDER_FILE", "投标人要求澄清招标文件的截止时间");
            /// <summary>
			/// 是否允许分包
			/// </summary>
			public readonly static Field SUBCONTRACT = new Field("SUBCONTRACT", "JT_PORT_SUPER_TENDER_FILE", "是否允许分包");
            /// <summary>
			/// 分包内容要求
			/// </summary>
			public readonly static Field SUBCONTRACT_CONTENT_REQUIRE = new Field("SUBCONTRACT_CONTENT_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "分包内容要求");
            /// <summary>
			/// 保证金户名一
			/// </summary>
			public readonly static Field MARGIN_NAME1 = new Field("MARGIN_NAME1", "JT_PORT_SUPER_TENDER_FILE", "保证金户名一");
            /// <summary>
			/// 保证金账号一
			/// </summary>
			public readonly static Field MARGIN_NUMBER1 = new Field("MARGIN_NUMBER1", "JT_PORT_SUPER_TENDER_FILE", "保证金账号一");
            /// <summary>
			/// 开户银行一
			/// </summary>
			public readonly static Field MARGIN_BANK1 = new Field("MARGIN_BANK1", "JT_PORT_SUPER_TENDER_FILE", "开户银行一");
            /// <summary>
			/// 保证金户名二
			/// </summary>
			public readonly static Field MARGIN_NAME2 = new Field("MARGIN_NAME2", "JT_PORT_SUPER_TENDER_FILE", "保证金户名二");
            /// <summary>
			/// 保证金账号二
			/// </summary>
			public readonly static Field MARGIN_NUMBER2 = new Field("MARGIN_NUMBER2", "JT_PORT_SUPER_TENDER_FILE", "保证金账号二");
            /// <summary>
			/// 开户银行二
			/// </summary>
			public readonly static Field MARGIN_BANK2 = new Field("MARGIN_BANK2", "JT_PORT_SUPER_TENDER_FILE", "开户银行二");
            /// <summary>
			/// 保证金户名三
			/// </summary>
			public readonly static Field MARGIN_NAME3 = new Field("MARGIN_NAME3", "JT_PORT_SUPER_TENDER_FILE", "保证金户名三");
            /// <summary>
			/// 保证金账号三
			/// </summary>
			public readonly static Field MARGIN_NUMBER3 = new Field("MARGIN_NUMBER3", "JT_PORT_SUPER_TENDER_FILE", "保证金账号三");
            /// <summary>
			/// 开户银行三
			/// </summary>
			public readonly static Field MARGIN_BANK3 = new Field("MARGIN_BANK3", "JT_PORT_SUPER_TENDER_FILE", "开户银行三");
            /// <summary>
			/// 近年财务状况年份要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE_YEAR = new Field("FINANCIAL_REQUIRE_YEAR", "JT_PORT_SUPER_TENDER_FILE", "近年财务状况年份要求");
            /// <summary>
			/// 完成的类似项目年份要求
			/// </summary>
			public readonly static Field SIMILAR_PROJECT_YEAR = new Field("SIMILAR_PROJECT_YEAR", "JT_PORT_SUPER_TENDER_FILE", "完成的类似项目年份要求");
            /// <summary>
			/// 发生的诉讼及仲裁情况的年份要求
			/// </summary>
			public readonly static Field LITIGATION_YEAR = new Field("LITIGATION_YEAR", "JT_PORT_SUPER_TENDER_FILE", "发生的诉讼及仲裁情况的年份要求");
            /// <summary>
			/// 评标委员会人数
			/// </summary>
			public readonly static Field ALL_EXPERT_NUM = new Field("ALL_EXPERT_NUM", "JT_PORT_SUPER_TENDER_FILE", "评标委员会人数");
            /// <summary>
			/// 招标人代表人数
			/// </summary>
			public readonly static Field TENDERER_NUM = new Field("TENDERER_NUM", "JT_PORT_SUPER_TENDER_FILE", "招标人代表人数");
            /// <summary>
			/// 专家人数
			/// </summary>
			public readonly static Field EXPERT_NUM = new Field("EXPERT_NUM", "JT_PORT_SUPER_TENDER_FILE", "专家人数");
            /// <summary>
			/// 是否授权评标委员会确定中标人
			/// </summary>
			public readonly static Field EXPERT_DETERMIN_BIDDER = new Field("EXPERT_DETERMIN_BIDDER", "JT_PORT_SUPER_TENDER_FILE", "是否授权评标委员会确定中标人");
            /// <summary>
			/// 履约担保形式
			/// </summary>
			public readonly static Field PERFORM_TYPE = new Field("PERFORM_TYPE", "JT_PORT_SUPER_TENDER_FILE", "履约担保形式");
            /// <summary>
			/// 担保银行信息
			/// </summary>
			public readonly static Field PERFORM_CONTENT1 = new Field("PERFORM_CONTENT1", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "担保银行信息");
            /// <summary>
			/// 其他金融机构信息
			/// </summary>
			public readonly static Field PERFORM_CONTENT2 = new Field("PERFORM_CONTENT2", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他金融机构信息");
            /// <summary>
			/// 履约担保金额
			/// </summary>
			public readonly static Field PERFORM_PRICE = new Field("PERFORM_PRICE", "JT_PORT_SUPER_TENDER_FILE", "履约担保金额");
            /// <summary>
			/// 投诉单位名称1
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME1 = new Field("SUPERVISE_DEPT_NAME1", "JT_PORT_SUPER_TENDER_FILE", "投诉单位名称1");
            /// <summary>
			/// 投诉单位地址1
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ADDRESS1 = new Field("SUPERVISE_DEPT_ADDRESS1", "JT_PORT_SUPER_TENDER_FILE", "投诉单位地址1");
            /// <summary>
			/// 投诉单位电话1
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_PHONE1 = new Field("SUPERVISE_DEPT_PHONE1", "JT_PORT_SUPER_TENDER_FILE", "投诉单位电话1");
            /// <summary>
			/// 投诉单位传真1
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_FAX1 = new Field("SUPERVISE_DEPT_FAX1", "JT_PORT_SUPER_TENDER_FILE", "投诉单位传真1");
            /// <summary>
			/// 投诉单位邮编1
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ZIP_CODE1 = new Field("SUPERVISE_DEPT_ZIP_CODE1", "JT_PORT_SUPER_TENDER_FILE", "投诉单位邮编1");
            /// <summary>
			/// 投诉单位名称2
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME2 = new Field("SUPERVISE_DEPT_NAME2", "JT_PORT_SUPER_TENDER_FILE", "投诉单位名称2");
            /// <summary>
			/// 投诉单位地址2
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ADDRESS2 = new Field("SUPERVISE_DEPT_ADDRESS2", "JT_PORT_SUPER_TENDER_FILE", "投诉单位地址2");
            /// <summary>
			/// 投诉单位电话2
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_PHONE2 = new Field("SUPERVISE_DEPT_PHONE2", "JT_PORT_SUPER_TENDER_FILE", "投诉单位电话2");
            /// <summary>
			/// 投诉单位传真2
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_FAX2 = new Field("SUPERVISE_DEPT_FAX2", "JT_PORT_SUPER_TENDER_FILE", "投诉单位传真2");
            /// <summary>
			/// 投诉单位邮编2
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ZIP_CODE2 = new Field("SUPERVISE_DEPT_ZIP_CODE2", "JT_PORT_SUPER_TENDER_FILE", "投诉单位邮编2");
            /// <summary>
			/// 其他要求
			/// </summary>
			public readonly static Field OTHER_REQUIREMENTS = new Field("OTHER_REQUIREMENTS", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他要求");
            /// <summary>
			/// 是否更改专用合同条款
			/// </summary>
			public readonly static Field CHANGE = new Field("CHANGE", "JT_PORT_SUPER_TENDER_FILE", "是否更改专用合同条款");
            /// <summary>
			/// 一般约定
			/// </summary>
			public readonly static Field GENERAL_CONTRACT = new Field("GENERAL_CONTRACT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "一般约定");
            /// <summary>
			/// 发包人义务
			/// </summary>
			public readonly static Field EMPLOYER_DUTY = new Field("EMPLOYER_DUTY", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "发包人义务");
            /// <summary>
			/// 监理服务
			/// </summary>
			public readonly static Field SUPERVISION_SERVICE = new Field("SUPERVISION_SERVICE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "监理服务");
            /// <summary>
			/// 合同的生效、终止、服务时间和期限、变更、暂停与解除
			/// </summary>
			public readonly static Field CONTRACT_OPERATION = new Field("CONTRACT_OPERATION", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "合同的生效、终止、服务时间和期限、变更、暂停与解除");
            /// <summary>
			/// 监理服务费计费与支付
			/// </summary>
			public readonly static Field MEASUREMENT_PAYMENT = new Field("MEASUREMENT_PAYMENT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "监理服务费计费与支付");
            /// <summary>
			/// 违约
			/// </summary>
			public readonly static Field BREACH_CONTRACT = new Field("BREACH_CONTRACT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "违约");
            /// <summary>
			/// 争议的解决
			/// </summary>
			public readonly static Field DISPUTE_RESOLUTION = new Field("DISPUTE_RESOLUTION", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "争议的解决");
            /// <summary>
			/// 其他
			/// </summary>
			public readonly static Field OTHER_CONVENTIONS = new Field("OTHER_CONVENTIONS", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他");
            /// <summary>
			/// 其他补充条款
			/// </summary>
			public readonly static Field SUPPLY_ITEM = new Field("SUPPLY_ITEM", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他补充条款");
            /// <summary>
			/// 监理服务费报价
			/// </summary>
			public readonly static Field SERVICE_CHARGE = new Field("SERVICE_CHARGE", "JT_PORT_SUPER_TENDER_FILE", "监理服务费报价");
            /// <summary>
			/// 图纸和资料
			/// </summary>
			public readonly static Field DRAWING = new Field("DRAWING", "JT_PORT_SUPER_TENDER_FILE", "图纸和资料");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_PORT_SUPER_TENDER_FILE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_PORT_SUPER_TENDER_FILE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_PORT_SUPER_TENDER_FILE", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_PORT_SUPER_TENDER_FILE", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_PORT_SUPER_TENDER_FILE", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_PORT_SUPER_TENDER_FILE", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_PORT_SUPER_TENDER_FILE", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_PORT_SUPER_TENDER_FILE", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_PORT_SUPER_TENDER_FILE", "M_TM");
            /// <summary>
			/// 质量要求
			/// </summary>
			public readonly static Field QUALITY_REQUIRE = new Field("QUALITY_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "质量要求");
            /// <summary>
			/// 项目类别
			/// </summary>
			public readonly static Field SUR_DES_TYPE = new Field("SUR_DES_TYPE", "JT_PORT_SUPER_TENDER_FILE", "项目类别");
            /// <summary>
			/// 项目概况
			/// </summary>
			public readonly static Field PROJECT_PROFILE = new Field("PROJECT_PROFILE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "项目概况");
            /// <summary>
			/// 勘察周期
			/// </summary>
			public readonly static Field RECONNAISSANCE_CYCLE = new Field("RECONNAISSANCE_CYCLE", "JT_PORT_SUPER_TENDER_FILE", "勘察周期");
            /// <summary>
			/// 勘察招标范围
			/// </summary>
			public readonly static Field SURVEY_TENDER_CONTENT = new Field("SURVEY_TENDER_CONTENT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "勘察招标范围");
            /// <summary>
			/// 设计招标范围
			/// </summary>
			public readonly static Field DESIGN_TENDER_CONTENT = new Field("DESIGN_TENDER_CONTENT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "设计招标范围");
            /// <summary>
			/// 联合体成员数量要求
			/// </summary>
			public readonly static Field NUMBER_UNIONS = new Field("NUMBER_UNIONS", "JT_PORT_SUPER_TENDER_FILE", "联合体成员数量要求");
            /// <summary>
			/// 公共资源交易中心名称
			/// </summary>
			public readonly static Field TRADING_CENTER_NAME = new Field("TRADING_CENTER_NAME", "JT_PORT_SUPER_TENDER_FILE", "公共资源交易中心名称");
            /// <summary>
			/// 其他要求
			/// </summary>
			public readonly static Field OTHER_REQUIRE = new Field("OTHER_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他要求");
            /// <summary>
			/// 其他主要专业负责人最低要求
			/// </summary>
			public readonly static Field MANAGE_TECHNOLOGY_REQUIRE = new Field("MANAGE_TECHNOLOGY_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他主要专业负责人最低要求");
            /// <summary>
			/// 提交初步设计文件送审稿时间
			/// </summary>
			public readonly static Field SUBMIT_DESIGN_DAYS = new Field("SUBMIT_DESIGN_DAYS", "JT_PORT_SUPER_TENDER_FILE", "提交初步设计文件送审稿时间");
            /// <summary>
			/// 提交修改后的正式初步设计文件时间
			/// </summary>
			public readonly static Field MODIFY_DESIGN_DAYS = new Field("MODIFY_DESIGN_DAYS", "JT_PORT_SUPER_TENDER_FILE", "提交修改后的正式初步设计文件时间");
            /// <summary>
			/// 提交施工图纸设计文件送审稿时间
			/// </summary>
			public readonly static Field SUBMIT_CONSTRUCT_DAYS = new Field("SUBMIT_CONSTRUCT_DAYS", "JT_PORT_SUPER_TENDER_FILE", "提交施工图纸设计文件送审稿时间");
            /// <summary>
			/// 提交修改后的正式施工图设计文件时间
			/// </summary>
			public readonly static Field MODIFY_CONSTRUCT_DAYS = new Field("MODIFY_CONSTRUCT_DAYS", "JT_PORT_SUPER_TENDER_FILE", "提交修改后的正式施工图设计文件时间");
            /// <summary>
			/// 类似项目业绩要求
			/// </summary>
			public readonly static Field DESIGN_PERFORMANCE = new Field("DESIGN_PERFORMANCE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "类似项目业绩要求");
            /// <summary>
			/// 项目负责人资格要求
			/// </summary>
			public readonly static Field MANAGER_QUALIFICAT_TITLE = new Field("MANAGER_QUALIFICAT_TITLE", "JT_PORT_SUPER_TENDER_FILE", "项目负责人资格要求");
            /// <summary>
			/// 招标人开户行
			/// </summary>
			public readonly static Field TENDERER_BANK = new Field("TENDERER_BANK", "JT_PORT_SUPER_TENDER_FILE", "招标人开户行");
            /// <summary>
			/// 招标人银行账号
			/// </summary>
			public readonly static Field TENDERER_ACCOUNT = new Field("TENDERER_ACCOUNT", "JT_PORT_SUPER_TENDER_FILE", "招标人银行账号");
            /// <summary>
			/// 招标代理机构开户行
			/// </summary>
			public readonly static Field TENDER_AGENCY_BANK = new Field("TENDER_AGENCY_BANK", "JT_PORT_SUPER_TENDER_FILE", "招标代理机构开户行");
            /// <summary>
			/// 招标代理银行账号
			/// </summary>
			public readonly static Field TENDER_AGENCY_ACCOUNT = new Field("TENDER_AGENCY_ACCOUNT", "JT_PORT_SUPER_TENDER_FILE", "招标代理银行账号");
            /// <summary>
			/// 接受分包的第三人资质要求
			/// </summary>
			public readonly static Field SUB_QUALIFI_REQUIRE = new Field("SUB_QUALIFI_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "接受分包的第三人资质要求");
            /// <summary>
			/// 评标办法
			/// </summary>
			public readonly static Field EVALUATING_METHOD = new Field("EVALUATING_METHOD", "JT_PORT_SUPER_TENDER_FILE", "评标办法");
            /// <summary>
			/// 是否提交履约
			/// </summary>
			public readonly static Field IS_PERFORM_PRICE = new Field("IS_PERFORM_PRICE", "JT_PORT_SUPER_TENDER_FILE", "是否提交履约");
            /// <summary>
			/// 履约担保形式
			/// </summary>
			public readonly static Field PERFORMANCE_BOND_FORM = new Field("PERFORMANCE_BOND_FORM", "JT_PORT_SUPER_TENDER_FILE", "履约担保形式");
            /// <summary>
			/// 交通部门地址一
			/// </summary>
			public readonly static Field SUPERVISE_ADDRESS1 = new Field("SUPERVISE_ADDRESS1", "JT_PORT_SUPER_TENDER_FILE", "交通部门地址一");
            /// <summary>
			/// 交通部门传真一
			/// </summary>
			public readonly static Field SUPERVISE_FAX1 = new Field("SUPERVISE_FAX1", "JT_PORT_SUPER_TENDER_FILE", "交通部门传真一");
            /// <summary>
			/// 交通部门邮编一
			/// </summary>
			public readonly static Field SUPERVISE_ZIP_CODE1 = new Field("SUPERVISE_ZIP_CODE1", "JT_PORT_SUPER_TENDER_FILE", "交通部门邮编一");
            /// <summary>
			/// 交通部门地址二
			/// </summary>
			public readonly static Field SUPERVISE_ADDRESS2 = new Field("SUPERVISE_ADDRESS2", "JT_PORT_SUPER_TENDER_FILE", "交通部门地址二");
            /// <summary>
			/// 交通部门传真二
			/// </summary>
			public readonly static Field SUPERVISE_FAX2 = new Field("SUPERVISE_FAX2", "JT_PORT_SUPER_TENDER_FILE", "交通部门传真二");
            /// <summary>
			/// 交通部门邮编二
			/// </summary>
			public readonly static Field SUPERVISE_ZIP_CODE2 = new Field("SUPERVISE_ZIP_CODE2", "JT_PORT_SUPER_TENDER_FILE", "交通部门邮编二");
            /// <summary>
			/// 投诉单位名称
			/// </summary>
			public readonly static Field ACCEPTING_INSTITUTION = new Field("ACCEPTING_INSTITUTION", "JT_PORT_SUPER_TENDER_FILE", "投诉单位名称");
            /// <summary>
			/// 投诉单位地址
			/// </summary>
			public readonly static Field COMPLAINT_ADDRESS = new Field("COMPLAINT_ADDRESS", "JT_PORT_SUPER_TENDER_FILE", "投诉单位地址");
            /// <summary>
			/// 投诉单位电话
			/// </summary>
			public readonly static Field COMPLAINTS_HOTLINE = new Field("COMPLAINTS_HOTLINE", "JT_PORT_SUPER_TENDER_FILE", "投诉单位电话");
            /// <summary>
			/// 投诉单位邮编
			/// </summary>
			public readonly static Field COMPLAINT_POST_CODE = new Field("COMPLAINT_POST_CODE", "JT_PORT_SUPER_TENDER_FILE", "投诉单位邮编");
            /// <summary>
			/// 业绩分每增加一项设计业绩加2分
			/// </summary>
			public readonly static Field BONUS_CONTENT = new Field("BONUS_CONTENT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "业绩分每增加一项设计业绩加2分");
            /// <summary>
			/// 定义和解释
			/// </summary>
			public readonly static Field DEFINITION = new Field("DEFINITION", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "定义和解释");
            /// <summary>
			/// 设计人的责任和义务
			/// </summary>
			public readonly static Field DESIGNER_DUTY = new Field("DESIGNER_DUTY", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "设计人的责任和义务");
            /// <summary>
			/// 勘察设计周期及提交成果
			/// </summary>
			public readonly static Field SUBMISSION_RESULTS = new Field("SUBMISSION_RESULTS", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "勘察设计周期及提交成果");
            /// <summary>
			/// 费用与支付
			/// </summary>
			public readonly static Field PAYMENT = new Field("PAYMENT", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "费用与支付");
            /// <summary>
			/// 招标人提供的资料
			/// </summary>
			public readonly static Field BASIC_DATA = new Field("BASIC_DATA", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "招标人提供的资料");
            /// <summary>
			/// 勘察设计技术要求
			/// </summary>
			public readonly static Field TECHNICAL_REQUIRE = new Field("TECHNICAL_REQUIRE", "JT_PORT_SUPER_TENDER_FILE",DbType.AnsiString, null, "勘察设计技术要求");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_PORT_SUPER_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_PORT_SUPER_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_PORT_SUPER_TENDER_FILE", "");
        }
        #endregion
	}
}