...
{
    /// <summary>
    /// 实体类SL_OBJECTION_REPLY。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SL_OBJECTION_REPLY")]
    [Serializable]
    public partial class SL_OBJECTION_REPLY : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SL_OBJECTION_REPLY");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "SL_OBJECTION_REPLY", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "SL_OBJECTION_REPLY", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "SL_OBJECTION_REPLY", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "SL_OBJECTION_REPLY", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "SL_OBJECTION_REPLY", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "SL_OBJECTION_REPLY", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "SL_OBJECTION_REPLY", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "SL_OBJECTION_REPLY", "统一交易标识码");
            /// <summary>
			/// 异议唯一标识
			/// </summary>
			public readonly static Field OBJECTIONG_GUID = new Field("OBJECTIONG_GUID", "SL_OBJECTION_REPLY", "异议唯一标识");
            /// <summary>
			/// 异议回复标题
			/// </summary>
			public readonly static Field RESPONSE_TITTLE = new Field("RESPONSE_TITTLE", "SL_OBJECTION_REPLY", "异议回复标题");
            /// <summary>
			/// 异议回复内容
			/// </summary>
			public readonly static Field RESPONSE_CONTENT = new Field("RESPONSE_CONTENT", "SL_OBJECTION_REPLY", "异议回复内容");
            /// <summary>
			/// 回复提交时间
			/// </summary>
			public readonly static Field RESPONSE_SUBMIT_TIME = new Field("RESPONSE_SUBMIT_TIME", "SL_OBJECTION_REPLY", "回复提交时间");
            /// <summary>
			/// 异议回复人
			/// </summary>
			public readonly static Field RESPONSE_CREATOR = new Field("RESPONSE_CREATOR", "SL_OBJECTION_REPLY", "异议回复人");
            /// <summary>
			/// 异议回复人类别
			/// </summary>
			public readonly static Field RESPONSE_CREATOR_TYPE = new Field("RESPONSE_CREATOR_TYPE", "SL_OBJECTION_REPLY", "异议回复人类别");
            /// <summary>
			/// 异议回复人角色
			/// </summary>
			public readonly static Field RESPONSE_CREATOR_ROLE = new Field("RESPONSE_CREATOR_ROLE", "SL_OBJECTION_REPLY", "异议回复人角色");
            /// <summary>
			/// 异议回复人代码
			/// </summary>
			public readonly static Field RESPONSE_CREATOR_CODE = new Field("RESPONSE_CREATOR_CODE", "SL_OBJECTION_REPLY", "异议回复人代码");
            /// <summary>
			/// 异议回复人联系方式
			/// </summary>
			public readonly static Field RESPONSE_CREATOR_CONTACT = new Field("RESPONSE_CREATOR_CONTACT", "SL_OBJECTION_REPLY", "异议回复人联系方式");
            /// <summary>
			/// 异议处理状态
			/// </summary>
			public readonly static Field RESPONSE_STATUS = new Field("RESPONSE_STATUS", "SL_OBJECTION_REPLY", "异议处理状态");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "SL_OBJECTION_REPLY", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "SL_OBJECTION_REPLY", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "SL_OBJECTION_REPLY", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "SL_OBJECTION_REPLY", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "SL_OBJECTION_REPLY", "公共服务平台标识码");
        }
        #endregion
	}
}