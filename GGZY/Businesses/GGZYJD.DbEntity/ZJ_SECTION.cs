...
{
    /// <summary>
    /// 实体类ZJ_SECTION。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("ZJ_SECTION")]
    [Serializable]
    public partial class ZJ_SECTION : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "ZJ_SECTION");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "ZJ_SECTION", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "ZJ_SECTION", "标段（包）编号");
            /// <summary>
			/// 标段（包）名称
			/// </summary>
			public readonly static Field BID_SECTION_NAME = new Field("BID_SECTION_NAME", "ZJ_SECTION", "标段（包）名称");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "ZJ_SECTION", "统一交易标识码");
            /// <summary>
			/// 标段（包）内容
			/// </summary>
			public readonly static Field BID_SECTION_CONTENT = new Field("BID_SECTION_CONTENT", "ZJ_SECTION",DbType.AnsiString, null, "标段（包）内容");
            /// <summary>
			/// 标段（包）分类代码
			/// </summary>
			public readonly static Field TENDER_PROJECT_CLASSIFY_CODE = new Field("TENDER_PROJECT_CLASSIFY_CODE", "ZJ_SECTION", "标段（包）分类代码");
            /// <summary>
			/// 标段合同估算价
			/// </summary>
			public readonly static Field CONTRACT_RECKON_PRICE = new Field("CONTRACT_RECKON_PRICE", "ZJ_SECTION", "标段合同估算价");
            /// <summary>
			/// 标段合同估算价币种代码
			/// </summary>
			public readonly static Field CURRENCY_CODE = new Field("CURRENCY_CODE", "ZJ_SECTION", "标段合同估算价币种代码");
            /// <summary>
			/// 标段合同估算价单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "ZJ_SECTION", "标段合同估算价单位");
            /// <summary>
			/// 投标人资格条件
			/// </summary>
			public readonly static Field BID_QUALIFICATION = new Field("BID_QUALIFICATION", "ZJ_SECTION",DbType.AnsiString, null, "投标人资格条件");
            /// <summary>
			/// 计划开工日期
			/// </summary>
			public readonly static Field BEGIN_DATE = new Field("BEGIN_DATE", "ZJ_SECTION", "计划开工日期");
            /// <summary>
			/// 工期
			/// </summary>
			public readonly static Field LIMITE_TIME = new Field("LIMITE_TIME", "ZJ_SECTION", "工期");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "ZJ_SECTION", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "ZJ_SECTION", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "ZJ_SECTION", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "ZJ_SECTION", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "ZJ_SECTION", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "ZJ_SECTION", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "ZJ_SECTION", "M_CREATEBY");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "ZJ_SECTION", "M_TM");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "ZJ_SECTION", "M_CREATE_TM");
            /// <summary>
			/// 招标文件
			/// </summary>
			public readonly static Field M_ATT_TENDER_FILE = new Field("M_ATT_TENDER_FILE", "ZJ_SECTION", "招标文件");
            /// <summary>
			/// 招标文件附件
			/// </summary>
			public readonly static Field M_ATT_TENDER_FILE_ATTACHS = new Field("M_ATT_TENDER_FILE_ATTACHS", "ZJ_SECTION", "招标文件附件");
            /// <summary>
			/// 招标公告
			/// </summary>
			public readonly static Field M_ATT_TENDER_NOTICE = new Field("M_ATT_TENDER_NOTICE", "ZJ_SECTION", "招标公告");
            /// <summary>
			/// 招标代理合同
			/// </summary>
			public readonly static Field M_ATT_TENDER_AGENT_CONTRACT = new Field("M_ATT_TENDER_AGENT_CONTRACT", "ZJ_SECTION", "招标代理合同");
            /// <summary>
			/// 加盖电子印章的澄清、答疑及补充PDF电子文件
			/// </summary>
			public readonly static Field M_ATT_FILE_EX_TDOC = new Field("M_ATT_FILE_EX_TDOC", "ZJ_SECTION", "加盖电子印章的澄清、答疑及补充PDF电子文件");
            /// <summary>
			/// 投标邀请书
			/// </summary>
			public readonly static Field M_ATT_INVITE_DOC = new Field("M_ATT_INVITE_DOC", "ZJ_SECTION", "投标邀请书");
            /// <summary>
			/// 中标候选人公示PDF文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）
			/// </summary>
			public readonly static Field M_ATT_PUBLICITY_DOC = new Field("M_ATT_PUBLICITY_DOC", "ZJ_SECTION", "中标候选人公示PDF文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）");
            /// <summary>
			/// 中标结果公示PDF文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）
			/// </summary>
			public readonly static Field M_ATT_WIN_BID_NOTICE = new Field("M_ATT_WIN_BID_NOTICE", "ZJ_SECTION", "中标结果公示PDF文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）");
            /// <summary>
			/// 异议/投诉
			/// </summary>
			public readonly static Field M_ATT_DISSENT_DOC = new Field("M_ATT_DISSENT_DOC", "ZJ_SECTION", "异议/投诉");
            /// <summary>
			/// 合同
			/// </summary>
			public readonly static Field M_ATT_CONTRACT_DOC = new Field("M_ATT_CONTRACT_DOC", "ZJ_SECTION", "合同");
            /// <summary>
			/// 资格预审文件
			/// </summary>
			public readonly static Field M_ATT_QUALIFICATION_DOC = new Field("M_ATT_QUALIFICATION_DOC", "ZJ_SECTION", "资格预审文件");
            /// <summary>
			/// 中标候选人公示电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）
			/// </summary>
			public readonly static Field M_ATT_PUBLICITY_DOC_SIGN = new Field("M_ATT_PUBLICITY_DOC_SIGN", "ZJ_SECTION", "中标候选人公示电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）");
            /// <summary>
			/// 中标结果公示电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）
			/// </summary>
			public readonly static Field M_ATT_WIN_BID_NOTICE_SIGN = new Field("M_ATT_WIN_BID_NOTICE_SIGN", "ZJ_SECTION", "中标结果公示电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）");
            /// <summary>
			/// 建立时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "ZJ_SECTION", "建立时间");
            /// <summary>
			/// 加盖电子印章的澄清、答疑及补充电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）
			/// </summary>
			public readonly static Field M_ATT_FILE_EX_TDOC_SIGN = new Field("M_ATT_FILE_EX_TDOC_SIGN", "ZJ_SECTION", "加盖电子印章的澄清、答疑及补充电子签章文件（招标人或其代理机构盖章并由项目负责人签名或者电子签名）");
            /// <summary>
			/// 标段（包）招标次数
			/// </summary>
			public readonly static Field BID_ECTION_NUM = new Field("BID_ECTION_NUM", "ZJ_SECTION", "标段（包）招标次数");
            /// <summary>
			/// 标段（包）招标方式
			/// </summary>
			public readonly static Field BID_TENDER_MODE = new Field("BID_TENDER_MODE", "ZJ_SECTION", "标段（包）招标方式");
            /// <summary>
			/// 标段（包）所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "ZJ_SECTION", "标段（包）所在行政区域代码");
            /// <summary>
			/// 交易发生行政区域代码
			/// </summary>
			public readonly static Field TRA_PLACE_CODE = new Field("TRA_PLACE_CODE", "ZJ_SECTION", "交易发生行政区域代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "ZJ_SECTION", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "ZJ_SECTION", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "ZJ_SECTION", "");
        }
        #endregion
	}
}