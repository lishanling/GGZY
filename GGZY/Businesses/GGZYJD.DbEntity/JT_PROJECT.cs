...
{
    /// <summary>
    /// 实体类JT_PROJECT。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_PROJECT")]
    [Serializable]
    public partial class JT_PROJECT : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_PROJECT");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "JT_PROJECT", "项目编号");
            /// <summary>
			/// 项目名称
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "JT_PROJECT", "项目名称");
            /// <summary>
			/// 项目所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "JT_PROJECT", "项目所在行政区域代码");
            /// <summary>
			/// 投资项目统一代码
			/// </summary>
			public readonly static Field INVEST_PROJECT_CODE = new Field("INVEST_PROJECT_CODE", "JT_PROJECT", "投资项目统一代码");
            /// <summary>
			/// 项目地址
			/// </summary>
			public readonly static Field ADDRESS = new Field("ADDRESS", "JT_PROJECT", "项目地址");
            /// <summary>
			/// 项目法人
			/// </summary>
			public readonly static Field LEGAL_PERSON = new Field("LEGAL_PERSON", "JT_PROJECT", "项目法人");
            /// <summary>
			/// 项目行业分类
			/// </summary>
			public readonly static Field INDUSTRIES_TYPE = new Field("INDUSTRIES_TYPE", "JT_PROJECT", "项目行业分类");
            /// <summary>
			/// 资金来源
			/// </summary>
			public readonly static Field FUND_SOURCE = new Field("FUND_SOURCE", "JT_PROJECT", "资金来源");
            /// <summary>
			/// 出资比例
			/// </summary>
			public readonly static Field CONTRIBUTION_SCALE = new Field("CONTRIBUTION_SCALE", "JT_PROJECT", "出资比例");
            /// <summary>
			/// 项目规模
			/// </summary>
			public readonly static Field PROJECT_SCALE = new Field("PROJECT_SCALE", "JT_PROJECT", "项目规模");
            /// <summary>
			/// 联系人
			/// </summary>
			public readonly static Field CONTACTOR = new Field("CONTACTOR", "JT_PROJECT", "联系人");
            /// <summary>
			/// 联系方式
			/// </summary>
			public readonly static Field CONTACT_INFORMATION = new Field("CONTACT_INFORMATION", "JT_PROJECT", "联系方式");
            /// <summary>
			/// 项目审批文件名称
			/// </summary>
			public readonly static Field APPROVAL_NAME = new Field("APPROVAL_NAME", "JT_PROJECT", "项目审批文件名称");
            /// <summary>
			/// 项目审批文号
			/// </summary>
			public readonly static Field APPROVAL_NUMBER = new Field("APPROVAL_NUMBER", "JT_PROJECT", "项目审批文号");
            /// <summary>
			/// 项目审批单位
			/// </summary>
			public readonly static Field APPROVAL_AUTHORITY = new Field("APPROVAL_AUTHORITY", "JT_PROJECT", "项目审批单位");
            /// <summary>
			/// 项目建立时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "JT_PROJECT", "项目建立时间");
            /// <summary>
			/// 招标编号
			/// </summary>
			public readonly static Field TENDER_CODE = new Field("TENDER_CODE", "JT_PROJECT", "招标编号");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_PROJECT", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_PROJECT", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_PROJECT", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_PROJECT", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_PROJECT", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_PROJECT", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_PROJECT", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_PROJECT", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_PROJECT", "M_TM");
            /// <summary>
			/// 报建编号
			/// </summary>
			public readonly static Field REPROT_CODE = new Field("REPROT_CODE", "JT_PROJECT", "报建编号");
            /// <summary>
			/// 附件立项批复文件（项目审批核准文件）
			/// </summary>
			public readonly static Field M_ATT_PROJECT_APPROVAL_FILE = new Field("M_ATT_PROJECT_APPROVAL_FILE", "JT_PROJECT", "附件立项批复文件（项目审批核准文件）");
            /// <summary>
			/// 分类版本代码
			/// </summary>
			public readonly static Field CLASS_VER_CODE = new Field("CLASS_VER_CODE", "JT_PROJECT", "分类版本代码");
            /// <summary>
			/// 项目类别关联代码
			/// </summary>
			public readonly static Field RELATE_CODE = new Field("RELATE_CODE", "JT_PROJECT", "项目类别关联代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_PROJECT", "");
            /// <summary>
			/// 信息录入人员
			/// </summary>
			public readonly static Field OPERATION_NAME = new Field("OPERATION_NAME", "JT_PROJECT", "信息录入人员");
        }
        #endregion
	}
}