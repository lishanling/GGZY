...
{
    /// <summary>
    /// 实体类JT_SUPER_TENDER_FILE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_SUPER_TENDER_FILE")]
    [Serializable]
    public partial class JT_SUPER_TENDER_FILE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_SUPER_TENDER_FILE");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_SUPER_TENDER_FILE", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 项目概况
			/// </summary>
			public readonly static Field PROJECT_PROFILE = new Field("PROJECT_PROFILE", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "项目概况");
            /// <summary>
			/// 本项目勘察设计招标合同段个数
			/// </summary>
			public readonly static Field CONTRACT_SECTION = new Field("CONTRACT_SECTION", "JT_SUPER_TENDER_FILE", "本项目勘察设计招标合同段个数");
            /// <summary>
			/// 投标人业绩条件
			/// </summary>
			public readonly static Field ACHIEVEMENT_CONDITIONS = new Field("ACHIEVEMENT_CONDITIONS", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "投标人业绩条件");
            /// <summary>
			/// 每个投标人最多可投标段数量
			/// </summary>
			public readonly static Field CONTRACT_SEGMENT = new Field("CONTRACT_SEGMENT", "JT_SUPER_TENDER_FILE", "每个投标人最多可投标段数量");
            /// <summary>
			/// 每个投标人最多可中标数量
			/// </summary>
			public readonly static Field TENDER_NUMBER = new Field("TENDER_NUMBER", "JT_SUPER_TENDER_FILE", "每个投标人最多可中标数量");
            /// <summary>
			/// 其他发布媒体1
			/// </summary>
			public readonly static Field MEDIA1 = new Field("MEDIA1", "JT_SUPER_TENDER_FILE", "其他发布媒体1");
            /// <summary>
			/// 其他发布媒体2
			/// </summary>
			public readonly static Field MEDIA2 = new Field("MEDIA2", "JT_SUPER_TENDER_FILE", "其他发布媒体2");
            /// <summary>
			/// 资金落实情况
			/// </summary>
			public readonly static Field FUND_IMPLEMENTATION = new Field("FUND_IMPLEMENTATION", "JT_SUPER_TENDER_FILE", "资金落实情况");
            /// <summary>
			/// 质量目标
			/// </summary>
			public readonly static Field QUALITY_TARGET = new Field("QUALITY_TARGET", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "质量目标");
            /// <summary>
			/// 安全目标
			/// </summary>
			public readonly static Field SECURITY_TARGET = new Field("SECURITY_TARGET", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "安全目标");
            /// <summary>
			/// 资质最低条件
			/// </summary>
			public readonly static Field MINIMUM_QUALIFICATIONS = new Field("MINIMUM_QUALIFICATIONS", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "资质最低条件");
            /// <summary>
			/// 业绩最低要求
			/// </summary>
			public readonly static Field ACHIEVEMENT_REQUIRE = new Field("ACHIEVEMENT_REQUIRE", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "业绩最低要求");
            /// <summary>
			/// 信誉最低要求
			/// </summary>
			public readonly static Field REPUTATION_REQUIRE = new Field("REPUTATION_REQUIRE", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "信誉最低要求");
            /// <summary>
			/// 银行贷款占出资比例的百分比
			/// </summary>
			public readonly static Field LOAN_RATIO = new Field("LOAN_RATIO", "JT_SUPER_TENDER_FILE", "银行贷款占出资比例的百分比");
            /// <summary>
			/// 自筹资金占出资比例的百分比
			/// </summary>
			public readonly static Field CAPITAL_RATIO = new Field("CAPITAL_RATIO", "JT_SUPER_TENDER_FILE", "自筹资金占出资比例的百分比");
            /// <summary>
			/// 近5年完成的类似项目业绩时间
			/// </summary>
			public readonly static Field ACHI_REQUIRE_YEAR = new Field("ACHI_REQUIRE_YEAR", "JT_SUPER_TENDER_FILE", "近5年完成的类似项目业绩时间");
            /// <summary>
			/// 近3年信誉要求
			/// </summary>
			public readonly static Field REPU_REQUIRE_YEAR = new Field("REPU_REQUIRE_YEAR", "JT_SUPER_TENDER_FILE", "近3年信誉要求");
            /// <summary>
			/// 投标保证金递交截止时间
			/// </summary>
			public readonly static Field MARGIN_TIME = new Field("MARGIN_TIME", "JT_SUPER_TENDER_FILE", "投标保证金递交截止时间");
            /// <summary>
			/// 招标人账户
			/// </summary>
			public readonly static Field MARGIN_NAME = new Field("MARGIN_NAME", "JT_SUPER_TENDER_FILE", "招标人账户");
            /// <summary>
			/// 招标人账号
			/// </summary>
			public readonly static Field MARGIN_NUMBER = new Field("MARGIN_NUMBER", "JT_SUPER_TENDER_FILE", "招标人账号");
            /// <summary>
			/// 招标人开户行
			/// </summary>
			public readonly static Field MARGIN_BANK = new Field("MARGIN_BANK", "JT_SUPER_TENDER_FILE", "招标人开户行");
            /// <summary>
			/// 近年完成的类似项目的年份要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE_YEAR = new Field("FINANCIAL_REQUIRE_YEAR", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "近年完成的类似项目的年份要求");
            /// <summary>
			/// 评标委员会人数
			/// </summary>
			public readonly static Field ALL_EXPERT_NUM = new Field("ALL_EXPERT_NUM", "JT_SUPER_TENDER_FILE", "评标委员会人数");
            /// <summary>
			/// 招标人代表人数
			/// </summary>
			public readonly static Field TENDERER_NUM = new Field("TENDERER_NUM", "JT_SUPER_TENDER_FILE", "招标人代表人数");
            /// <summary>
			/// 专家人数
			/// </summary>
			public readonly static Field EXPERT_NUM = new Field("EXPERT_NUM", "JT_SUPER_TENDER_FILE", "专家人数");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "JT_SUPER_TENDER_FILE", "监督部门名称");
            /// <summary>
			/// 监督部门联系电话
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_TELE = new Field("SUPERVISE_DEPT_TELE", "JT_SUPER_TENDER_FILE", "监督部门联系电话");
            /// <summary>
			/// 监督部门地址
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ADDRESS = new Field("SUPERVISE_DEPT_ADDRESS", "JT_SUPER_TENDER_FILE", "监督部门地址");
            /// <summary>
			/// 勘察设计技术要求
			/// </summary>
			public readonly static Field TECH_REQUIREMENTS = new Field("TECH_REQUIREMENTS", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "勘察设计技术要求");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_SUPER_TENDER_FILE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_SUPER_TENDER_FILE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_SUPER_TENDER_FILE", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_SUPER_TENDER_FILE", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_SUPER_TENDER_FILE", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_SUPER_TENDER_FILE", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_SUPER_TENDER_FILE", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_SUPER_TENDER_FILE", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_SUPER_TENDER_FILE", "M_TM");
            /// <summary>
			/// 项目总工期
			/// </summary>
			public readonly static Field LIMITE_ALL_TIME = new Field("LIMITE_ALL_TIME", "JT_SUPER_TENDER_FILE", "项目总工期");
            /// <summary>
			/// 缺陷责任期
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD1 = new Field("DEFECT_LIABILITY_PERIOD1", "JT_SUPER_TENDER_FILE", "缺陷责任期");
            /// <summary>
			/// 本项目路基土建工程施工划分标段数
			/// </summary>
			public readonly static Field BID_SECTION = new Field("BID_SECTION", "JT_SUPER_TENDER_FILE", "本项目路基土建工程施工划分标段数");
            /// <summary>
			/// 本次招标标段数
			/// </summary>
			public readonly static Field TENDERER_BID_SECTION = new Field("TENDERER_BID_SECTION", "JT_SUPER_TENDER_FILE", "本次招标标段数");
            /// <summary>
			/// 其他事项
			/// </summary>
			public readonly static Field OTHER_MATTERS = new Field("OTHER_MATTERS", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他事项");
            /// <summary>
			/// 其他
			/// </summary>
			public readonly static Field OTHER = new Field("OTHER", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "其他");
            /// <summary>
			/// 需要补充的其他内容
			/// </summary>
			public readonly static Field OTHER_CONTENT = new Field("OTHER_CONTENT", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "需要补充的其他内容");
            /// <summary>
			/// 工期单位
			/// </summary>
			public readonly static Field UNIT_SELECTION = new Field("UNIT_SELECTION", "JT_SUPER_TENDER_FILE", "工期单位");
            /// <summary>
			/// 近年完成的类似项目的年份要求
			/// </summary>
			public readonly static Field PROJECT_YEAR_REQUIRED_TIME = new Field("PROJECT_YEAR_REQUIRED_TIME", "JT_SUPER_TENDER_FILE", "近年完成的类似项目的年份要求");
            /// <summary>
			/// 近年发生的诉讼及仲裁情况的年份要求
			/// </summary>
			public readonly static Field LITIGATION_YEAR_REQUIRED_TIME = new Field("LITIGATION_YEAR_REQUIRED_TIME", "JT_SUPER_TENDER_FILE", "近年发生的诉讼及仲裁情况的年份要求");
            /// <summary>
			/// 评标办法评审因素和评审标准
			/// </summary>
			public readonly static Field EVALUATING_METHOD_STANDARD = new Field("EVALUATING_METHOD_STANDARD", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "评标办法评审因素和评审标准");
            /// <summary>
			/// 监督部门邮编
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ZIP_CODE = new Field("SUPERVISE_DEPT_ZIP_CODE", "JT_SUPER_TENDER_FILE", "监督部门邮编");
            /// <summary>
			/// 评标专家确定方式
			/// </summary>
			public readonly static Field EXPERT_EXTRACT = new Field("EXPERT_EXTRACT", "JT_SUPER_TENDER_FILE", "评标专家确定方式");
            /// <summary>
			/// 财务最低要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE = new Field("FINANCIAL_REQUIRE", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "财务最低要求");
            /// <summary>
			/// 项目经理和项目总工资格
			/// </summary>
			public readonly static Field QUALIFICATION_REQUIRE = new Field("QUALIFICATION_REQUIRE", "JT_SUPER_TENDER_FILE",DbType.AnsiString, null, "项目经理和项目总工资格");
            /// <summary>
			/// 评标委员会推荐中标候选人人数
			/// </summary>
			public readonly static Field WIN_CANDIDATE_NUM = new Field("WIN_CANDIDATE_NUM", "JT_SUPER_TENDER_FILE", "评标委员会推荐中标候选人人数");
            /// <summary>
			/// 发包人
			/// </summary>
			public readonly static Field SUBC_NAME = new Field("SUBC_NAME", "JT_SUPER_TENDER_FILE", "发包人");
            /// <summary>
			/// 发包人地址
			/// </summary>
			public readonly static Field SUBC_ADDRESS = new Field("SUBC_ADDRESS", "JT_SUPER_TENDER_FILE", "发包人地址");
            /// <summary>
			/// 发包人邮政编码
			/// </summary>
			public readonly static Field SUBC_ZIP_CODE = new Field("SUBC_ZIP_CODE", "JT_SUPER_TENDER_FILE", "发包人邮政编码");
            /// <summary>
			/// 因物价波动引起的价格调整按照第几项约定的原则处理
			/// </summary>
			public readonly static Field CONVENTION = new Field("CONVENTION", "JT_SUPER_TENDER_FILE", "因物价波动引起的价格调整按照第几项约定的原则处理");
            /// <summary>
			/// 材料名称
			/// </summary>
			public readonly static Field MATERIAL = new Field("MATERIAL", "JT_SUPER_TENDER_FILE", "材料名称");
            /// <summary>
			/// 争议的最终解决方式
			/// </summary>
			public readonly static Field DISPUTE_RESOLUTION = new Field("DISPUTE_RESOLUTION", "JT_SUPER_TENDER_FILE", "争议的最终解决方式");
            /// <summary>
			/// 仲裁委员会名称
			/// </summary>
			public readonly static Field ARBITRATION_COMMISSION = new Field("ARBITRATION_COMMISSION", "JT_SUPER_TENDER_FILE", "仲裁委员会名称");
            /// <summary>
			/// 单据所列费用
			/// </summary>
			public readonly static Field DOCUMENT_CHARGES = new Field("DOCUMENT_CHARGES", "JT_SUPER_TENDER_FILE", "单据所列费用");
            /// <summary>
			/// 进度付款证书最低限额
			/// </summary>
			public readonly static Field MINIMUM_LIMIT = new Field("MINIMUM_LIMIT", "JT_SUPER_TENDER_FILE", "进度付款证书最低限额");
            /// <summary>
			/// 工程量清单
			/// </summary>
			public readonly static Field BILL_OF_QUANTITIES = new Field("BILL_OF_QUANTITIES", "JT_SUPER_TENDER_FILE", "工程量清单");
            /// <summary>
			/// 图纸
			/// </summary>
			public readonly static Field DRAWING = new Field("DRAWING", "JT_SUPER_TENDER_FILE", "图纸");
            /// <summary>
			/// 技术规范
			/// </summary>
			public readonly static Field TECHNICAL_SPECIFICATIONS = new Field("TECHNICAL_SPECIFICATIONS", "JT_SUPER_TENDER_FILE", "技术规范");
            /// <summary>
			/// 补充技术规范
			/// </summary>
			public readonly static Field SUPPLY_TECHNICAL_STANDARD = new Field("SUPPLY_TECHNICAL_STANDARD", "JT_SUPER_TENDER_FILE", "补充技术规范");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_SUPER_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_SUPER_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_SUPER_TENDER_FILE", "");
        }
        #endregion
	}
}