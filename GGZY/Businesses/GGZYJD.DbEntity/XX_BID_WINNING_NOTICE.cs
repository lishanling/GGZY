...
{
    /// <summary>
    /// 实体类XX_BID_WINNING_NOTICE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("XX_BID_WINNING_NOTICE")]
    [Serializable]
    public partial class XX_BID_WINNING_NOTICE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "XX_BID_WINNING_NOTICE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "XX_BID_WINNING_NOTICE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "XX_BID_WINNING_NOTICE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "XX_BID_WINNING_NOTICE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "XX_BID_WINNING_NOTICE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "XX_BID_WINNING_NOTICE", "");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "XX_BID_WINNING_NOTICE", "项目编号");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "XX_BID_WINNING_NOTICE", "招标项目编号");
            /// <summary>
			/// 招标项目名称
			/// </summary>
			public readonly static Field TENDER_PROJECT_NAME = new Field("TENDER_PROJECT_NAME", "XX_BID_WINNING_NOTICE", "招标项目名称");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "XX_BID_WINNING_NOTICE",DbType.AnsiString, null, "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "XX_BID_WINNING_NOTICE", "统一交易标识码");
            /// <summary>
			/// 中标通知书编号（企业）
			/// </summary>
			public readonly static Field WIN_NOTICE_CODE_ENTP = new Field("WIN_NOTICE_CODE_ENTP", "XX_BID_WINNING_NOTICE", "中标通知书编号（企业）");
            /// <summary>
			/// 中标通知书编号（主管部门）
			/// </summary>
			public readonly static Field WIN_NOTICE_CODE = new Field("WIN_NOTICE_CODE", "XX_BID_WINNING_NOTICE", "中标通知书编号（主管部门）");
            /// <summary>
			/// 中标人名称
			/// </summary>
			public readonly static Field WIN_BIDDER_NAME = new Field("WIN_BIDDER_NAME", "XX_BID_WINNING_NOTICE", "中标人名称");
            /// <summary>
			/// 中标人统一社会信用代码
			/// </summary>
			public readonly static Field WIN_BIDDER_CODE = new Field("WIN_BIDDER_CODE", "XX_BID_WINNING_NOTICE", "中标人统一社会信用代码");
            /// <summary>
			/// 投标日期
			/// </summary>
			public readonly static Field BID_TIME = new Field("BID_TIME", "XX_BID_WINNING_NOTICE", "投标日期");
            /// <summary>
			/// 招标范围和内容
			/// </summary>
			public readonly static Field TENDER_NOTICE_CONTENT = new Field("TENDER_NOTICE_CONTENT", "XX_BID_WINNING_NOTICE",DbType.AnsiString, null, "招标范围和内容");
            /// <summary>
			/// 工期
			/// </summary>
			public readonly static Field TIME_LIMIT = new Field("TIME_LIMIT", "XX_BID_WINNING_NOTICE", "工期");
            /// <summary>
			/// 中标价
			/// </summary>
			public readonly static Field BID_AMOUNT = new Field("BID_AMOUNT", "XX_BID_WINNING_NOTICE", "中标价");
            /// <summary>
			/// 价格币种代码
			/// </summary>
			public readonly static Field BID_CURRENCY = new Field("BID_CURRENCY", "XX_BID_WINNING_NOTICE", "价格币种代码");
            /// <summary>
			/// 价格单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "XX_BID_WINNING_NOTICE", "价格单位");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "XX_BID_WINNING_NOTICE", "价款形式代码");
            /// <summary>
			/// 费率或其它类型结果
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "XX_BID_WINNING_NOTICE",DbType.AnsiString, null, "费率或其它类型结果");
            /// <summary>
			/// 项目负责人
			/// </summary>
			public readonly static Field PROJECT_LEAD = new Field("PROJECT_LEAD", "XX_BID_WINNING_NOTICE",DbType.AnsiString, null, "项目负责人");
            /// <summary>
			/// 项目负责人身份证号码
			/// </summary>
			public readonly static Field PROJECT_LEAD_ID = new Field("PROJECT_LEAD_ID", "XX_BID_WINNING_NOTICE", "项目负责人身份证号码");
            /// <summary>
			/// 项目负责人注册证书类别及注册证书号
			/// </summary>
			public readonly static Field PROJECT_LEAD_CERTITY_NO = new Field("PROJECT_LEAD_CERTITY_NO", "XX_BID_WINNING_NOTICE", "项目负责人注册证书类别及注册证书号");
            /// <summary>
			/// 中标通知书的文本内容
			/// </summary>
			public readonly static Field WIN_NOTICE_CONTENT = new Field("WIN_NOTICE_CONTENT", "XX_BID_WINNING_NOTICE",DbType.AnsiString, null, "中标通知书的文本内容");
            /// <summary>
			/// 中标通知书发出日期
			/// </summary>
			public readonly static Field WIN_NOTICE_SEND_TIME = new Field("WIN_NOTICE_SEND_TIME", "XX_BID_WINNING_NOTICE", "中标通知书发出日期");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "XX_BID_WINNING_NOTICE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "XX_BID_WINNING_NOTICE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "XX_BID_WINNING_NOTICE", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "XX_BID_WINNING_NOTICE", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "XX_BID_WINNING_NOTICE", "公共服务平台标识码");
        }
        #endregion
	}
}