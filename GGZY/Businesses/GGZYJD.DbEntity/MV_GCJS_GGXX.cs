...
{
    /// <summary>
    /// 实体类MV_GCJS_GGXX。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("MV_GCJS_GGXX")]
    [Serializable]
    public partial class MV_GCJS_GGXX : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "MV_GCJS_GGXX");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_CATEGORY = new Field("PROJECT_CATEGORY", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field KIND = new Field("KIND", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field HY_TYPE = new Field("HY_TYPE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_TYPE = new Field("PROJECT_TYPE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROTYPE_TEXT = new Field("PROTYPE_TEXT", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field NAME = new Field("NAME", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TITLE = new Field("TITLE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field GGTYPE = new Field("GGTYPE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AREANAME = new Field("AREANAME", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PLATFORM_NAME = new Field("PLATFORM_NAME", "MV_GCJS_GGXX", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TM = new Field("TM", "MV_GCJS_GGXX", "");
        }
        #endregion
	}
}