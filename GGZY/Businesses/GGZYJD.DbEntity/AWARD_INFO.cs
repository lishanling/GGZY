...
namespace GGZYJD.DbEntity
{
    ...
    [Table("AWARD_INFO")]
    [Serializable]
    public partial class AWARD_INFO : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 发布人员ID
			/// </summary>
			public readonly static Field USER_ID = new Field("USER_ID", "AWARD_INFO", "发布人员ID");
            /// <summary>
			/// 发布时间
			/// </summary>
			public readonly static Field COMMIT_TIME = new Field("COMMIT_TIME", "AWARD_INFO", "发布时间");
        }
        #endregion
	}
}