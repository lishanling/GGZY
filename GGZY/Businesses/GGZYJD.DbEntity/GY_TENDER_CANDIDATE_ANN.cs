...
{
    /// <summary>
    /// 实体类GY_TENDER_CANDIDATE_ANN。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("GY_TENDER_CANDIDATE_ANN")]
    [Serializable]
    public partial class GY_TENDER_CANDIDATE_ANN : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "GY_TENDER_CANDIDATE_ANN");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "GY_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "GY_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "GY_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "GY_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "GY_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "GY_TENDER_CANDIDATE_ANN", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "GY_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 相关统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "GY_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "相关统一交易标识码");
            /// <summary>
			/// 公示标题
			/// </summary>
			public readonly static Field PUBLICITY_NAME = new Field("PUBLICITY_NAME", "GY_TENDER_CANDIDATE_ANN", "公示标题");
            /// <summary>
			/// 公示内容
			/// </summary>
			public readonly static Field PUBLICITY_CONTENT = new Field("PUBLICITY_CONTENT", "GY_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "公示内容");
            /// <summary>
			/// 公示提交时间
			/// </summary>
			public readonly static Field PUBLICITY_REFER_TIME = new Field("PUBLICITY_REFER_TIME", "GY_TENDER_CANDIDATE_ANN", "公示提交时间");
            /// <summary>
			/// 公示发布媒体
			/// </summary>
			public readonly static Field NOTICE_MEDIA = new Field("NOTICE_MEDIA", "GY_TENDER_CANDIDATE_ANN", "公示发布媒体");
            /// <summary>
			/// 公示源URL
			/// </summary>
			public readonly static Field URL = new Field("URL", "GY_TENDER_CANDIDATE_ANN", "公示源URL");
            /// <summary>
			/// 公示类型
			/// </summary>
			public readonly static Field PUBLICITY_TYPE = new Field("PUBLICITY_TYPE", "GY_TENDER_CANDIDATE_ANN", "公示类型");
            /// <summary>
			/// 公示开始时间
			/// </summary>
			public readonly static Field PUBLICITY_START_TIME = new Field("PUBLICITY_START_TIME", "GY_TENDER_CANDIDATE_ANN", "公示开始时间");
            /// <summary>
			/// 公示结束时间
			/// </summary>
			public readonly static Field PUBLICITY_END_TIME = new Field("PUBLICITY_END_TIME", "GY_TENDER_CANDIDATE_ANN", "公示结束时间");
            /// <summary>
			/// 提出异议的渠道和方式
			/// </summary>
			public readonly static Field OBJECTION_METHOD = new Field("OBJECTION_METHOD", "GY_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "提出异议的渠道和方式");
            /// <summary>
			/// 其他内容
			/// </summary>
			public readonly static Field OTHER_CONTENT = new Field("OTHER_CONTENT", "GY_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "其他内容");
            /// <summary>
			/// 第一中标候选人名称
			/// </summary>
			public readonly static Field FIRST_BIDDER_NAME = new Field("FIRST_BIDDER_NAME", "GY_TENDER_CANDIDATE_ANN", "第一中标候选人名称");
            /// <summary>
			/// 第一中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field FIRST_BIDDER_CODE = new Field("FIRST_BIDDER_CODE", "GY_TENDER_CANDIDATE_ANN", "第一中标候选人统一社会信用代码");
            /// <summary>
			/// 第二中标候选人名称
			/// </summary>
			public readonly static Field SECOND_BIDDER_NAME = new Field("SECOND_BIDDER_NAME", "GY_TENDER_CANDIDATE_ANN", "第二中标候选人名称");
            /// <summary>
			/// 第二中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field SECOND_BIDDER_CODE = new Field("SECOND_BIDDER_CODE", "GY_TENDER_CANDIDATE_ANN", "第二中标候选人统一社会信用代码");
            /// <summary>
			/// 第三中标候选人名称
			/// </summary>
			public readonly static Field THIRD_BIDDER_NAME = new Field("THIRD_BIDDER_NAME", "GY_TENDER_CANDIDATE_ANN", "第三中标候选人名称");
            /// <summary>
			/// 第三中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field THIRD_BIDDER_CODE = new Field("THIRD_BIDDER_CODE", "GY_TENDER_CANDIDATE_ANN", "第三中标候选人统一社会信用代码");
            /// <summary>
			/// 公示发布责任人
			/// </summary>
			public readonly static Field BULLETIN_DUTY = new Field("BULLETIN_DUTY", "GY_TENDER_CANDIDATE_ANN", "公示发布责任人");
            /// <summary>
			/// 交易平台数据验证责任人姓名
			/// </summary>
			public readonly static Field EXAMINER_NAME = new Field("EXAMINER_NAME", "GY_TENDER_CANDIDATE_ANN", "交易平台数据验证责任人姓名");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "GY_TENDER_CANDIDATE_ANN", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "GY_TENDER_CANDIDATE_ANN", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "GY_TENDER_CANDIDATE_ANN", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "GY_TENDER_CANDIDATE_ANN", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "GY_TENDER_CANDIDATE_ANN", "公共服务平台标识码");
        }
        #endregion
	}
}