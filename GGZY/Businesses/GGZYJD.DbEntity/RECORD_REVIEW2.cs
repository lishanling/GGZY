...
{
    /// <summary>
    /// 实体类RECORD_REVIEW2。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("RECORD_REVIEW2")]
    [Serializable]
    public partial class RECORD_REVIEW2 : JdEntity
    {
        #region Model
		private decimal? _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "RECORD_REVIEW2");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ID = new Field("ID", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_CODE = new Field("REVIEW_CODE", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_TYPE = new Field("REVIEW_TYPE", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field COMMIT_TIME = new Field("COMMIT_TIME", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_STATUS = new Field("REVIEW_STATUS", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field SIGN_TIME = new Field("SIGN_TIME", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field SIGN_PERSON = new Field("SIGN_PERSON", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field SIGN_COMMENT = new Field("SIGN_COMMENT", "RECORD_REVIEW2",DbType.AnsiString, null, "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_TIME = new Field("REVIEW_TIME", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_PERSON = new Field("REVIEW_PERSON", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REVIEW_COMMENT = new Field("REVIEW_COMMENT", "RECORD_REVIEW2",DbType.AnsiString, null, "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IS_ADJUST = new Field("IS_ADJUST", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ADJUST_TIME = new Field("ADJUST_TIME", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AMENDMENT_OPINION = new Field("AMENDMENT_OPINION", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field CREATE_TM = new Field("CREATE_TM", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field CREATOR = new Field("CREATOR", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AUDIT_UNIT = new Field("AUDIT_UNIT", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IS_SIGN = new Field("IS_SIGN", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ADJUST_PERSON = new Field("ADJUST_PERSON", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IS_SUBMIT_AGAIN = new Field("IS_SUBMIT_AGAIN", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IS_GET_DATA = new Field("IS_GET_DATA", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field SIGN_OVER_TM = new Field("SIGN_OVER_TM", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OVER_TM = new Field("OVER_TM", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field GET_SYSTEM_NO = new Field("GET_SYSTEM_NO", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field GET_DATA_TIME = new Field("GET_DATA_TIME", "RECORD_REVIEW2", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "RECORD_REVIEW2", "");
        }
        #endregion
	}
}