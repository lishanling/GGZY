...
{
    /// <summary>
    /// 实体类JT_LETTER_OF_GUARANTEE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_LETTER_OF_GUARANTEE")]
    [Serializable]
    public partial class JT_LETTER_OF_GUARANTEE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_LETTER_OF_GUARANTEE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATOR = new Field("M_CREATOR", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_LETTER_OF_GUARANTEE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "JT_LETTER_OF_GUARANTEE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "JT_LETTER_OF_GUARANTEE", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "JT_LETTER_OF_GUARANTEE", "投标人名称");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "JT_LETTER_OF_GUARANTEE", "投标人代码");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "JT_LETTER_OF_GUARANTEE", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "JT_LETTER_OF_GUARANTEE", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 保函类型
			/// </summary>
			public readonly static Field GUARANTEE_TYPE = new Field("GUARANTEE_TYPE", "JT_LETTER_OF_GUARANTEE", "保函类型");
            /// <summary>
			/// 保函编号
			/// </summary>
			public readonly static Field GUARANTEE_NO = new Field("GUARANTEE_NO", "JT_LETTER_OF_GUARANTEE", "保函编号");
            /// <summary>
			/// 保函状态
			/// </summary>
			public readonly static Field GUARANTEE_STATUS = new Field("GUARANTEE_STATUS", "JT_LETTER_OF_GUARANTEE", "保函状态");
            /// <summary>
			/// 受益人
			/// </summary>
			public readonly static Field BENEFICIARY = new Field("BENEFICIARY", "JT_LETTER_OF_GUARANTEE", "受益人");
            /// <summary>
			/// 承保人
			/// </summary>
			public readonly static Field INSURER = new Field("INSURER", "JT_LETTER_OF_GUARANTEE", "承保人");
            /// <summary>
			/// 担保金额
			/// </summary>
			public readonly static Field GUARANTEE_AMOUNT = new Field("GUARANTEE_AMOUNT", "JT_LETTER_OF_GUARANTEE", "担保金额");
            /// <summary>
			/// 担保费用
			/// </summary>
			public readonly static Field GUARANTEE_COST = new Field("GUARANTEE_COST", "JT_LETTER_OF_GUARANTEE", "担保费用");
            /// <summary>
			/// 保函创建时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "JT_LETTER_OF_GUARANTEE", "保函创建时间");
            /// <summary>
			/// 担保开始时间
			/// </summary>
			public readonly static Field BEGIN_TIME = new Field("BEGIN_TIME", "JT_LETTER_OF_GUARANTEE", "担保开始时间");
            /// <summary>
			/// 担保结束时间
			/// </summary>
			public readonly static Field END_TIME = new Field("END_TIME", "JT_LETTER_OF_GUARANTEE", "担保结束时间");
            /// <summary>
			/// 支付方式
			/// </summary>
			public readonly static Field PAYMENT_METHOD = new Field("PAYMENT_METHOD", "JT_LETTER_OF_GUARANTEE", "支付方式");
            /// <summary>
			/// 支付时间
			/// </summary>
			public readonly static Field PAYMENT_TIME = new Field("PAYMENT_TIME", "JT_LETTER_OF_GUARANTEE", "支付时间");
            /// <summary>
			/// 出函时间
			/// </summary>
			public readonly static Field LETTER_TIME = new Field("LETTER_TIME", "JT_LETTER_OF_GUARANTEE", "出函时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_LETTER_OF_GUARANTEE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_LETTER_OF_GUARANTEE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_LETTER_OF_GUARANTEE", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 申请人员
			/// </summary>
			public readonly static Field PROPOSER = new Field("PROPOSER", "JT_LETTER_OF_GUARANTEE", "申请人员");
            /// <summary>
			/// 申请人员联系方式
			/// </summary>
			public readonly static Field PROPOSER_PHONE = new Field("PROPOSER_PHONE", "JT_LETTER_OF_GUARANTEE", "申请人员联系方式");
            /// <summary>
			/// 证件类型
			/// </summary>
			public readonly static Field PROPOSER_CARD_TYPE = new Field("PROPOSER_CARD_TYPE", "JT_LETTER_OF_GUARANTEE", "证件类型");
            /// <summary>
			/// 证件号码
			/// </summary>
			public readonly static Field PROPOSER_CODE = new Field("PROPOSER_CODE", "JT_LETTER_OF_GUARANTEE", "证件号码");
            /// <summary>
			/// 支付账号
			/// </summary>
			public readonly static Field PURCHASE_ACCOUN = new Field("PURCHASE_ACCOUN", "JT_LETTER_OF_GUARANTEE", "支付账号");
            /// <summary>
			/// 费率
			/// </summary>
			public readonly static Field RATE = new Field("RATE", "JT_LETTER_OF_GUARANTEE", "费率");
            /// <summary>
			/// 电子保单文件下载地址
			/// </summary>
			public readonly static Field GUARANTEE_URL = new Field("GUARANTEE_URL", "JT_LETTER_OF_GUARANTEE", "电子保单文件下载地址");
            /// <summary>
			/// 电子保单文件md5码
			/// </summary>
			public readonly static Field GUARANTEE_MD5 = new Field("GUARANTEE_MD5", "JT_LETTER_OF_GUARANTEE", "电子保单文件md5码");
        }
        #endregion
	}
}