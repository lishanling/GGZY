...
{
    /// <summary>
    /// 实体类SL_WIN_RESULT_ANNO。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SL_WIN_RESULT_ANNO")]
    [Serializable]
    public partial class SL_WIN_RESULT_ANNO : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SL_WIN_RESULT_ANNO");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "SL_WIN_RESULT_ANNO", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "SL_WIN_RESULT_ANNO", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "SL_WIN_RESULT_ANNO", "统一交易标识码");
            /// <summary>
			/// 公告标题
			/// </summary>
			public readonly static Field NOTICE_NAME = new Field("NOTICE_NAME", "SL_WIN_RESULT_ANNO", "公告标题");
            /// <summary>
			/// 公告内容
			/// </summary>
			public readonly static Field NOTICE_CONTENT = new Field("NOTICE_CONTENT", "SL_WIN_RESULT_ANNO",DbType.AnsiString, null, "公告内容");
            /// <summary>
			/// 公告发布时间
			/// </summary>
			public readonly static Field NOTICE_SEND_TIME = new Field("NOTICE_SEND_TIME", "SL_WIN_RESULT_ANNO", "公告发布时间");
            /// <summary>
			/// 公告发布媒体
			/// </summary>
			public readonly static Field NOTICE_MEDIA = new Field("NOTICE_MEDIA", "SL_WIN_RESULT_ANNO", "公告发布媒体");
            /// <summary>
			/// 公告源URL
			/// </summary>
			public readonly static Field URL = new Field("URL", "SL_WIN_RESULT_ANNO", "公告源URL");
            /// <summary>
			/// 公告性质
			/// </summary>
			public readonly static Field NOTICE_NATURE = new Field("NOTICE_NATURE", "SL_WIN_RESULT_ANNO", "公告性质");
            /// <summary>
			/// 公告类型
			/// </summary>
			public readonly static Field BULLETIN_TYPE = new Field("BULLETIN_TYPE", "SL_WIN_RESULT_ANNO", "公告类型");
            /// <summary>
			/// 中标投标人名称
			/// </summary>
			public readonly static Field WIN_BIDDER_NAME = new Field("WIN_BIDDER_NAME", "SL_WIN_RESULT_ANNO", "中标投标人名称");
            /// <summary>
			/// 中标投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "SL_WIN_RESULT_ANNO", "中标投标人类别");
            /// <summary>
			/// 中标投标人代码
			/// </summary>
			public readonly static Field WIN_BIDDER_CODE = new Field("WIN_BIDDER_CODE", "SL_WIN_RESULT_ANNO", "中标投标人代码");
            /// <summary>
			/// 中标投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "SL_WIN_RESULT_ANNO", "中标投标人角色");
            /// <summary>
			/// 中标金额
			/// </summary>
			public readonly static Field BID_AMOUNT = new Field("BID_AMOUNT", "SL_WIN_RESULT_ANNO", "中标金额");
            /// <summary>
			/// 价格币种代码
			/// </summary>
			public readonly static Field BID_CURRENCY = new Field("BID_CURRENCY", "SL_WIN_RESULT_ANNO", "价格币种代码");
            /// <summary>
			/// 价格单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "SL_WIN_RESULT_ANNO", "价格单位");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "SL_WIN_RESULT_ANNO", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "SL_WIN_RESULT_ANNO", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "SL_WIN_RESULT_ANNO", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "SL_WIN_RESULT_ANNO", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "SL_WIN_RESULT_ANNO", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "SL_WIN_RESULT_ANNO", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "SL_WIN_RESULT_ANNO", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "SL_WIN_RESULT_ANNO", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "SL_WIN_RESULT_ANNO", "M_TM");
            /// <summary>
			/// 联合体代码
			/// </summary>
			public readonly static Field UNION_CODE = new Field("UNION_CODE", "SL_WIN_RESULT_ANNO", "联合体代码");
            /// <summary>
			/// 联合体名称
			/// </summary>
			public readonly static Field UNION_NAME = new Field("UNION_NAME", "SL_WIN_RESULT_ANNO", "联合体名称");
            /// <summary>
			/// 中标费率
			/// </summary>
			public readonly static Field RATE = new Field("RATE", "SL_WIN_RESULT_ANNO", "中标费率");
            /// <summary>
			/// 其他类型中标价
			/// </summary>
			public readonly static Field OTHER_WIN_PRICE = new Field("OTHER_WIN_PRICE", "SL_WIN_RESULT_ANNO",DbType.AnsiString, null, "其他类型中标价");
            /// <summary>
			/// 其他内容
			/// </summary>
			public readonly static Field OTHER_CONTENT = new Field("OTHER_CONTENT", "SL_WIN_RESULT_ANNO",DbType.AnsiString, null, "其他内容");
            /// <summary>
			/// &quot;公示发布责任人 &quot;
			/// </summary>
			public readonly static Field BULLETIN_DUTY = new Field("BULLETIN_DUTY", "SL_WIN_RESULT_ANNO", "&quot;公示发布责任人 &quot;");
            /// <summary>
			/// &quot;交易平台数据验证责任人姓名 &quot;
			/// </summary>
			public readonly static Field EXAMINER_NAME = new Field("EXAMINER_NAME", "SL_WIN_RESULT_ANNO", "&quot;交易平台数据验证责任人姓名 &quot;");
            /// <summary>
			/// 标段（包）所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "SL_WIN_RESULT_ANNO", "标段（包）所在行政区域代码");
            /// <summary>
			/// 交易发生行政区域代码
			/// </summary>
			public readonly static Field TRA_PLACE_CODE = new Field("TRA_PLACE_CODE", "SL_WIN_RESULT_ANNO", "交易发生行政区域代码");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDER_AGENCY_NAME = new Field("TENDER_AGENCY_NAME", "SL_WIN_RESULT_ANNO", "招标代理机构名称");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE = new Field("TENDER_AGENCY_CODE", "SL_WIN_RESULT_ANNO", "招标代理机构代码");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "SL_WIN_RESULT_ANNO", "价款形式代码");
            /// <summary>
			/// 费率或其它类型结果
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "SL_WIN_RESULT_ANNO",DbType.AnsiString, null, "费率或其它类型结果");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "SL_WIN_RESULT_ANNO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "SL_WIN_RESULT_ANNO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "SL_WIN_RESULT_ANNO", "");
            /// <summary>
			/// 中标投标人企业注册所在地
			/// </summary>
			public readonly static Field BIDDER_REGION_CODE = new Field("BIDDER_REGION_CODE", "SL_WIN_RESULT_ANNO", "中标投标人企业注册所在地");
            /// <summary>
			/// 中标投标人企业性质
			/// </summary>
			public readonly static Field BIDDER_PROPERTY = new Field("BIDDER_PROPERTY", "SL_WIN_RESULT_ANNO", "中标投标人企业性质");
            /// <summary>
			/// 项目负责人
			/// </summary>
			public readonly static Field PROJECT_LEAD = new Field("PROJECT_LEAD", "SL_WIN_RESULT_ANNO", "项目负责人");
            /// <summary>
			/// 项目负责人身份证号码
			/// </summary>
			public readonly static Field PROJECT_LEAD_ID = new Field("PROJECT_LEAD_ID", "SL_WIN_RESULT_ANNO", "项目负责人身份证号码");
        }
        #endregion
	}
}