...
{
    /// <summary>
    /// 实体类SL_CONTRACT_PERFORMANCE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SL_CONTRACT_PERFORMANCE")]
    [Serializable]
    public partial class SL_CONTRACT_PERFORMANCE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SL_CONTRACT_PERFORMANCE");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "SL_CONTRACT_PERFORMANCE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "SL_CONTRACT_PERFORMANCE", "统一交易标识码");
            /// <summary>
			/// 合同名称
			/// </summary>
			public readonly static Field CONTRACT_NAME = new Field("CONTRACT_NAME", "SL_CONTRACT_PERFORMANCE", "合同名称");
            /// <summary>
			/// 招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "SL_CONTRACT_PERFORMANCE", "招标人名称");
            /// <summary>
			/// 招标人代码
			/// </summary>
			public readonly static Field TENDER_CODE = new Field("TENDER_CODE", "SL_CONTRACT_PERFORMANCE", "招标人代码");
            /// <summary>
			/// 中标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "SL_CONTRACT_PERFORMANCE", "中标人名称");
            /// <summary>
			/// 中标人代码
			/// </summary>
			public readonly static Field BIDDER_CODE = new Field("BIDDER_CODE", "SL_CONTRACT_PERFORMANCE", "中标人代码");
            /// <summary>
			/// 合同金额
			/// </summary>
			public readonly static Field CONTRACT_PRICE = new Field("CONTRACT_PRICE", "SL_CONTRACT_PERFORMANCE", "合同金额");
            /// <summary>
			/// 合同结算金额
			/// </summary>
			public readonly static Field SETTLE_PRICE = new Field("SETTLE_PRICE", "SL_CONTRACT_PERFORMANCE", "合同结算金额");
            /// <summary>
			/// 金额币种代码
			/// </summary>
			public readonly static Field PRICE_CURRENCY = new Field("PRICE_CURRENCY", "SL_CONTRACT_PERFORMANCE", "金额币种代码");
            /// <summary>
			/// 金额单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "SL_CONTRACT_PERFORMANCE", "金额单位");
            /// <summary>
			/// 合同主要内容
			/// </summary>
			public readonly static Field CONTRACT_CONTENT = new Field("CONTRACT_CONTENT", "SL_CONTRACT_PERFORMANCE",DbType.AnsiString, null, "合同主要内容");
            /// <summary>
			/// 合同期限
			/// </summary>
			public readonly static Field LIMITE_TIME = new Field("LIMITE_TIME", "SL_CONTRACT_PERFORMANCE", "合同期限");
            /// <summary>
			/// 质量要求
			/// </summary>
			public readonly static Field QUALITY_REQUIRE = new Field("QUALITY_REQUIRE", "SL_CONTRACT_PERFORMANCE",DbType.AnsiString, null, "质量要求");
            /// <summary>
			/// 履约变更内容
			/// </summary>
			public readonly static Field PERFORM_CHANGE_CONTENT = new Field("PERFORM_CHANGE_CONTENT", "SL_CONTRACT_PERFORMANCE",DbType.AnsiString, null, "履约变更内容");
            /// <summary>
			/// 合同完成时间
			/// </summary>
			public readonly static Field FINISH_TIME = new Field("FINISH_TIME", "SL_CONTRACT_PERFORMANCE", "合同完成时间");
            /// <summary>
			/// 实际履约期限
			/// </summary>
			public readonly static Field ACTUALLY_PERIOD = new Field("ACTUALLY_PERIOD", "SL_CONTRACT_PERFORMANCE", "实际履约期限");
            /// <summary>
			/// 履约信息
			/// </summary>
			public readonly static Field PERFORM_INFO = new Field("PERFORM_INFO", "SL_CONTRACT_PERFORMANCE",DbType.AnsiString, null, "履约信息");
            /// <summary>
			/// 递交时间
			/// </summary>
			public readonly static Field SUBMIT_TIME = new Field("SUBMIT_TIME", "SL_CONTRACT_PERFORMANCE", "递交时间");
            /// <summary>
			/// 合同签署时间
			/// </summary>
			public readonly static Field CONTRACT_SIGN_TIME = new Field("CONTRACT_SIGN_TIME", "SL_CONTRACT_PERFORMANCE", "合同签署时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "SL_CONTRACT_PERFORMANCE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "SL_CONTRACT_PERFORMANCE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "SL_CONTRACT_PERFORMANCE", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "SL_CONTRACT_PERFORMANCE", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "SL_CONTRACT_PERFORMANCE", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "SL_CONTRACT_PERFORMANCE", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "SL_CONTRACT_PERFORMANCE", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "SL_CONTRACT_PERFORMANCE", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "SL_CONTRACT_PERFORMANCE", "M_TM");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "SL_CONTRACT_PERFORMANCE", "招标项目编号");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "SL_CONTRACT_PERFORMANCE", "价款形式代码");
            /// <summary>
			/// 其它形式合同报价
			/// </summary>
			public readonly static Field OTHER_CONTRACT_PRICE = new Field("OTHER_CONTRACT_PRICE", "SL_CONTRACT_PERFORMANCE", "其它形式合同报价");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "SL_CONTRACT_PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "SL_CONTRACT_PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "SL_CONTRACT_PERFORMANCE", "");
            /// <summary>
			/// 合同编号
			/// </summary>
			public readonly static Field CONTRACT_CODE = new Field("CONTRACT_CODE", "SL_CONTRACT_PERFORMANCE", "合同编号");
        }
        #endregion
	}
}