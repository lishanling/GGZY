...
{
    /// <summary>
    /// 实体类GY_TENDER_CANDIDATE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("GY_TENDER_CANDIDATE")]
    [Serializable]
    public partial class GY_TENDER_CANDIDATE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "GY_TENDER_CANDIDATE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "GY_TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "GY_TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "GY_TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "GY_TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "GY_TENDER_CANDIDATE", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "GY_TENDER_CANDIDATE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "GY_TENDER_CANDIDATE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "GY_TENDER_CANDIDATE", "统一交易标识码");
            /// <summary>
			/// 中标候选人名称
			/// </summary>
			public readonly static Field WIN_CANDIDATE_NAME = new Field("WIN_CANDIDATE_NAME", "GY_TENDER_CANDIDATE", "中标候选人名称");
            /// <summary>
			/// 中标候选人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "GY_TENDER_CANDIDATE", "中标候选人类别");
            /// <summary>
			/// 中标候选人代码
			/// </summary>
			public readonly static Field WIN_CANDIDATE_CODE = new Field("WIN_CANDIDATE_CODE", "GY_TENDER_CANDIDATE", "中标候选人代码");
            /// <summary>
			/// 中标候选人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "GY_TENDER_CANDIDATE", "中标候选人角色");
            /// <summary>
			/// 中标候选人人企业注册所在地
			/// </summary>
			public readonly static Field BIDDER_REGION_CODE = new Field("BIDDER_REGION_CODE", "GY_TENDER_CANDIDATE", "中标候选人人企业注册所在地");
            /// <summary>
			/// 中标候选人企业性质
			/// </summary>
			public readonly static Field BIDDER_PROPERTY = new Field("BIDDER_PROPERTY", "GY_TENDER_CANDIDATE", "中标候选人企业性质");
            /// <summary>
			/// 中标候选人排名
			/// </summary>
			public readonly static Field WIN_CANDIDATE_ORDER = new Field("WIN_CANDIDATE_ORDER", "GY_TENDER_CANDIDATE", "中标候选人排名");
            /// <summary>
			/// 是否采用下浮率
			/// </summary>
			public readonly static Field IS_FLOAT_RATE = new Field("IS_FLOAT_RATE", "GY_TENDER_CANDIDATE", "是否采用下浮率");
            /// <summary>
			/// 评分结果
			/// </summary>
			public readonly static Field EVALUATION_RESULT = new Field("EVALUATION_RESULT", "GY_TENDER_CANDIDATE",DbType.AnsiString, null, "评分结果");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "GY_TENDER_CANDIDATE", "价款形式代码");
            /// <summary>
			/// 费率或其它类型报价
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "GY_TENDER_CANDIDATE",DbType.AnsiString, null, "费率或其它类型报价");
            /// <summary>
			/// 投标价格
			/// </summary>
			public readonly static Field BID_PRICE = new Field("BID_PRICE", "GY_TENDER_CANDIDATE", "投标价格");
            /// <summary>
			/// 价格币种代码
			/// </summary>
			public readonly static Field PRICE_CURRENCY = new Field("PRICE_CURRENCY", "GY_TENDER_CANDIDATE", "价格币种代码");
            /// <summary>
			/// 价格单位
			/// </summary>
			public readonly static Field PRICE_UINT = new Field("PRICE_UINT", "GY_TENDER_CANDIDATE", "价格单位");
            /// <summary>
			/// 质量
			/// </summary>
			public readonly static Field QUALITY = new Field("QUALITY", "GY_TENDER_CANDIDATE",DbType.AnsiString, null, "质量");
            /// <summary>
			/// 评标情况
			/// </summary>
			public readonly static Field EVALUATION_STATUS = new Field("EVALUATION_STATUS", "GY_TENDER_CANDIDATE",DbType.AnsiString, null, "评标情况");
            /// <summary>
			/// 中标候选人响应招标文件的资格能力条件
			/// </summary>
			public readonly static Field WIN_CANDIDATE_QUALIFICATION = new Field("WIN_CANDIDATE_QUALIFICATION", "GY_TENDER_CANDIDATE",DbType.AnsiString, null, "中标候选人响应招标文件的资格能力条件");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "GY_TENDER_CANDIDATE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "GY_TENDER_CANDIDATE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "GY_TENDER_CANDIDATE", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "GY_TENDER_CANDIDATE", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "GY_TENDER_CANDIDATE", "公共服务平台标识码");
        }
        #endregion
	}
}