...
{
    /// <summary>
    /// 实体类T_FRAUD。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("T_FRAUD")]
    [Serializable]
    public partial class T_FRAUD : JdEntity
    {
        #region Model
		private decimal? _ID;
		...
		private string _PUNISHMENT_TYPE;
		...
		{
			get{ return _PUNISHMENT_TYPE; }
			set
			{
				this.OnPropertyValueChange(_.PUNISHMENT_TYPE, _PUNISHMENT_TYPE, value);
				this._PUNISHMENT_TYPE = value;
			}
		}
		/// <summary>
		/// 附件
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "T_FRAUD");
            /// <summary>
			/// ID
			/// </summary>
			public readonly static Field ID = new Field("ID", "T_FRAUD", "ID");
            /// <summary>
			/// 标题
			/// </summary>
			public readonly static Field TITLE = new Field("TITLE", "T_FRAUD", "标题");
            /// <summary>
			/// 企业名称
			/// </summary>
			public readonly static Field COMPANY_NAME = new Field("COMPANY_NAME", "T_FRAUD", "企业名称");
            /// <summary>
			/// 企业地址
			/// </summary>
			public readonly static Field COMPANY_ADDRESS = new Field("COMPANY_ADDRESS", "T_FRAUD", "企业地址");
            /// <summary>
			/// 严重违法失信行为的具体情况
			/// </summary>
			public readonly static Field DISHONESTY_CONTENT = new Field("DISHONESTY_CONTENT", "T_FRAUD", "严重违法失信行为的具体情况");
            /// <summary>
			/// 处罚结果
			/// </summary>
			public readonly static Field PUNISHMENT_RESULT = new Field("PUNISHMENT_RESULT", "T_FRAUD", "处罚结果");
            /// <summary>
			/// 处罚依据
			/// </summary>
			public readonly static Field PUNISHMENT_BASIS = new Field("PUNISHMENT_BASIS", "T_FRAUD", "处罚依据");
            /// <summary>
			/// 处罚日期
			/// </summary>
			public readonly static Field PUNISHMENT_DATE = new Field("PUNISHMENT_DATE", "T_FRAUD", "处罚日期");
            /// <summary>
			/// 处罚截止日期
			/// </summary>
			public readonly static Field PUNISHMENT_DEADLINE = new Field("PUNISHMENT_DEADLINE", "T_FRAUD", "处罚截止日期");
            /// <summary>
			/// 执法单位
			/// </summary>
			public readonly static Field ENFORCEMENT_UNIT = new Field("ENFORCEMENT_UNIT", "T_FRAUD", "执法单位");
            /// <summary>
			/// 审核人员
			/// </summary>
			public readonly static Field AUDIT_STAFF = new Field("AUDIT_STAFF", "T_FRAUD", "审核人员");
            /// <summary>
			/// 审核意见
			/// </summary>
			public readonly static Field AUDIT_OPINION = new Field("AUDIT_OPINION", "T_FRAUD", "审核意见");
            /// <summary>
			/// 处罚类型
			/// </summary>
			public readonly static Field PUNISHMENT_TYPE = new Field("PUNISHMENT_TYPE", "T_FRAUD", "处罚类型");
            /// <summary>
			/// 附件
			/// </summary>
			public readonly static Field ATTACHMENT = new Field("ATTACHMENT", "T_FRAUD",DbType.AnsiString, null, "附件");
            /// <summary>
			/// 状态
			/// </summary>
			public readonly static Field STATE = new Field("STATE", "T_FRAUD", "状态");
            /// <summary>
			/// 提交时间
			/// </summary>
			public readonly static Field COMMIT_TIME = new Field("COMMIT_TIME", "T_FRAUD", "提交时间");
            /// <summary>
			/// 审核时间
			/// </summary>
			public readonly static Field AUDIT_TIME = new Field("AUDIT_TIME", "T_FRAUD", "审核时间");
            /// <summary>
			/// 发布人员ID
			/// </summary>
			public readonly static Field USER_ID = new Field("USER_ID", "T_FRAUD", "发布人员ID");
        }
        #endregion
	}
}