...
namespace GGZYJD.DbEntity
{
    ...
    [Serializable]
    public partial class TENDER_PROJECT_DEL : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "TENDER_PROJECT_DEL", "项目编号");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "TENDER_PROJECT_DEL", "招标项目编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "TENDER_PROJECT_DEL", "统一交易标识码");
            /// <summary>
			/// 招标项目名称
			/// </summary>
			public readonly static Field TENDER_PROJECT_NAME = new Field("TENDER_PROJECT_NAME", "TENDER_PROJECT_DEL", "招标项目名称");
            /// <summary>
			/// 招标项目类型
			/// </summary>
			public readonly static Field TENDER_PROJECT_TYPE = new Field("TENDER_PROJECT_TYPE", "TENDER_PROJECT_DEL", "招标项目类型");
            /// <summary>
			/// 招标项目所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "TENDER_PROJECT_DEL", "招标项目所在行政区域代码");
            /// <summary>
			/// 招标内容与范围及招标方案说明
			/// </summary>
			public readonly static Field TENDER_CONTENT = new Field("TENDER_CONTENT", "TENDER_PROJECT_DEL",DbType.AnsiString, null, "招标内容与范围及招标方案说明");
            /// <summary>
			/// 项目业主名称
			/// </summary>
			public readonly static Field OWNER_NAME = new Field("OWNER_NAME", "TENDER_PROJECT_DEL", "项目业主名称");
            /// <summary>
			/// 招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "TENDER_PROJECT_DEL", "招标人名称");
            /// <summary>
			/// 招标人类别
			/// </summary>
			public readonly static Field TENDERER_CODE_TYPE = new Field("TENDERER_CODE_TYPE", "TENDER_PROJECT_DEL", "招标人类别");
            /// <summary>
			/// 招标人代码
			/// </summary>
			public readonly static Field TENDERER_CODE = new Field("TENDERER_CODE", "TENDER_PROJECT_DEL", "招标人代码");
            /// <summary>
			/// 招标人角色
			/// </summary>
			public readonly static Field TENDERER_ROLE = new Field("TENDERER_ROLE", "TENDER_PROJECT_DEL", "招标人角色");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDER_AGENCY_NAME = new Field("TENDER_AGENCY_NAME", "TENDER_PROJECT_DEL", "招标代理机构名称");
            /// <summary>
			/// 招标代理机构类别
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE_TYPE = new Field("TENDER_AGENCY_CODE_TYPE", "TENDER_PROJECT_DEL", "招标代理机构类别");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE = new Field("TENDER_AGENCY_CODE", "TENDER_PROJECT_DEL", "招标代理机构代码");
            /// <summary>
			/// 招标代理机构角色
			/// </summary>
			public readonly static Field TENDER_AGENCY_ROLE = new Field("TENDER_AGENCY_ROLE", "TENDER_PROJECT_DEL", "招标代理机构角色");
            /// <summary>
			/// 招标方式
			/// </summary>
			public readonly static Field TENDER_MODE = new Field("TENDER_MODE", "TENDER_PROJECT_DEL", "招标方式");
            /// <summary>
			/// 招标组织形式
			/// </summary>
			public readonly static Field TENDER_ORGANIZE_FORM = new Field("TENDER_ORGANIZE_FORM", "TENDER_PROJECT_DEL", "招标组织形式");
            /// <summary>
			/// 招标项目建立时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "TENDER_PROJECT_DEL", "招标项目建立时间");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "TENDER_PROJECT_DEL", "监督部门名称");
            /// <summary>
			/// 监督部门代码
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_CODE = new Field("SUPERVISE_DEPT_CODE", "TENDER_PROJECT_DEL", "监督部门代码");
            /// <summary>
			/// 审核部门名称
			/// </summary>
			public readonly static Field APPROVE_DEPT_NAME = new Field("APPROVE_DEPT_NAME", "TENDER_PROJECT_DEL", "审核部门名称");
            /// <summary>
			/// 审核部门代码
			/// </summary>
			public readonly static Field APPROVE_DEPT_CODE = new Field("APPROVE_DEPT_CODE", "TENDER_PROJECT_DEL", "审核部门代码");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TENDER_PROJECT_DEL", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TENDER_PROJECT_DEL", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TENDER_PROJECT_DEL", "数据时间戳");
            /// <summary>
			/// 招标项目编号旧的编码 各个代理机构自己的编码
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE_OLD1 = new Field("TENDER_PROJECT_CODE_OLD1", "TENDER_PROJECT_DEL", "招标项目编号旧的编码 各个代理机构自己的编码");
            /// <summary>
			/// 备案部门ID
			/// </summary>
			public readonly static Field RECORD_DEPID = new Field("RECORD_DEPID", "TENDER_PROJECT_DEL", "备案部门ID");
            /// <summary>
			/// 报建编号
			/// </summary>
			public readonly static Field CONSTRUCTION_ID = new Field("CONSTRUCTION_ID", "TENDER_PROJECT_DEL", "报建编号");
            /// <summary>
			/// 创建人
			/// </summary>
			public readonly static Field M_CREATOR = new Field("M_CREATOR", "TENDER_PROJECT_DEL", "创建人");
            /// <summary>
			/// 
			/// </summary>
			...
			/// 公共资源交易入场登记表
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG = new Field("M_ATT_PROJECT_REG", "TENDER_PROJECT_DEL", "公共资源交易入场登记表");
            /// <summary>
			/// 招标代理机构承诺书
			/// </summary>
			public readonly static Field M_ATT_AGENT_COMMIT = new Field("M_ATT_AGENT_COMMIT", "TENDER_PROJECT_DEL", "招标代理机构承诺书");
            /// <summary>
			/// 其他招标代理机构认为需要上传的文件资料
			/// </summary>
			public readonly static Field M_ATT_OTHER_FILE = new Field("M_ATT_OTHER_FILE", "TENDER_PROJECT_DEL", "其他招标代理机构认为需要上传的文件资料");
            /// <summary>
			/// 入场登记表中由行政主管部门明确入场意见
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG_APPROVE = new Field("M_ATT_PROJECT_REG_APPROVE", "TENDER_PROJECT_DEL", "入场登记表中由行政主管部门明确入场意见");
            /// <summary>
			/// 招标代理合同
			/// </summary>
			public readonly static Field M_ATT_TENDER_AGENT_CONTRACT = new Field("M_ATT_TENDER_AGENT_CONTRACT", "TENDER_PROJECT_DEL", "招标代理合同");
            /// <summary>
			/// 数据上传时间
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "TENDER_PROJECT_DEL", "数据上传时间");
            /// <summary>
			/// 
			/// </summary>
			...
			/// 删除用户
			/// </summary>
			public readonly static Field M_DEL_USER = new Field("M_DEL_USER", "TENDER_PROJECT_DEL", "删除用户");
            /// <summary>
			/// 删除时间
			/// </summary>
			public readonly static Field M_DEL_TM = new Field("M_DEL_TM", "TENDER_PROJECT_DEL", "删除时间");
            /// <summary>
			/// 招标联系人
			/// </summary>
			public readonly static Field TENDERER_CONTRACT = new Field("TENDERER_CONTRACT", "TENDER_PROJECT_DEL", "招标联系人");
            /// <summary>
			/// 招标人联系电话
			/// </summary>
			public readonly static Field TENDERER_PHONE = new Field("TENDERER_PHONE", "TENDER_PROJECT_DEL", "招标人联系电话");
            /// <summary>
			/// 招标代理联系人
			/// </summary>
			public readonly static Field TENDER_AGENT_CONTRACT = new Field("TENDER_AGENT_CONTRACT", "TENDER_PROJECT_DEL", "招标代理联系人");
            /// <summary>
			/// 招标代理联系电话
			/// </summary>
			public readonly static Field TENDER_AGENT_PHONE = new Field("TENDER_AGENT_PHONE", "TENDER_PROJECT_DEL", "招标代理联系电话");
            /// <summary>
			/// 招标文件名称
			/// </summary>
			public readonly static Field TENDER_DOCNAME = new Field("TENDER_DOCNAME", "TENDER_PROJECT_DEL", "招标文件名称");
            /// <summary>
			/// 备案类型
			/// </summary>
			public readonly static Field RTYPE = new Field("RTYPE", "TENDER_PROJECT_DEL", "备案类型");
            /// <summary>
			/// 抄送部门ID
			/// </summary>
			public readonly static Field OTHER_DEPID = new Field("OTHER_DEPID", "TENDER_PROJECT_DEL", "抄送部门ID");
        }
        #endregion
	}
}