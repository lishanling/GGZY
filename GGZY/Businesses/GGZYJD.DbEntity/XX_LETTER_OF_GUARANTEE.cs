...
{
    /// <summary>
    /// 实体类XX_LETTER_OF_GUARANTEE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("XX_LETTER_OF_GUARANTEE")]
    [Serializable]
    public partial class XX_LETTER_OF_GUARANTEE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "XX_LETTER_OF_GUARANTEE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "XX_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "XX_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "XX_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "XX_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "XX_LETTER_OF_GUARANTEE", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "XX_LETTER_OF_GUARANTEE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "XX_LETTER_OF_GUARANTEE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "XX_LETTER_OF_GUARANTEE", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "XX_LETTER_OF_GUARANTEE", "投标人名称");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "XX_LETTER_OF_GUARANTEE", "投标人代码");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "XX_LETTER_OF_GUARANTEE", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "XX_LETTER_OF_GUARANTEE", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 保函类型
			/// </summary>
			public readonly static Field GUARANTEE_TYPE = new Field("GUARANTEE_TYPE", "XX_LETTER_OF_GUARANTEE", "保函类型");
            /// <summary>
			/// 保函编号
			/// </summary>
			public readonly static Field GUARANTEE_NO = new Field("GUARANTEE_NO", "XX_LETTER_OF_GUARANTEE", "保函编号");
            /// <summary>
			/// 保函状态
			/// </summary>
			public readonly static Field GUARANTEE_STATUS = new Field("GUARANTEE_STATUS", "XX_LETTER_OF_GUARANTEE", "保函状态");
            /// <summary>
			/// 申请人员
			/// </summary>
			public readonly static Field PROPOSER = new Field("PROPOSER", "XX_LETTER_OF_GUARANTEE", "申请人员");
            /// <summary>
			/// 申请人员联系方式
			/// </summary>
			public readonly static Field PROPOSER_PHONE = new Field("PROPOSER_PHONE", "XX_LETTER_OF_GUARANTEE", "申请人员联系方式");
            /// <summary>
			/// 证件类型
			/// </summary>
			public readonly static Field PROPOSER_CARD_TYPE = new Field("PROPOSER_CARD_TYPE", "XX_LETTER_OF_GUARANTEE", "证件类型");
            /// <summary>
			/// 证件号码
			/// </summary>
			public readonly static Field PROPOSER_CODE = new Field("PROPOSER_CODE", "XX_LETTER_OF_GUARANTEE", "证件号码");
            /// <summary>
			/// 受益人
			/// </summary>
			public readonly static Field BENEFICIARY = new Field("BENEFICIARY", "XX_LETTER_OF_GUARANTEE", "受益人");
            /// <summary>
			/// 承保人
			/// </summary>
			public readonly static Field INSURER = new Field("INSURER", "XX_LETTER_OF_GUARANTEE", "承保人");
            /// <summary>
			/// 担保金额
			/// </summary>
			public readonly static Field GUARANTEE_AMOUNT = new Field("GUARANTEE_AMOUNT", "XX_LETTER_OF_GUARANTEE", "担保金额");
            /// <summary>
			/// 担保费用
			/// </summary>
			public readonly static Field GUARANTEE_COST = new Field("GUARANTEE_COST", "XX_LETTER_OF_GUARANTEE", "担保费用");
            /// <summary>
			/// 保函创建时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "XX_LETTER_OF_GUARANTEE", "保函创建时间");
            /// <summary>
			/// 担保开始时间
			/// </summary>
			public readonly static Field BEGIN_TIME = new Field("BEGIN_TIME", "XX_LETTER_OF_GUARANTEE", "担保开始时间");
            /// <summary>
			/// 担保结束时间
			/// </summary>
			public readonly static Field END_TIME = new Field("END_TIME", "XX_LETTER_OF_GUARANTEE", "担保结束时间");
            /// <summary>
			/// 支付方式
			/// </summary>
			public readonly static Field PURCHASE_METHOD = new Field("PURCHASE_METHOD", "XX_LETTER_OF_GUARANTEE", "支付方式");
            /// <summary>
			/// 支付时间
			/// </summary>
			public readonly static Field PURCHASE_TIME = new Field("PURCHASE_TIME", "XX_LETTER_OF_GUARANTEE", "支付时间");
            /// <summary>
			/// 支付账号
			/// </summary>
			public readonly static Field PURCHASE_ACCOUN = new Field("PURCHASE_ACCOUN", "XX_LETTER_OF_GUARANTEE", "支付账号");
            /// <summary>
			/// 费率
			/// </summary>
			public readonly static Field RATE = new Field("RATE", "XX_LETTER_OF_GUARANTEE", "费率");
            /// <summary>
			/// 电子保单文件下载地址
			/// </summary>
			public readonly static Field GUARANTEE_URL = new Field("GUARANTEE_URL", "XX_LETTER_OF_GUARANTEE", "电子保单文件下载地址");
            /// <summary>
			/// 电子保单文件md5码
			/// </summary>
			public readonly static Field GUARANTEE_MD5 = new Field("GUARANTEE_MD5", "XX_LETTER_OF_GUARANTEE", "电子保单文件md5码");
            /// <summary>
			/// 出函时间
			/// </summary>
			public readonly static Field LETTER_TIME = new Field("LETTER_TIME", "XX_LETTER_OF_GUARANTEE", "出函时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "XX_LETTER_OF_GUARANTEE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "XX_LETTER_OF_GUARANTEE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "XX_LETTER_OF_GUARANTEE", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "XX_LETTER_OF_GUARANTEE", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "XX_LETTER_OF_GUARANTEE", "公共服务平台标识码");
        }
        #endregion
	}
}