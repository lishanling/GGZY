...
{
    /// <summary>
    /// 实体类YG_EVALUATION_SCORE_DETAIL。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("YG_EVALUATION_SCORE_DETAIL")]
    [Serializable]
    public partial class YG_EVALUATION_SCORE_DETAIL : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "YG_EVALUATION_SCORE_DETAIL");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "YG_EVALUATION_SCORE_DETAIL", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "YG_EVALUATION_SCORE_DETAIL", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "YG_EVALUATION_SCORE_DETAIL", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "YG_EVALUATION_SCORE_DETAIL", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "YG_EVALUATION_SCORE_DETAIL", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "YG_EVALUATION_SCORE_DETAIL", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "YG_EVALUATION_SCORE_DETAIL", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "YG_EVALUATION_SCORE_DETAIL", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "YG_EVALUATION_SCORE_DETAIL", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "YG_EVALUATION_SCORE_DETAIL", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "YG_EVALUATION_SCORE_DETAIL", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "YG_EVALUATION_SCORE_DETAIL", "投标人角色");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "YG_EVALUATION_SCORE_DETAIL", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "YG_EVALUATION_SCORE_DETAIL", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 联合体联系人（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_NAME = new Field("UNION_CONTACT_NAME", "YG_EVALUATION_SCORE_DETAIL", "联合体联系人（如有）");
            /// <summary>
			/// 联合体联系电话（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_PHONE = new Field("UNION_CONTACT_PHONE", "YG_EVALUATION_SCORE_DETAIL", "联合体联系电话（如有）");
            /// <summary>
			/// 评标专家名称
			/// </summary>
			public readonly static Field EXPERT_NAME = new Field("EXPERT_NAME", "YG_EVALUATION_SCORE_DETAIL", "评标专家名称");
            /// <summary>
			/// 评标专家身份证号
			/// </summary>
			public readonly static Field ID_CARD = new Field("ID_CARD", "YG_EVALUATION_SCORE_DETAIL", "评标专家身份证号");
            /// <summary>
			/// 报价分
			/// </summary>
			public readonly static Field PRICE_POINTS = new Field("PRICE_POINTS", "YG_EVALUATION_SCORE_DETAIL", "报价分");
            /// <summary>
			/// 资格分
			/// </summary>
			public readonly static Field QUALIFICATION_POINTS = new Field("QUALIFICATION_POINTS", "YG_EVALUATION_SCORE_DETAIL", "资格分");
            /// <summary>
			/// 商务分
			/// </summary>
			public readonly static Field BUSINESS_POINTS = new Field("BUSINESS_POINTS", "YG_EVALUATION_SCORE_DETAIL", "商务分");
            /// <summary>
			/// 技术分
			/// </summary>
			public readonly static Field TECHNICAL_POINTS = new Field("TECHNICAL_POINTS", "YG_EVALUATION_SCORE_DETAIL", "技术分");
            /// <summary>
			/// 响应性评审
			/// </summary>
			public readonly static Field RESPONSE_POINTS = new Field("RESPONSE_POINTS", "YG_EVALUATION_SCORE_DETAIL", "响应性评审");
            /// <summary>
			/// 其他分
			/// </summary>
			public readonly static Field OTHER_POINTS = new Field("OTHER_POINTS", "YG_EVALUATION_SCORE_DETAIL", "其他分");
            /// <summary>
			/// 资格分明细
			/// </summary>
			public readonly static Field QUALIFICATION_DETAIL = new Field("QUALIFICATION_DETAIL", "YG_EVALUATION_SCORE_DETAIL",DbType.AnsiString, null, "资格分明细");
            /// <summary>
			/// 商务分明细
			/// </summary>
			public readonly static Field BUSINESS_DETAIL = new Field("BUSINESS_DETAIL", "YG_EVALUATION_SCORE_DETAIL",DbType.AnsiString, null, "商务分明细");
            /// <summary>
			/// 技术分明细
			/// </summary>
			public readonly static Field TECHNICAL_DETAIL = new Field("TECHNICAL_DETAIL", "YG_EVALUATION_SCORE_DETAIL",DbType.AnsiString, null, "技术分明细");
            /// <summary>
			/// 响应性评审
			/// </summary>
			public readonly static Field RESPONSE_DETAIL = new Field("RESPONSE_DETAIL", "YG_EVALUATION_SCORE_DETAIL",DbType.AnsiString, null, "响应性评审");
            /// <summary>
			/// 其他文件
			/// </summary>
			public readonly static Field OTHER_DETAIL = new Field("OTHER_DETAIL", "YG_EVALUATION_SCORE_DETAIL",DbType.AnsiString, null, "其他文件");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "YG_EVALUATION_SCORE_DETAIL", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "YG_EVALUATION_SCORE_DETAIL", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "YG_EVALUATION_SCORE_DETAIL", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "YG_EVALUATION_SCORE_DETAIL", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "YG_EVALUATION_SCORE_DETAIL", "公共服务平台标识码");
        }
        #endregion
	}
}