...
{
    /// <summary>
    /// 实体类JT_TENDER_PROJECT。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_TENDER_PROJECT")]
    [Serializable]
    public partial class JT_TENDER_PROJECT : JdEntity
    {
        #region Model
		...
		private string _TENDERER_AGENCY_COR_IDENTITY;
		private string _TENDER_AGENCY_UNIT_ADDRESS;
		private string _TENDER_AGENCY_LEGAL_ZIP_CODE;
		private string _TENDER_AGENCY_LEGAL_CONTACT;
		private string _TENDER_AGENCY_LEGAL_PHONE;
		...
		/// 招标人代理机构企业标识
		/// </summary>
		public string TENDERER_AGENCY_COR_IDENTITY
		{
			get{ return _TENDERER_AGENCY_COR_IDENTITY; }
			set
			{
				this.OnPropertyValueChange(_.TENDERER_AGENCY_COR_IDENTITY, _TENDERER_AGENCY_COR_IDENTITY, value);
				this._TENDERER_AGENCY_COR_IDENTITY = value;
			}
		}
		/// <summary>
		/// 招标代理机构地址
		/// </summary>
		public string TENDER_AGENCY_UNIT_ADDRESS
		{
			get{ return _TENDER_AGENCY_UNIT_ADDRESS; }
			set
			{
				this.OnPropertyValueChange(_.TENDER_AGENCY_UNIT_ADDRESS, _TENDER_AGENCY_UNIT_ADDRESS, value);
				this._TENDER_AGENCY_UNIT_ADDRESS = value;
			}
		}
		/// <summary>
		/// 招标代理机构邮编
		...
		/// 招标代理机构电话
		/// </summary>
		public string TENDER_AGENCY_LEGAL_PHONE
		{
			get{ return _TENDER_AGENCY_LEGAL_PHONE; }
			set
			{
				this.OnPropertyValueChange(_.TENDER_AGENCY_LEGAL_PHONE, _TENDER_AGENCY_LEGAL_PHONE, value);
				this._TENDER_AGENCY_LEGAL_PHONE = value;
			}
		}
		/// <summary>
		/// 招标代理机构传真
        ...
        public override Field[] GetFields()
        {
            return new Field[] {
				...
				_.TENDERER_AGENCY_COR_IDENTITY,
				_.TENDER_AGENCY_UNIT_ADDRESS,
				_.TENDER_AGENCY_LEGAL_ZIP_CODE,
				_.TENDER_AGENCY_LEGAL_CONTACT,
				_.TENDER_AGENCY_LEGAL_PHONE,
        ...
        public override object[] GetValues()
        {
            return new object[] {
				...
				this._TENDERER_AGENCY_COR_IDENTITY,
				this._TENDER_AGENCY_UNIT_ADDRESS,
				this._TENDER_AGENCY_LEGAL_ZIP_CODE,
				this._TENDER_AGENCY_LEGAL_CONTACT,
				this._TENDER_AGENCY_LEGAL_PHONE,
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_TENDER_PROJECT");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "JT_TENDER_PROJECT", "项目编号");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_TENDER_PROJECT", "招标项目编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "JT_TENDER_PROJECT", "统一交易标识码");
            /// <summary>
			/// 招标项目名称
			/// </summary>
			public readonly static Field TENDER_PROJECT_NAME = new Field("TENDER_PROJECT_NAME", "JT_TENDER_PROJECT", "招标项目名称");
            /// <summary>
			/// 招标项目类型
			/// </summary>
			public readonly static Field TENDER_PROJECT_TYPE = new Field("TENDER_PROJECT_TYPE", "JT_TENDER_PROJECT", "招标项目类型");
            /// <summary>
			/// 招标项目所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "JT_TENDER_PROJECT", "招标项目所在行政区域代码");
            /// <summary>
			/// 招标内容与范围及招标方案说明
			/// </summary>
			public readonly static Field TENDER_CONTENT = new Field("TENDER_CONTENT", "JT_TENDER_PROJECT",DbType.AnsiString, null, "招标内容与范围及招标方案说明");
            /// <summary>
			/// 项目业主名称
			/// </summary>
			public readonly static Field OWNER_NAME = new Field("OWNER_NAME", "JT_TENDER_PROJECT", "项目业主名称");
            /// <summary>
			/// 招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "JT_TENDER_PROJECT", "招标人名称");
            /// <summary>
			/// 招标人类别
			/// </summary>
			public readonly static Field TENDERER_CODE_TYPE = new Field("TENDERER_CODE_TYPE", "JT_TENDER_PROJECT", "招标人类别");
            /// <summary>
			/// 招标人代码
			/// </summary>
			public readonly static Field TENDERER_CODE = new Field("TENDERER_CODE", "JT_TENDER_PROJECT", "招标人代码");
            /// <summary>
			/// 招标人角色
			/// </summary>
			public readonly static Field TENDERER_ROLE = new Field("TENDERER_ROLE", "JT_TENDER_PROJECT", "招标人角色");
            /// <summary>
			/// 是否联合招标
			/// </summary>
			public readonly static Field ISUNION = new Field("ISUNION", "JT_TENDER_PROJECT", "是否联合招标");
            /// <summary>
			/// 招标人企业标识
			/// </summary>
			public readonly static Field TENDERER_CORPORATE_IDENTITY = new Field("TENDERER_CORPORATE_IDENTITY", "JT_TENDER_PROJECT", "招标人企业标识");
            /// <summary>
			/// 招标人地址
			/// </summary>
			public readonly static Field TENDERER_LEGAL_UNIT_ADDRESS = new Field("TENDERER_LEGAL_UNIT_ADDRESS", "JT_TENDER_PROJECT", "招标人地址");
            /// <summary>
			/// 招标人邮编
			/// </summary>
			public readonly static Field TENDERER_LEGAL_ZIP_CODE = new Field("TENDERER_LEGAL_ZIP_CODE", "JT_TENDER_PROJECT", "招标人邮编");
            /// <summary>
			/// 招标联系人
			/// </summary>
			public readonly static Field TENDERER_LEGAL_CONTACT = new Field("TENDERER_LEGAL_CONTACT", "JT_TENDER_PROJECT", "招标联系人");
            /// <summary>
			/// 招标人联系电话
			/// </summary>
			public readonly static Field TENDERER_LEGAL_OFFICE_PHONE = new Field("TENDERER_LEGAL_OFFICE_PHONE", "JT_TENDER_PROJECT", "招标人联系电话");
            /// <summary>
			/// 招标人传真
			/// </summary>
			public readonly static Field TENDERER_LEGAL_FAX = new Field("TENDERER_LEGAL_FAX", "JT_TENDER_PROJECT", "招标人传真");
            /// <summary>
			/// 招标人电子邮箱
			/// </summary>
			public readonly static Field TENDERER_LEGAL_EMAIL = new Field("TENDERER_LEGAL_EMAIL", "JT_TENDER_PROJECT", "招标人电子邮箱");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDER_AGENCY_NAME = new Field("TENDER_AGENCY_NAME", "JT_TENDER_PROJECT", "招标代理机构名称");
            /// <summary>
			/// 招标代理机构类别
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE_TYPE = new Field("TENDER_AGENCY_CODE_TYPE", "JT_TENDER_PROJECT", "招标代理机构类别");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE = new Field("TENDER_AGENCY_CODE", "JT_TENDER_PROJECT", "招标代理机构代码");
            /// <summary>
			/// 招标代理机构角色
			/// </summary>
			public readonly static Field TENDER_AGENCY_ROLE = new Field("TENDER_AGENCY_ROLE", "JT_TENDER_PROJECT", "招标代理机构角色");
            /// <summary>
			/// 招标人代理机构企业标识
			/// </summary>
			public readonly static Field TENDERER_AGENCY_COR_IDENTITY = new Field("TENDERER_AGENCY_COR_IDENTITY", "JT_TENDER_PROJECT", "招标人代理机构企业标识");
            /// <summary>
			/// 招标代理机构地址
			/// </summary>
			public readonly static Field TENDER_AGENCY_UNIT_ADDRESS = new Field("TENDER_AGENCY_UNIT_ADDRESS", "JT_TENDER_PROJECT", "招标代理机构地址");
            /// <summary>
			/// 招标代理机构邮编
			/// </summary>
			public readonly static Field TENDER_AGENCY_LEGAL_ZIP_CODE = new Field("TENDER_AGENCY_LEGAL_ZIP_CODE", "JT_TENDER_PROJECT", "招标代理机构邮编");
            /// <summary>
			/// 招标代理机构联系人
			/// </summary>
			public readonly static Field TENDER_AGENCY_LEGAL_CONTACT = new Field("TENDER_AGENCY_LEGAL_CONTACT", "JT_TENDER_PROJECT", "招标代理机构联系人");
            /// <summary>
			/// 招标代理机构电话
			/// </summary>
			public readonly static Field TENDER_AGENCY_LEGAL_PHONE = new Field("TENDER_AGENCY_LEGAL_PHONE", "JT_TENDER_PROJECT", "招标代理机构电话");
            /// <summary>
			/// 招标代理机构传真
			/// </summary>
			public readonly static Field TENDER_AGENCY_LEGAL_FAX = new Field("TENDER_AGENCY_LEGAL_FAX", "JT_TENDER_PROJECT", "招标代理机构传真");
            /// <summary>
			/// 招标人代理机构电子邮箱
			/// </summary>
			public readonly static Field TENDER_AGENCY_LEGAL_EMAIL = new Field("TENDER_AGENCY_LEGAL_EMAIL", "JT_TENDER_PROJECT", "招标人代理机构电子邮箱");
            /// <summary>
			/// 招标方式
			/// </summary>
			public readonly static Field TENDER_MODE = new Field("TENDER_MODE", "JT_TENDER_PROJECT", "招标方式");
            /// <summary>
			/// 招标组织形式
			/// </summary>
			public readonly static Field TENDER_ORGANIZE_FORM = new Field("TENDER_ORGANIZE_FORM", "JT_TENDER_PROJECT", "招标组织形式");
            /// <summary>
			/// 招标项目建立时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "JT_TENDER_PROJECT", "招标项目建立时间");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "JT_TENDER_PROJECT", "监督部门名称");
            /// <summary>
			/// 监督部门代码
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_CODE = new Field("SUPERVISE_DEPT_CODE", "JT_TENDER_PROJECT", "监督部门代码");
            /// <summary>
			/// 监督部门联系电话
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_PHONE = new Field("SUPERVISE_DEPT_PHONE", "JT_TENDER_PROJECT", "监督部门联系电话");
            /// <summary>
			/// 审核部门名称
			/// </summary>
			public readonly static Field APPROVE_DEPT_NAME = new Field("APPROVE_DEPT_NAME", "JT_TENDER_PROJECT", "审核部门名称");
            /// <summary>
			/// 审核部门代码
			/// </summary>
			public readonly static Field APPROVE_DEPT_CODE = new Field("APPROVE_DEPT_CODE", "JT_TENDER_PROJECT", "审核部门代码");
            /// <summary>
			/// 申报责任人
			/// </summary>
			public readonly static Field REPORT_DUTY = new Field("REPORT_DUTY", "JT_TENDER_PROJECT", "申报责任人");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_TENDER_PROJECT", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_TENDER_PROJECT", "公共服务平台标识码");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_TENDER_PROJECT", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_TENDER_PROJECT", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_TENDER_PROJECT", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_TENDER_PROJECT", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_TENDER_PROJECT", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_TENDER_PROJECT", "M_TM");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_TENDER_PROJECT", "数据时间戳");
            /// <summary>
			/// 相同的招标项目编号的其他表的更新时，更新该时间
			/// </summary>
			public readonly static Field OTHER_UPDATE_TIME = new Field("OTHER_UPDATE_TIME", "JT_TENDER_PROJECT", "相同的招标项目编号的其他表的更新时，更新该时间");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_SELF_CODE = new Field("TENDER_SELF_CODE", "JT_TENDER_PROJECT", "招标项目编号");
            /// <summary>
			/// 公共资源交易入场登记表
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG = new Field("M_ATT_PROJECT_REG", "JT_TENDER_PROJECT", "公共资源交易入场登记表");
            /// <summary>
			/// 招标代理机构承诺书
			/// </summary>
			public readonly static Field M_ATT_AGENT_COMMIT = new Field("M_ATT_AGENT_COMMIT", "JT_TENDER_PROJECT", "招标代理机构承诺书");
            /// <summary>
			/// 其他招标代理机构认为需要上传的文件资料
			/// </summary>
			public readonly static Field M_ATT_OTHER_FILE = new Field("M_ATT_OTHER_FILE", "JT_TENDER_PROJECT", "其他招标代理机构认为需要上传的文件资料");
            /// <summary>
			/// 入场登记表中由行政主管部门明确入场意见
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG_APPROVE = new Field("M_ATT_PROJECT_REG_APPROVE", "JT_TENDER_PROJECT", "入场登记表中由行政主管部门明确入场意见");
            /// <summary>
			/// 招标代理合同
			/// </summary>
			public readonly static Field M_ATT_TENDER_AGENT_CONTRACT = new Field("M_ATT_TENDER_AGENT_CONTRACT", "JT_TENDER_PROJECT", "招标代理合同");
            /// <summary>
			/// 主要负责人的授权书
			/// </summary>
			public readonly static Field M_ATT_COR_AUTHORITY_FILE = new Field("M_ATT_COR_AUTHORITY_FILE", "JT_TENDER_PROJECT", "主要负责人的授权书");
            /// <summary>
			/// 资金来源落实证明文件
			/// </summary>
			public readonly static Field M_ATT_FUND_SOURCE_CERTIFY_FILE = new Field("M_ATT_FUND_SOURCE_CERTIFY_FILE", "JT_TENDER_PROJECT", "资金来源落实证明文件");
            /// <summary>
			/// 是否依法必须招标
			/// </summary>
			public readonly static Field IS_TO_LAW = new Field("IS_TO_LAW", "JT_TENDER_PROJECT", "是否依法必须招标");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_TENDER_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_TENDER_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_TENDER_PROJECT", "");
            /// <summary>
			/// 招标文件备案编号
			/// </summary>
			public readonly static Field TENDER_RECORD_CODE = new Field("TENDER_RECORD_CODE", "JT_TENDER_PROJECT", "招标文件备案编号");
            /// <summary>
			/// 招标人企业注册所在地
			/// </summary>
			public readonly static Field TENDERER_REGION_CODE = new Field("TENDERER_REGION_CODE", "JT_TENDER_PROJECT", "招标人企业注册所在地");
            /// <summary>
			/// 招标人企业性质
			/// </summary>
			public readonly static Field TENDERER_PROPERTY = new Field("TENDERER_PROPERTY", "JT_TENDER_PROJECT", "招标人企业性质");
            /// <summary>
			/// 招标代理机构企业注册所在地
			/// </summary>
			public readonly static Field TENDER_AGENCY_REGION_CODE = new Field("TENDER_AGENCY_REGION_CODE", "JT_TENDER_PROJECT", "招标代理机构企业注册所在地");
            /// <summary>
			/// 招标代理机构企业性质
			/// </summary>
			public readonly static Field TENDER_AGENCY_PROPERTY = new Field("TENDER_AGENCY_PROPERTY", "JT_TENDER_PROJECT", "招标代理机构企业性质");
            /// <summary>
			/// 信息录入人员
			/// </summary>
			public readonly static Field OPERATION_NAME = new Field("OPERATION_NAME", "JT_TENDER_PROJECT", "信息录入人员");
            /// <summary>
			/// 交易系统编号
			/// </summary>
			public readonly static Field TRADE_SYSTEM_NO = new Field("TRADE_SYSTEM_NO", "JT_TENDER_PROJECT", "交易系统编号");
            /// <summary>
			/// 交易系统平台使用费
			/// </summary>
			public readonly static Field TRADE_SYSTEM_FEE = new Field("TRADE_SYSTEM_FEE", "JT_TENDER_PROJECT", "交易系统平台使用费");
        }
        #endregion
	}
}