...
{
    /// <summary>
    /// 实体类ZJ_TENDER_PROJECT。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("ZJ_TENDER_PROJECT")]
    [Serializable]
    public partial class ZJ_TENDER_PROJECT : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "ZJ_TENDER_PROJECT");
            /// <summary>
			/// 报建编号
			/// </summary>
			public readonly static Field REPROT_CODE = new Field("REPROT_CODE", "ZJ_TENDER_PROJECT", "报建编号");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "ZJ_TENDER_PROJECT", "项目编号");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "ZJ_TENDER_PROJECT", "招标项目编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "ZJ_TENDER_PROJECT", "统一交易标识码");
            /// <summary>
			/// 招标项目名称
			/// </summary>
			public readonly static Field TENDER_PROJECT_NAME = new Field("TENDER_PROJECT_NAME", "ZJ_TENDER_PROJECT", "招标项目名称");
            /// <summary>
			/// 招标项目类型
			/// </summary>
			public readonly static Field TENDER_PROJECT_TYPE = new Field("TENDER_PROJECT_TYPE", "ZJ_TENDER_PROJECT", "招标项目类型");
            /// <summary>
			/// 招标项目所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "ZJ_TENDER_PROJECT", "招标项目所在行政区域代码");
            /// <summary>
			/// 招标内容与范围及招标方案说明
			/// </summary>
			public readonly static Field TENDER_CONTENT = new Field("TENDER_CONTENT", "ZJ_TENDER_PROJECT",DbType.AnsiString, null, "招标内容与范围及招标方案说明");
            /// <summary>
			/// 项目业主名称
			/// </summary>
			public readonly static Field OWNER_NAME = new Field("OWNER_NAME", "ZJ_TENDER_PROJECT", "项目业主名称");
            /// <summary>
			/// 招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "ZJ_TENDER_PROJECT", "招标人名称");
            /// <summary>
			/// 招标人类别
			/// </summary>
			public readonly static Field TENDERER_CODE_TYPE = new Field("TENDERER_CODE_TYPE", "ZJ_TENDER_PROJECT", "招标人类别");
            /// <summary>
			/// 招标人代码
			/// </summary>
			public readonly static Field TENDERER_CODE = new Field("TENDERER_CODE", "ZJ_TENDER_PROJECT", "招标人代码");
            /// <summary>
			/// 招标人角色
			/// </summary>
			public readonly static Field TENDERER_ROLE = new Field("TENDERER_ROLE", "ZJ_TENDER_PROJECT", "招标人角色");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDER_AGENCY_NAME = new Field("TENDER_AGENCY_NAME", "ZJ_TENDER_PROJECT", "招标代理机构名称");
            /// <summary>
			/// 招标代理机构类别
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE_TYPE = new Field("TENDER_AGENCY_CODE_TYPE", "ZJ_TENDER_PROJECT", "招标代理机构类别");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE = new Field("TENDER_AGENCY_CODE", "ZJ_TENDER_PROJECT", "招标代理机构代码");
            /// <summary>
			/// 招标代理机构角色
			/// </summary>
			public readonly static Field TENDER_AGENCY_ROLE = new Field("TENDER_AGENCY_ROLE", "ZJ_TENDER_PROJECT", "招标代理机构角色");
            /// <summary>
			/// 招标方式
			/// </summary>
			public readonly static Field TENDER_MODE = new Field("TENDER_MODE", "ZJ_TENDER_PROJECT", "招标方式");
            /// <summary>
			/// 招标组织形式
			/// </summary>
			public readonly static Field TENDER_ORGANIZE_FORM = new Field("TENDER_ORGANIZE_FORM", "ZJ_TENDER_PROJECT", "招标组织形式");
            /// <summary>
			/// 招标项目建立时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "ZJ_TENDER_PROJECT", "招标项目建立时间");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "ZJ_TENDER_PROJECT", "监督部门名称");
            /// <summary>
			/// 监督部门代码
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_CODE = new Field("SUPERVISE_DEPT_CODE", "ZJ_TENDER_PROJECT", "监督部门代码");
            /// <summary>
			/// 审核部门名称
			/// </summary>
			public readonly static Field APPROVE_DEPT_NAME = new Field("APPROVE_DEPT_NAME", "ZJ_TENDER_PROJECT", "审核部门名称");
            /// <summary>
			/// 审核部门代码
			/// </summary>
			public readonly static Field APPROVE_DEPT_CODE = new Field("APPROVE_DEPT_CODE", "ZJ_TENDER_PROJECT", "审核部门代码");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "ZJ_TENDER_PROJECT", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "ZJ_TENDER_PROJECT", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "ZJ_TENDER_PROJECT", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "ZJ_TENDER_PROJECT", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "ZJ_TENDER_PROJECT", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "ZJ_TENDER_PROJECT", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "ZJ_TENDER_PROJECT", "M_CREATEBY");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "ZJ_TENDER_PROJECT", "M_TM");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "ZJ_TENDER_PROJECT", "M_CREATE_TM");
            /// <summary>
			/// 相同的招标项目编号的其他表的更新时，更新该时间
			/// </summary>
			public readonly static Field OTHER_UPDATE_TIME = new Field("OTHER_UPDATE_TIME", "ZJ_TENDER_PROJECT", "相同的招标项目编号的其他表的更新时，更新该时间");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_SELF_CODE = new Field("TENDER_SELF_CODE", "ZJ_TENDER_PROJECT", "招标项目编号");
            /// <summary>
			/// 公共资源交易入场登记表
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG = new Field("M_ATT_PROJECT_REG", "ZJ_TENDER_PROJECT", "公共资源交易入场登记表");
            /// <summary>
			/// 招标代理机构承诺书
			/// </summary>
			public readonly static Field M_ATT_AGENT_COMMIT = new Field("M_ATT_AGENT_COMMIT", "ZJ_TENDER_PROJECT", "招标代理机构承诺书");
            /// <summary>
			/// 其他招标代理机构认为需要上传的文件资料
			/// </summary>
			public readonly static Field M_ATT_OTHER_FILE = new Field("M_ATT_OTHER_FILE", "ZJ_TENDER_PROJECT", "其他招标代理机构认为需要上传的文件资料");
            /// <summary>
			/// 入场登记表中由行政主管部门明确入场意见
			/// </summary>
			public readonly static Field M_ATT_PROJECT_REG_APPROVE = new Field("M_ATT_PROJECT_REG_APPROVE", "ZJ_TENDER_PROJECT", "入场登记表中由行政主管部门明确入场意见");
            /// <summary>
			/// 招标代理合同
			/// </summary>
			public readonly static Field M_ATT_TENDER_AGENT_CONTRACT = new Field("M_ATT_TENDER_AGENT_CONTRACT", "ZJ_TENDER_PROJECT", "招标代理合同");
            /// <summary>
			/// 主要负责人的授权书
			/// </summary>
			public readonly static Field M_ATT_COR_AUTHORITY_FILE = new Field("M_ATT_COR_AUTHORITY_FILE", "ZJ_TENDER_PROJECT", "主要负责人的授权书");
            /// <summary>
			/// 资金来源落实证明文件
			/// </summary>
			public readonly static Field M_ATT_FUND_SOURCE_CERTIFY_FILE = new Field("M_ATT_FUND_SOURCE_CERTIFY_FILE", "ZJ_TENDER_PROJECT", "资金来源落实证明文件");
            /// <summary>
			/// 招标条件备案编号
			/// </summary>
			public readonly static Field TENDER_RECORD_CODE = new Field("TENDER_RECORD_CODE", "ZJ_TENDER_PROJECT", "招标条件备案编号");
            /// <summary>
			/// 是否依法必须招标
			/// </summary>
			public readonly static Field IS_TO_LAW = new Field("IS_TO_LAW", "ZJ_TENDER_PROJECT", "是否依法必须招标");
            /// <summary>
			/// 是否联合招标
			/// </summary>
			public readonly static Field ISUNION = new Field("ISUNION", "ZJ_TENDER_PROJECT", "是否联合招标");
            /// <summary>
			/// 申报责任人
			/// </summary>
			public readonly static Field REPORT_DUTY = new Field("REPORT_DUTY", "ZJ_TENDER_PROJECT", "申报责任人");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "ZJ_TENDER_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "ZJ_TENDER_PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "ZJ_TENDER_PROJECT", "");
            /// <summary>
			/// 招标人企业注册所在地
			/// </summary>
			public readonly static Field TENDERER_REGION_CODE = new Field("TENDERER_REGION_CODE", "ZJ_TENDER_PROJECT", "招标人企业注册所在地");
            /// <summary>
			/// 招标人企业性质
			/// </summary>
			public readonly static Field TENDERER_PROPERTY = new Field("TENDERER_PROPERTY", "ZJ_TENDER_PROJECT", "招标人企业性质");
            /// <summary>
			/// 招标代理机构企业注册所在地
			/// </summary>
			public readonly static Field TENDER_AGENCY_REGION_CODE = new Field("TENDER_AGENCY_REGION_CODE", "ZJ_TENDER_PROJECT", "招标代理机构企业注册所在地");
            /// <summary>
			/// 招标代理机构企业性质
			/// </summary>
			public readonly static Field TENDER_AGENCY_PROPERTY = new Field("TENDER_AGENCY_PROPERTY", "ZJ_TENDER_PROJECT", "招标代理机构企业性质");
            /// <summary>
			/// 信息录入人员
			/// </summary>
			public readonly static Field OPERATION_NAME = new Field("OPERATION_NAME", "ZJ_TENDER_PROJECT", "信息录入人员");
            /// <summary>
			/// 交易系统编号
			/// </summary>
			public readonly static Field TRADE_SYSTEM_NO = new Field("TRADE_SYSTEM_NO", "ZJ_TENDER_PROJECT", "交易系统编号");
            /// <summary>
			/// 交易系统平台使用费
			/// </summary>
			public readonly static Field TRADE_SYSTEM_FEE = new Field("TRADE_SYSTEM_FEE", "ZJ_TENDER_PROJECT", "交易系统平台使用费");
        }
        #endregion
	}
}