...
{
    /// <summary>
    /// 实体类GY_BID_DOC_CHARACT_CODE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("GY_BID_DOC_CHARACT_CODE")]
    [Serializable]
    public partial class GY_BID_DOC_CHARACT_CODE : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "GY_BID_DOC_CHARACT_CODE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "GY_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "GY_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "GY_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "GY_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "GY_BID_DOC_CHARACT_CODE", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "GY_BID_DOC_CHARACT_CODE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "GY_BID_DOC_CHARACT_CODE", "标段（包）编号");
            /// <summary>
			/// 相关统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODES = new Field("UNIFIED_DEAL_CODES", "GY_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "相关统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "GY_BID_DOC_CHARACT_CODE", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "GY_BID_DOC_CHARACT_CODE", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "GY_BID_DOC_CHARACT_CODE", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "GY_BID_DOC_CHARACT_CODE", "投标人角色");
            /// <summary>
			/// 投标文件名称
			/// </summary>
			public readonly static Field BID_DOCUMENT_NAME = new Field("BID_DOCUMENT_NAME", "GY_BID_DOC_CHARACT_CODE", "投标文件名称");
            /// <summary>
			/// 投标文件大小
			/// </summary>
			public readonly static Field BID_DOCUMENT_SIDE = new Field("BID_DOCUMENT_SIDE", "GY_BID_DOC_CHARACT_CODE", "投标文件大小");
            /// <summary>
			/// 投标文件MD5码
			/// </summary>
			public readonly static Field BID_DOCUMENT_MD5 = new Field("BID_DOCUMENT_MD5", "GY_BID_DOC_CHARACT_CODE", "投标文件MD5码");
            /// <summary>
			/// 投标文件提交时间
			/// </summary>
			public readonly static Field TENDER_DOC_SUBMITTIME = new Field("TENDER_DOC_SUBMITTIME", "GY_BID_DOC_CHARACT_CODE", "投标文件提交时间");
            /// <summary>
			/// CPU序列号
			/// </summary>
			public readonly static Field CPU_ID = new Field("CPU_ID", "GY_BID_DOC_CHARACT_CODE", "CPU序列号");
            /// <summary>
			/// 硬盘序列号
			/// </summary>
			public readonly static Field HARD_DISK_SERIAL_NUMBER = new Field("HARD_DISK_SERIAL_NUMBER", "GY_BID_DOC_CHARACT_CODE", "硬盘序列号");
            /// <summary>
			/// 内存序列号
			/// </summary>
			public readonly static Field MEMORY_SERIAL_NUMBER = new Field("MEMORY_SERIAL_NUMBER", "GY_BID_DOC_CHARACT_CODE", "内存序列号");
            /// <summary>
			/// IP地址
			/// </summary>
			public readonly static Field NET_ID = new Field("NET_ID", "GY_BID_DOC_CHARACT_CODE", "IP地址");
            /// <summary>
			/// 网卡MAC地址
			/// </summary>
			public readonly static Field MAC_ADDRESS = new Field("MAC_ADDRESS", "GY_BID_DOC_CHARACT_CODE", "网卡MAC地址");
            /// <summary>
			/// 投标文件URL
			/// </summary>
			public readonly static Field TENDER_DOCUMENTS_URL = new Field("TENDER_DOCUMENTS_URL", "GY_BID_DOC_CHARACT_CODE", "投标文件URL");
            /// <summary>
			/// 计价软硬件信息xml
			/// </summary>
			public readonly static Field VALUATION_XML = new Field("VALUATION_XML", "GY_BID_DOC_CHARACT_CODE",DbType.AnsiString, null, "计价软硬件信息xml");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "GY_BID_DOC_CHARACT_CODE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "GY_BID_DOC_CHARACT_CODE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "GY_BID_DOC_CHARACT_CODE", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "GY_BID_DOC_CHARACT_CODE", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "GY_BID_DOC_CHARACT_CODE", "公共服务平台标识码");
        }
        #endregion
	}
}