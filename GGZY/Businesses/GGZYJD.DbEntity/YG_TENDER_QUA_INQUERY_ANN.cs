...
{
    /// <summary>
    /// 实体类YG_TENDER_QUA_INQUERY_ANN。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("YG_TENDER_QUA_INQUERY_ANN")]
    [Serializable]
    public partial class YG_TENDER_QUA_INQUERY_ANN : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "YG_TENDER_QUA_INQUERY_ANN");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "YG_TENDER_QUA_INQUERY_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "YG_TENDER_QUA_INQUERY_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "YG_TENDER_QUA_INQUERY_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "YG_TENDER_QUA_INQUERY_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "YG_TENDER_QUA_INQUERY_ANN", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "YG_TENDER_QUA_INQUERY_ANN", "招标项目编号");
            /// <summary>
			/// 公告标段（包）数量
			/// </summary>
			public readonly static Field NOTICE_BID_NUM = new Field("NOTICE_BID_NUM", "YG_TENDER_QUA_INQUERY_ANN", "公告标段（包）数量");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 交易中心名称
			/// </summary>
			public readonly static Field TRAD_CENTER_NAME = new Field("TRAD_CENTER_NAME", "YG_TENDER_QUA_INQUERY_ANN", "交易中心名称");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODES = new Field("UNIFIED_DEAL_CODES", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "统一交易标识码");
            /// <summary>
			/// 招标编号
			/// </summary>
			public readonly static Field TENDER_SELF_CODE = new Field("TENDER_SELF_CODE", "YG_TENDER_QUA_INQUERY_ANN", "招标编号");
            /// <summary>
			/// 公告标题
			/// </summary>
			public readonly static Field NOTICE_NAME = new Field("NOTICE_NAME", "YG_TENDER_QUA_INQUERY_ANN", "公告标题");
            /// <summary>
			/// 公告内容
			/// </summary>
			public readonly static Field NOTICE_CONTENT = new Field("NOTICE_CONTENT", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "公告内容");
            /// <summary>
			/// 公告发布时间
			/// </summary>
			public readonly static Field NOTICE_SEND_TIME = new Field("NOTICE_SEND_TIME", "YG_TENDER_QUA_INQUERY_ANN", "公告发布时间");
            /// <summary>
			/// 公告发布媒体
			/// </summary>
			public readonly static Field NOTICE_MEDIA = new Field("NOTICE_MEDIA", "YG_TENDER_QUA_INQUERY_ANN", "公告发布媒体");
            /// <summary>
			/// 公告源URL
			/// </summary>
			public readonly static Field URL = new Field("URL", "YG_TENDER_QUA_INQUERY_ANN", "公告源URL");
            /// <summary>
			/// 公告性质
			/// </summary>
			public readonly static Field NOTICE_NATURE = new Field("NOTICE_NATURE", "YG_TENDER_QUA_INQUERY_ANN", "公告性质");
            /// <summary>
			/// 公告类型
			/// </summary>
			public readonly static Field BULLETIN_TYPE = new Field("BULLETIN_TYPE", "YG_TENDER_QUA_INQUERY_ANN", "公告类型");
            /// <summary>
			/// 招标文件/资格预审文件获取时间
			/// </summary>
			public readonly static Field DOC_GET_START_TIME = new Field("DOC_GET_START_TIME", "YG_TENDER_QUA_INQUERY_ANN", "招标文件/资格预审文件获取时间");
            /// <summary>
			/// 招标文件/资格预审文件获取截至时间
			/// </summary>
			public readonly static Field DOC_GET_END_TIME = new Field("DOC_GET_END_TIME", "YG_TENDER_QUA_INQUERY_ANN", "招标文件/资格预审文件获取截至时间");
            /// <summary>
			/// 招标文件/资格预审文件获取方法
			/// </summary>
			public readonly static Field TENDER_DOC_GET_METHOD = new Field("TENDER_DOC_GET_METHOD", "YG_TENDER_QUA_INQUERY_ANN", "招标文件/资格预审文件获取方法");
            /// <summary>
			/// 投标文件/资格预审申请文件递交截止时间
			/// </summary>
			public readonly static Field BID_DOC_REFER_END_TIME = new Field("BID_DOC_REFER_END_TIME", "YG_TENDER_QUA_INQUERY_ANN", "投标文件/资格预审申请文件递交截止时间");
            /// <summary>
			/// 是否延期开标
			/// </summary>
			public readonly static Field IS_POSTPONE = new Field("IS_POSTPONE", "YG_TENDER_QUA_INQUERY_ANN", "是否延期开标");
            /// <summary>
			/// 开标时间/开启时间
			/// </summary>
			public readonly static Field BID_OPEN_TIME = new Field("BID_OPEN_TIME", "YG_TENDER_QUA_INQUERY_ANN", "开标时间/开启时间");
            /// <summary>
			/// 开标方式/文件开启方式
			/// </summary>
			public readonly static Field BID_OPEN_METHOD = new Field("BID_OPEN_METHOD", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "开标方式/文件开启方式");
            /// <summary>
			/// 评审办法
			/// </summary>
			public readonly static Field QUAL_TYPE = new Field("QUAL_TYPE", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "评审办法");
            /// <summary>
			/// 文件售价
			/// </summary>
			public readonly static Field DOC_PRICE = new Field("DOC_PRICE", "YG_TENDER_QUA_INQUERY_ANN", "文件售价");
            /// <summary>
			/// 文件售价币种
			/// </summary>
			public readonly static Field DOC_PRICE_CURRENCY = new Field("DOC_PRICE_CURRENCY", "YG_TENDER_QUA_INQUERY_ANN", "文件售价币种");
            /// <summary>
			/// 文件售价单位
			/// </summary>
			public readonly static Field DOC_PRICE_UNIT = new Field("DOC_PRICE_UNIT", "YG_TENDER_QUA_INQUERY_ANN", "文件售价单位");
            /// <summary>
			/// 投标文件/资格预审申请文件递交方法
			/// </summary>
			public readonly static Field BID_DOC_REFER_METHOD = new Field("BID_DOC_REFER_METHOD", "YG_TENDER_QUA_INQUERY_ANN", "投标文件/资格预审申请文件递交方法");
            /// <summary>
			/// 是否允许联合体投标
			/// </summary>
			public readonly static Field SYNDICATED_FLAG = new Field("SYNDICATED_FLAG", "YG_TENDER_QUA_INQUERY_ANN", "是否允许联合体投标");
            /// <summary>
			/// 招标人代码
			/// </summary>
			public readonly static Field TENDERER_CODE = new Field("TENDERER_CODE", "YG_TENDER_QUA_INQUERY_ANN", "招标人代码");
            /// <summary>
			/// 招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "YG_TENDER_QUA_INQUERY_ANN", "招标人名称");
            /// <summary>
			/// 招标人地址
			/// </summary>
			public readonly static Field TENDERER_ADDRESS = new Field("TENDERER_ADDRESS", "YG_TENDER_QUA_INQUERY_ANN", "招标人地址");
            /// <summary>
			/// 招标人联系人
			/// </summary>
			public readonly static Field TENDERER_CONTACTOR = new Field("TENDERER_CONTACTOR", "YG_TENDER_QUA_INQUERY_ANN", "招标人联系人");
            /// <summary>
			/// 招标人联系电话
			/// </summary>
			public readonly static Field TENDERER_PHONE_NUMBER = new Field("TENDERER_PHONE_NUMBER", "YG_TENDER_QUA_INQUERY_ANN", "招标人联系电话");
            /// <summary>
			/// 招标人电子邮箱
			/// </summary>
			public readonly static Field TENDERER_EMAIL = new Field("TENDERER_EMAIL", "YG_TENDER_QUA_INQUERY_ANN", "招标人电子邮箱");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDER_AGENCY_CODE = new Field("TENDER_AGENCY_CODE", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构代码");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDER_AGENCY_NAME = new Field("TENDER_AGENCY_NAME", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构名称");
            /// <summary>
			/// 招标代理机构地址
			/// </summary>
			public readonly static Field TENDER_AGENCY_ADDRESS = new Field("TENDER_AGENCY_ADDRESS", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构地址");
            /// <summary>
			/// 招标代理机构联系人
			/// </summary>
			public readonly static Field TENDER_AGENCY_CONTACTOR = new Field("TENDER_AGENCY_CONTACTOR", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构联系人");
            /// <summary>
			/// 招标代理机构联系电话
			/// </summary>
			public readonly static Field TENDER_AGENCY_PHONE_NUMBER = new Field("TENDER_AGENCY_PHONE_NUMBER", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构联系电话");
            /// <summary>
			/// 招标代理机构电子邮箱
			/// </summary>
			public readonly static Field TENDER_AGENCY_EMAIL = new Field("TENDER_AGENCY_EMAIL", "YG_TENDER_QUA_INQUERY_ANN", "招标代理机构电子邮箱");
            /// <summary>
			/// 其他内容
			/// </summary>
			public readonly static Field OTHER_CONTENT = new Field("OTHER_CONTENT", "YG_TENDER_QUA_INQUERY_ANN",DbType.AnsiString, null, "其他内容");
            /// <summary>
			/// 公告发布责任人
			/// </summary>
			public readonly static Field BULLETIN_DUTY = new Field("BULLETIN_DUTY", "YG_TENDER_QUA_INQUERY_ANN", "公告发布责任人");
            /// <summary>
			/// 交易平台验证责任人
			/// </summary>
			public readonly static Field BULLETIN_DUTY_CODE_TYPE = new Field("BULLETIN_DUTY_CODE_TYPE", "YG_TENDER_QUA_INQUERY_ANN", "交易平台验证责任人");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "YG_TENDER_QUA_INQUERY_ANN", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "YG_TENDER_QUA_INQUERY_ANN", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "YG_TENDER_QUA_INQUERY_ANN", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "YG_TENDER_QUA_INQUERY_ANN", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "YG_TENDER_QUA_INQUERY_ANN", "公共服务平台标识码");
        }
        #endregion
	}
}