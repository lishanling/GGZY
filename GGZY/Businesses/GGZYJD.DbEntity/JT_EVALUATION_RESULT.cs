...
{
    /// <summary>
    /// 实体类JT_EVALUATION_RESULT。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_EVALUATION_RESULT")]
    [Serializable]
    public partial class JT_EVALUATION_RESULT : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_EVALUATION_RESULT");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_EVALUATION_RESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_EVALUATION_RESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_EVALUATION_RESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_EVALUATION_RESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_EVALUATION_RESULT", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_EVALUATION_RESULT", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "JT_EVALUATION_RESULT", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "JT_EVALUATION_RESULT", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "JT_EVALUATION_RESULT", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "JT_EVALUATION_RESULT", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "JT_EVALUATION_RESULT", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "JT_EVALUATION_RESULT", "投标人角色");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "JT_EVALUATION_RESULT", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "JT_EVALUATION_RESULT", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 联合体联系人（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_NAME = new Field("UNION_CONTACT_NAME", "JT_EVALUATION_RESULT", "联合体联系人（如有）");
            /// <summary>
			/// 联合体联系电话（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_PHONE = new Field("UNION_CONTACT_PHONE", "JT_EVALUATION_RESULT", "联合体联系电话（如有）");
            /// <summary>
			/// 报价分
			/// </summary>
			public readonly static Field PRICE_POINTS = new Field("PRICE_POINTS", "JT_EVALUATION_RESULT", "报价分");
            /// <summary>
			/// 资格分
			/// </summary>
			public readonly static Field QUALIFICATION_POINTS = new Field("QUALIFICATION_POINTS", "JT_EVALUATION_RESULT", "资格分");
            /// <summary>
			/// 商务分
			/// </summary>
			public readonly static Field BUSINESS_POINTS = new Field("BUSINESS_POINTS", "JT_EVALUATION_RESULT", "商务分");
            /// <summary>
			/// 技术分
			/// </summary>
			public readonly static Field TECHNICAL_POINTS = new Field("TECHNICAL_POINTS", "JT_EVALUATION_RESULT", "技术分");
            /// <summary>
			/// 响应性评审
			/// </summary>
			public readonly static Field RESPONSE_POINTS = new Field("RESPONSE_POINTS", "JT_EVALUATION_RESULT", "响应性评审");
            /// <summary>
			/// 其他分
			/// </summary>
			public readonly static Field OTHER_POINTS = new Field("OTHER_POINTS", "JT_EVALUATION_RESULT", "其他分");
            /// <summary>
			/// 是否否决投标
			/// </summary>
			public readonly static Field IS_VETO = new Field("IS_VETO", "JT_EVALUATION_RESULT", "是否否决投标");
            /// <summary>
			/// 否决投标理由汇总
			/// </summary>
			public readonly static Field VETO_REASON_DETAIL = new Field("VETO_REASON_DETAIL", "JT_EVALUATION_RESULT",DbType.AnsiString, null, "否决投标理由汇总");
            /// <summary>
			/// 评分结果排位
			/// </summary>
			public readonly static Field RANK = new Field("RANK", "JT_EVALUATION_RESULT", "评分结果排位");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_EVALUATION_RESULT", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_EVALUATION_RESULT", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_EVALUATION_RESULT", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_EVALUATION_RESULT", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_EVALUATION_RESULT", "公共服务平台标识码");
        }
        #endregion
	}
}