...
namespace GGZYJD.DbEntity
{
    ...
    [Table("TRADE_CENTER")]
    [Serializable]
    public partial class TRADE_CENTER : JdEntity
    {
        #region Model
		private decimal? _ID;
		...
		public string PRIVATE_KEY
		{
			...
			set
			{
				this.OnPropertyValueChange(_.PRIVATE_KEY, _PRIVATE_KEY, value);
        ...
        public class _
        {
			...
			/// 交易中心编码
			/// </summary>
			public readonly static Field SYSTEM_NO = new Field("SYSTEM_NO", "TRADE_CENTER", "交易中心编码");
            /// <summary>
			/// 私钥
			/// </summary>
			public readonly static Field PRIVATE_KEY = new Field("PRIVATE_KEY", "TRADE_CENTER", "私钥");
            /// <summary>
			/// 交易中心地址
			/// </summary>
			...
			/// 审批结果通知URL
			/// </summary>
			public readonly static Field NOTIFY_URL = new Field("NOTIFY_URL", "TRADE_CENTER", "审批结果通知URL");
        }
        #endregion
	}
}