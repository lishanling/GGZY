...
{
    /// <summary>
    /// 实体类SL_TENDER_CANDIDATE_ANN。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SL_TENDER_CANDIDATE_ANN")]
    [Serializable]
    public partial class SL_TENDER_CANDIDATE_ANN : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SL_TENDER_CANDIDATE_ANN");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "SL_TENDER_CANDIDATE_ANN", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "SL_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 相关统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "SL_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "相关统一交易标识码");
            /// <summary>
			/// 公示标题
			/// </summary>
			public readonly static Field PUBLICITY_NAME = new Field("PUBLICITY_NAME", "SL_TENDER_CANDIDATE_ANN", "公示标题");
            /// <summary>
			/// 公示内容
			/// </summary>
			public readonly static Field PUBLICITY_CONTENT = new Field("PUBLICITY_CONTENT", "SL_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "公示内容");
            /// <summary>
			/// 公示提交时间
			/// </summary>
			public readonly static Field PUBLICITY_REFER_TIME = new Field("PUBLICITY_REFER_TIME", "SL_TENDER_CANDIDATE_ANN", "公示提交时间");
            /// <summary>
			/// 公示发布媒体
			/// </summary>
			public readonly static Field NOTICE_MEDIA = new Field("NOTICE_MEDIA", "SL_TENDER_CANDIDATE_ANN", "公示发布媒体");
            /// <summary>
			/// 公示源URL
			/// </summary>
			public readonly static Field URL = new Field("URL", "SL_TENDER_CANDIDATE_ANN", "公示源URL");
            /// <summary>
			/// 公示类型
			/// </summary>
			public readonly static Field PUBLICITY_TYPE = new Field("PUBLICITY_TYPE", "SL_TENDER_CANDIDATE_ANN", "公示类型");
            /// <summary>
			/// 公示开始时间
			/// </summary>
			public readonly static Field PUBLICITY_START_TIME = new Field("PUBLICITY_START_TIME", "SL_TENDER_CANDIDATE_ANN", "公示开始时间");
            /// <summary>
			/// 公示结束时间
			/// </summary>
			public readonly static Field PUBLICITY_END_TIME = new Field("PUBLICITY_END_TIME", "SL_TENDER_CANDIDATE_ANN", "公示结束时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "SL_TENDER_CANDIDATE_ANN", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "SL_TENDER_CANDIDATE_ANN", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "SL_TENDER_CANDIDATE_ANN", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "SL_TENDER_CANDIDATE_ANN", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "SL_TENDER_CANDIDATE_ANN", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "SL_TENDER_CANDIDATE_ANN", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "SL_TENDER_CANDIDATE_ANN", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "SL_TENDER_CANDIDATE_ANN", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "SL_TENDER_CANDIDATE_ANN", "M_TM");
            /// <summary>
			/// 提出异议的渠道和方式
			/// </summary>
			public readonly static Field OBJECTION_METHOD = new Field("OBJECTION_METHOD", "SL_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "提出异议的渠道和方式");
            /// <summary>
			/// 其他内容
			/// </summary>
			public readonly static Field OTHER_CONTENT = new Field("OTHER_CONTENT", "SL_TENDER_CANDIDATE_ANN",DbType.AnsiString, null, "其他内容");
            /// <summary>
			/// 公示发布责任人
			/// </summary>
			public readonly static Field BULLETIN_DUTY = new Field("BULLETIN_DUTY", "SL_TENDER_CANDIDATE_ANN", "公示发布责任人");
            /// <summary>
			/// 交易平台数据验证责任人姓名
			/// </summary>
			public readonly static Field EXAMINER_NAME = new Field("EXAMINER_NAME", "SL_TENDER_CANDIDATE_ANN", "交易平台数据验证责任人姓名");
            /// <summary>
			/// 联合体代码
			/// </summary>
			public readonly static Field UNION_CODE = new Field("UNION_CODE", "SL_TENDER_CANDIDATE_ANN", "联合体代码");
            /// <summary>
			/// 联合体名称
			/// </summary>
			public readonly static Field UNION_NAME = new Field("UNION_NAME", "SL_TENDER_CANDIDATE_ANN", "联合体名称");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "SL_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "SL_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "SL_TENDER_CANDIDATE_ANN", "");
            /// <summary>
			/// 第一中标候选人名称
			/// </summary>
			public readonly static Field FIRST_BIDDER_NAME = new Field("FIRST_BIDDER_NAME", "SL_TENDER_CANDIDATE_ANN", "第一中标候选人名称");
            /// <summary>
			/// 第一中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field FIRST_BIDDER_CODE = new Field("FIRST_BIDDER_CODE", "SL_TENDER_CANDIDATE_ANN", "第一中标候选人统一社会信用代码");
            /// <summary>
			/// 第二中标候选人名称
			/// </summary>
			public readonly static Field SECOND_BIDDER_NAME = new Field("SECOND_BIDDER_NAME", "SL_TENDER_CANDIDATE_ANN", "第二中标候选人名称");
            /// <summary>
			/// 第二中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field SECOND_BIDDER_CODE = new Field("SECOND_BIDDER_CODE", "SL_TENDER_CANDIDATE_ANN", "第二中标候选人统一社会信用代码");
            /// <summary>
			/// 第三中标候选人名称
			/// </summary>
			public readonly static Field THIRD_BIDDER_NAME = new Field("THIRD_BIDDER_NAME", "SL_TENDER_CANDIDATE_ANN", "第三中标候选人名称");
            /// <summary>
			/// 第三中标候选人统一社会信用代码
			/// </summary>
			public readonly static Field THIRD_BIDDER_CODE = new Field("THIRD_BIDDER_CODE", "SL_TENDER_CANDIDATE_ANN", "第三中标候选人统一社会信用代码");
        }
        #endregion
	}
}