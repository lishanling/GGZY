...
{
    /// <summary>
    /// 实体类RECORD_CLASSIFY。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("RECORD_CLASSIFY")]
    [Serializable]
    public partial class RECORD_CLASSIFY : JdEntity
    {
        #region Model
		private decimal? _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "RECORD_CLASSIFY");
            /// <summary>
			/// ID
			/// </summary>
			public readonly static Field ID = new Field("ID", "RECORD_CLASSIFY", "ID");
            /// <summary>
			/// 备案主表ID
			/// </summary>
			public readonly static Field RECORD_ID = new Field("RECORD_ID", "RECORD_CLASSIFY", "备案主表ID");
            /// <summary>
			/// 招标类型
			/// </summary>
			public readonly static Field TENDER_TYPE = new Field("TENDER_TYPE", "RECORD_CLASSIFY", "招标类型");
            /// <summary>
			/// 招标控制价
			/// </summary>
			public readonly static Field CONTROL_PRICE = new Field("CONTROL_PRICE", "RECORD_CLASSIFY", "招标控制价");
            /// <summary>
			/// 控制价单位
			/// </summary>
			public readonly static Field CONTROL_UNIT = new Field("CONTROL_UNIT", "RECORD_CLASSIFY", "控制价单位");
            /// <summary>
			/// 控制价币种
			/// </summary>
			public readonly static Field CONTROL_CURRENCY_CODE = new Field("CONTROL_CURRENCY_CODE", "RECORD_CLASSIFY", "控制价币种");
            /// <summary>
			/// 招标范围及和内容
			/// </summary>
			public readonly static Field TENDER_CONTENT = new Field("TENDER_CONTENT", "RECORD_CLASSIFY",DbType.AnsiString, null, "招标范围及和内容");
            /// <summary>
			/// 确定企业资质及等级的相关依据
			/// </summary>
			public readonly static Field ENTERPRISE_QUALIFI_BASIC = new Field("ENTERPRISE_QUALIFI_BASIC", "RECORD_CLASSIFY",DbType.AnsiString, null, "确定企业资质及等级的相关依据");
            /// <summary>
			/// 确定注册建造师及等级的相关依据
			/// </summary>
			public readonly static Field REGISTER_CON_BASIC = new Field("REGISTER_CON_BASIC", "RECORD_CLASSIFY",DbType.AnsiString, null, "确定注册建造师及等级的相关依据");
            /// <summary>
			/// 确定类似工程业绩的相关依据
			/// </summary>
			public readonly static Field SIMILAR_PROJECT_BASIC = new Field("SIMILAR_PROJECT_BASIC", "RECORD_CLASSIFY",DbType.AnsiString, null, "确定类似工程业绩的相关依据");
            /// <summary>
			/// 总工期
			/// </summary>
			public readonly static Field ALL_LIMITE_TIME = new Field("ALL_LIMITE_TIME", "RECORD_CLASSIFY", "总工期");
            /// <summary>
			/// 定额工期
			/// </summary>
			public readonly static Field QUOTA_LIMIT_TIME = new Field("QUOTA_LIMIT_TIME", "RECORD_CLASSIFY", "定额工期");
            /// <summary>
			/// 投标人资质等级要求
			/// </summary>
			public readonly static Field BIDDER_QUALIFI_REQUIRE = new Field("BIDDER_QUALIFI_REQUIRE", "RECORD_CLASSIFY",DbType.AnsiString, null, "投标人资质等级要求");
            /// <summary>
			/// 注册建造师等级要求
			/// </summary>
			public readonly static Field REGISTER_CON_REQUIRE = new Field("REGISTER_CON_REQUIRE", "RECORD_CLASSIFY",DbType.AnsiString, null, "注册建造师等级要求");
            /// <summary>
			/// 是否联合体投标
			/// </summary>
			public readonly static Field SYNDICATED_FLAG = new Field("SYNDICATED_FLAG", "RECORD_CLASSIFY", "是否联合体投标");
            /// <summary>
			/// 是否应用综合评价分值
			/// </summary>
			public readonly static Field IS_COMPREHENSIVE_SCORE = new Field("IS_COMPREHENSIVE_SCORE", "RECORD_CLASSIFY", "是否应用综合评价分值");
            /// <summary>
			/// 类型业绩要求
			/// </summary>
			public readonly static Field TYPE_PERFORM_REQUIRE = new Field("TYPE_PERFORM_REQUIRE", "RECORD_CLASSIFY",DbType.AnsiString, null, "类型业绩要求");
            /// <summary>
			/// 投标保证金金额
			/// </summary>
			public readonly static Field MARGIN_AMOUNT = new Field("MARGIN_AMOUNT", "RECORD_CLASSIFY", "投标保证金金额");
            /// <summary>
			/// 投标保证金单位
			/// </summary>
			public readonly static Field MARGIN_UNIT = new Field("MARGIN_UNIT", "RECORD_CLASSIFY", "投标保证金单位");
            /// <summary>
			/// 投标保证金币种
			/// </summary>
			public readonly static Field MARGIN_CURRENCY_CODE = new Field("MARGIN_CURRENCY_CODE", "RECORD_CLASSIFY", "投标保证金币种");
            /// <summary>
			/// 招标文件获取方法
			/// </summary>
			public readonly static Field TENDER_DOC_GET_METHOD = new Field("TENDER_DOC_GET_METHOD", "RECORD_CLASSIFY", "招标文件获取方法");
            /// <summary>
			/// 招标文件获取开始时间
			/// </summary>
			public readonly static Field DOC_GET_START_TIME = new Field("DOC_GET_START_TIME", "RECORD_CLASSIFY", "招标文件获取开始时间");
            /// <summary>
			/// 招标文件获取截止时间
			/// </summary>
			public readonly static Field DOC_GET_END_TIME = new Field("DOC_GET_END_TIME", "RECORD_CLASSIFY", "招标文件获取截止时间");
            /// <summary>
			/// 投标文件递交截止时间
			/// </summary>
			public readonly static Field BID_DOC_REFER_END_TIME = new Field("BID_DOC_REFER_END_TIME", "RECORD_CLASSIFY", "投标文件递交截止时间");
            /// <summary>
			/// 投标文件递交方法
			/// </summary>
			public readonly static Field BID_DOC_REFER_METHOD = new Field("BID_DOC_REFER_METHOD", "RECORD_CLASSIFY", "投标文件递交方法");
            /// <summary>
			/// 招标公告
			/// </summary>
			public readonly static Field TENDER_NOTICE = new Field("TENDER_NOTICE", "RECORD_CLASSIFY",DbType.AnsiString, null, "招标公告");
            /// <summary>
			/// 投标截止时间
			/// </summary>
			public readonly static Field DEADLINE_BIDDING = new Field("DEADLINE_BIDDING", "RECORD_CLASSIFY", "投标截止时间");
            /// <summary>
			/// 开标时间
			/// </summary>
			public readonly static Field BID_OPEN_TIME = new Field("BID_OPEN_TIME", "RECORD_CLASSIFY", "开标时间");
            /// <summary>
			/// 履约担保金额
			/// </summary>
			public readonly static Field PERFORM_PRICE = new Field("PERFORM_PRICE", "RECORD_CLASSIFY", "履约担保金额");
            /// <summary>
			/// 合同签订时间
			/// </summary>
			public readonly static Field CONTRACT_SIGN_TIME = new Field("CONTRACT_SIGN_TIME", "RECORD_CLASSIFY", "合同签订时间");
            /// <summary>
			/// 评标委员会成员人数
			/// </summary>
			public readonly static Field ALL_EXPERT_NUM = new Field("ALL_EXPERT_NUM", "RECORD_CLASSIFY", "评标委员会成员人数");
            /// <summary>
			/// 工程造价类专家人数（最低投标价）
			/// </summary>
			public readonly static Field EXPERT_NUM = new Field("EXPERT_NUM", "RECORD_CLASSIFY", "工程造价类专家人数（最低投标价）");
            /// <summary>
			/// 评标办法
			/// </summary>
			public readonly static Field EVALUATING_METHOD = new Field("EVALUATING_METHOD", "RECORD_CLASSIFY", "评标办法");
            /// <summary>
			/// 合同风险范围
			/// </summary>
			public readonly static Field SCOPE_CONTRACT_RISK = new Field("SCOPE_CONTRACT_RISK", "RECORD_CLASSIFY",DbType.AnsiString, null, "合同风险范围");
            /// <summary>
			/// 合同金额
			/// </summary>
			public readonly static Field CONTRACT_PRICE = new Field("CONTRACT_PRICE", "RECORD_CLASSIFY", "合同金额");
            /// <summary>
			/// 预付款
			/// </summary>
			public readonly static Field ADVANCE_CHARGE = new Field("ADVANCE_CHARGE", "RECORD_CLASSIFY", "预付款");
            /// <summary>
			/// 进度款支付比例
			/// </summary>
			public readonly static Field PERCENT_PROGERESS = new Field("PERCENT_PROGERESS", "RECORD_CLASSIFY", "进度款支付比例");
            /// <summary>
			/// 缺陷责任工期
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD = new Field("DEFECT_LIABILITY_PERIOD", "RECORD_CLASSIFY", "缺陷责任工期");
            /// <summary>
			/// 质量保证金金额
			/// </summary>
			public readonly static Field QUALITY_MARGIN_AMOUNT = new Field("QUALITY_MARGIN_AMOUNT", "RECORD_CLASSIFY", "质量保证金金额");
            /// <summary>
			/// 是否延期
			/// </summary>
			public readonly static Field IS_POSTPONE = new Field("IS_POSTPONE", "RECORD_CLASSIFY", "是否延期");
            /// <summary>
			/// 投标截止时间-澄清修改
			/// </summary>
			public readonly static Field DEADLINE_BIDDING2 = new Field("DEADLINE_BIDDING2", "RECORD_CLASSIFY", "投标截止时间-澄清修改");
            /// <summary>
			/// 延期后开标时间
			/// </summary>
			public readonly static Field POST_OPEN_TIME = new Field("POST_OPEN_TIME", "RECORD_CLASSIFY", "延期后开标时间");
            /// <summary>
			/// 延期后开标地点
			/// </summary>
			public readonly static Field POST_OPEN_ADDRESS = new Field("POST_OPEN_ADDRESS", "RECORD_CLASSIFY", "延期后开标地点");
            /// <summary>
			/// 澄清、修改公示标题
			/// </summary>
			public readonly static Field CLARIFY_TITLE = new Field("CLARIFY_TITLE", "RECORD_CLASSIFY", "澄清、修改公示标题");
            /// <summary>
			/// 澄清、修改内容
			/// </summary>
			public readonly static Field CLARIFY_CONTENT = new Field("CLARIFY_CONTENT", "RECORD_CLASSIFY",DbType.AnsiString, null, "澄清、修改内容");
            /// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CREATE_TM = new Field("CREATE_TM", "RECORD_CLASSIFY", "创建时间");
            /// <summary>
			/// 创建人
			/// </summary>
			public readonly static Field CREATOR = new Field("CREATOR", "RECORD_CLASSIFY", "创建人");
            /// <summary>
			/// 澄清、修改截止时间
			/// </summary>
			public readonly static Field CLARIFY_END_TIME = new Field("CLARIFY_END_TIME", "RECORD_CLASSIFY", "澄清、修改截止时间");
            /// <summary>
			/// 保证金提交截止时间
			/// </summary>
			public readonly static Field DEPOSIT_END_TIME = new Field("DEPOSIT_END_TIME", "RECORD_CLASSIFY", "保证金提交截止时间");
            /// <summary>
			/// 工程量清单编制单位
			/// </summary>
			public readonly static Field QUANTITIES_DRAW_UNIT = new Field("QUANTITIES_DRAW_UNIT", "RECORD_CLASSIFY", "工程量清单编制单位");
            /// <summary>
			/// 工程量清单审查单位
			/// </summary>
			public readonly static Field QUANTITIES_AUDIT_UNIT = new Field("QUANTITIES_AUDIT_UNIT", "RECORD_CLASSIFY", "工程量清单审查单位");
            /// <summary>
			/// 招标控制价编制单位
			/// </summary>
			public readonly static Field CONTROL_PRICE_DRAW_UNIT = new Field("CONTROL_PRICE_DRAW_UNIT", "RECORD_CLASSIFY", "招标控制价编制单位");
            /// <summary>
			/// 招标控制价审核单位
			/// </summary>
			public readonly static Field CONTROL_PRICE_AUDIT_UNIT = new Field("CONTROL_PRICE_AUDIT_UNIT", "RECORD_CLASSIFY", "招标控制价审核单位");
            /// <summary>
			/// 履约担保金额单位
			/// </summary>
			public readonly static Field PERFORM_UNIT = new Field("PERFORM_UNIT", "RECORD_CLASSIFY", "履约担保金额单位");
            /// <summary>
			/// 履约担保金额币种
			/// </summary>
			public readonly static Field PERFORM_CURRENCY_CODE = new Field("PERFORM_CURRENCY_CODE", "RECORD_CLASSIFY", "履约担保金额币种");
        }
        #endregion
	}
}