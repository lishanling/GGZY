...
{
    /// <summary>
    /// 实体类RECORD_BIDDOC_NORMAL。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("RECORD_BIDDOC_NORMAL")]
    [Serializable]
    public partial class RECORD_BIDDOC_NORMAL : JdEntity
    {
        #region Model
		private decimal? _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "RECORD_BIDDOC_NORMAL");
            /// <summary>
			/// ID
			/// </summary>
			public readonly static Field ID = new Field("ID", "RECORD_BIDDOC_NORMAL", "ID");
            /// <summary>
			/// 备案主表ID
			/// </summary>
			public readonly static Field RECORD_ID = new Field("RECORD_ID", "RECORD_BIDDOC_NORMAL", "备案主表ID");
            /// <summary>
			/// 招标文件/资格预审文件获取时间
			/// </summary>
			public readonly static Field TENDER_DOC_GET_TIME = new Field("TENDER_DOC_GET_TIME", "RECORD_BIDDOC_NORMAL", "招标文件/资格预审文件获取时间");
            /// <summary>
			/// 招标文件/资格预审文件获取截至时间
			/// </summary>
			public readonly static Field DOC_GET_END_TIME = new Field("DOC_GET_END_TIME", "RECORD_BIDDOC_NORMAL", "招标文件/资格预审文件获取截至时间");
            /// <summary>
			/// 投标文件/资格预审申请文件递交截止时间
			/// </summary>
			public readonly static Field BID_DOC_REFER_END_TIME = new Field("BID_DOC_REFER_END_TIME", "RECORD_BIDDOC_NORMAL", "投标文件/资格预审申请文件递交截止时间");
            /// <summary>
			/// 开标时间
			/// </summary>
			public readonly static Field BID_OPEN_TIME = new Field("BID_OPEN_TIME", "RECORD_BIDDOC_NORMAL", "开标时间");
            /// <summary>
			/// 文件售价
			/// </summary>
			public readonly static Field DOC_PRICE = new Field("DOC_PRICE", "RECORD_BIDDOC_NORMAL", "文件售价");
            /// <summary>
			/// 文件售价币种
			/// </summary>
			public readonly static Field DOC_PRICE_CURRENCY = new Field("DOC_PRICE_CURRENCY", "RECORD_BIDDOC_NORMAL", "文件售价币种");
            /// <summary>
			/// 文件售价单位
			/// </summary>
			public readonly static Field DOC_PRICE_UNIT = new Field("DOC_PRICE_UNIT", "RECORD_BIDDOC_NORMAL", "文件售价单位");
            /// <summary>
			/// 是否允许联合体投标
			/// </summary>
			public readonly static Field SYNDICATED_FLAG = new Field("SYNDICATED_FLAG", "RECORD_BIDDOC_NORMAL", "是否允许联合体投标");
            /// <summary>
			/// 联合体投标要求
			/// </summary>
			public readonly static Field SYNDICATED_REQUIRE = new Field("SYNDICATED_REQUIRE", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "联合体投标要求");
            /// <summary>
			/// 确定类似工程业绩的相关依据
			/// </summary>
			public readonly static Field SIMILAR_PROJECT_BASIC = new Field("SIMILAR_PROJECT_BASIC", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "确定类似工程业绩的相关依据");
            /// <summary>
			/// 投标资格
			/// </summary>
			public readonly static Field BID_QUALIFICATION = new Field("BID_QUALIFICATION", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "投标资格");
            /// <summary>
			/// 投标有效期
			/// </summary>
			public readonly static Field VALID_PERIOD = new Field("VALID_PERIOD", "RECORD_BIDDOC_NORMAL", "投标有效期");
            /// <summary>
			/// 投标文件递交方法
			/// </summary>
			public readonly static Field BID_DOC_REFER_METHOD = new Field("BID_DOC_REFER_METHOD", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "投标文件递交方法");
            /// <summary>
			/// 投标保证金缴纳方式
			/// </summary>
			public readonly static Field MARGIN_PAY_TYPE = new Field("MARGIN_PAY_TYPE", "RECORD_BIDDOC_NORMAL", "投标保证金缴纳方式");
            /// <summary>
			/// 投标保证金金额
			/// </summary>
			public readonly static Field MARGIN_AMOUNT = new Field("MARGIN_AMOUNT", "RECORD_BIDDOC_NORMAL", "投标保证金金额");
            /// <summary>
			/// 投标保证金单位
			/// </summary>
			public readonly static Field MARGIN_UNIT = new Field("MARGIN_UNIT", "RECORD_BIDDOC_NORMAL", "投标保证金单位");
            /// <summary>
			/// 投标保证金币种
			/// </summary>
			public readonly static Field MARGIN_CURRENCY_CODE = new Field("MARGIN_CURRENCY_CODE", "RECORD_BIDDOC_NORMAL", "投标保证金币种");
            /// <summary>
			/// 招标控制价
			/// </summary>
			public readonly static Field CONTROL_PRICE = new Field("CONTROL_PRICE", "RECORD_BIDDOC_NORMAL", "招标控制价");
            /// <summary>
			/// 控制价单位
			/// </summary>
			public readonly static Field CONTROL_UNIT = new Field("CONTROL_UNIT", "RECORD_BIDDOC_NORMAL", "控制价单位");
            /// <summary>
			/// 控制价币种
			/// </summary>
			public readonly static Field CONTROL_CURRENCY_CODE = new Field("CONTROL_CURRENCY_CODE", "RECORD_BIDDOC_NORMAL", "控制价币种");
            /// <summary>
			/// 评标办法
			/// </summary>
			public readonly static Field EVALUATING_METHOD = new Field("EVALUATING_METHOD", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "评标办法");
            /// <summary>
			/// 开标地点
			/// </summary>
			public readonly static Field BID_OPEN_PLACE = new Field("BID_OPEN_PLACE", "RECORD_BIDDOC_NORMAL", "开标地点");
            /// <summary>
			/// 答疑澄清时间
			/// </summary>
			public readonly static Field CLARIFY_TIME = new Field("CLARIFY_TIME", "RECORD_BIDDOC_NORMAL", "答疑澄清时间");
            /// <summary>
			/// 招标公告
			/// </summary>
			public readonly static Field TENDER_NOTICE = new Field("TENDER_NOTICE", "RECORD_BIDDOC_NORMAL",DbType.AnsiString, null, "招标公告");
            /// <summary>
			/// 资格审查方式
			/// </summary>
			public readonly static Field QUAL_TYPE = new Field("QUAL_TYPE", "RECORD_BIDDOC_NORMAL", "资格审查方式");
            /// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CREATE_TM = new Field("CREATE_TM", "RECORD_BIDDOC_NORMAL", "创建时间");
            /// <summary>
			/// 创建人
			/// </summary>
			public readonly static Field CREATOR = new Field("CREATOR", "RECORD_BIDDOC_NORMAL", "创建人");
        }
        #endregion
	}
}