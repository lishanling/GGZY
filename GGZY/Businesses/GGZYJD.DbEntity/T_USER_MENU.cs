...
namespace GGZYJD.DbEntity
{
    ...
    [Table("T_USER_MENU")]
    [Serializable]
    public partial class T_USER_MENU : JdEntity
    {
        #region Model
		private decimal? _ID;
		...
		/// 是否打开新页面
		/// </summary>
		public decimal? IS_OPENPAGE
		{
			get{ return _IS_OPENPAGE; }
			set
			{
				this.OnPropertyValueChange(_.IS_OPENPAGE, _IS_OPENPAGE, value);
				this._IS_OPENPAGE = value;
			}
		}
		#endregion
        ...
        public class _
        {
			...
			/// 是否打开新页面
			/// </summary>
			public readonly static Field IS_OPENPAGE = new Field("IS_OPENPAGE", "T_USER_MENU", "是否打开新页面");
        }
        #endregion
	}
}