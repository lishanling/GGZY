...
{
    /// <summary>
    /// 实体类JT_SUBGRADE_TENDER_FILE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_SUBGRADE_TENDER_FILE")]
    [Serializable]
    public partial class JT_SUBGRADE_TENDER_FILE : JdEntity
    {
        #region Model
		...
		private string _CONTRACT_NAME_OR_NUM;
		private string _THIS_CONTRACT_SECTION;
		...
		/// 施工监理的合同段内容
		/// </summary>
		public string CONTRACT_NAME_OR_NUM
		{
		...
		/// 本次招标合同段名称
		/// </summary>
		public string THIS_CONTRACT_SECTION
		{
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_SUBGRADE_TENDER_FILE");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "JT_SUBGRADE_TENDER_FILE", "招标项目编号");
            /// <summary>
			/// 相关标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODES = new Field("BID_SECTION_CODES", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "相关标段（包）编号");
            /// <summary>
			/// 项目总工期
			/// </summary>
			public readonly static Field LIMITE_ALL_TIME = new Field("LIMITE_ALL_TIME", "JT_SUBGRADE_TENDER_FILE", "项目总工期");
            /// <summary>
			/// 缺陷责任期
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD1 = new Field("DEFECT_LIABILITY_PERIOD1", "JT_SUBGRADE_TENDER_FILE", "缺陷责任期");
            /// <summary>
			/// 本项目路基土建工程施工划分标段数
			/// </summary>
			public readonly static Field BID_SECTION = new Field("BID_SECTION", "JT_SUBGRADE_TENDER_FILE", "本项目路基土建工程施工划分标段数");
            /// <summary>
			/// 投标段组数量
			/// </summary>
			public readonly static Field BID_SECTION_GROUP = new Field("BID_SECTION_GROUP", "JT_SUBGRADE_TENDER_FILE", "投标段组数量");
            /// <summary>
			/// 本次招标标段数
			/// </summary>
			public readonly static Field TENDERER_BID_SECTION = new Field("TENDERER_BID_SECTION", "JT_SUBGRADE_TENDER_FILE", "本次招标标段数");
            /// <summary>
			/// 本次招标投标段组数
			/// </summary>
			public readonly static Field TENDERER_BID_SECTION_GROUP = new Field("TENDERER_BID_SECTION_GROUP", "JT_SUBGRADE_TENDER_FILE", "本次招标投标段组数");
            /// <summary>
			/// 投标人允许参投标段数量
			/// </summary>
			public readonly static Field CONTRACT_SEGMENT = new Field("CONTRACT_SEGMENT", "JT_SUBGRADE_TENDER_FILE", "投标人允许参投标段数量");
            /// <summary>
			/// 投标人允许中标数量
			/// </summary>
			public readonly static Field TENDER_NUMBER = new Field("TENDER_NUMBER", "JT_SUBGRADE_TENDER_FILE", "投标人允许中标数量");
            /// <summary>
			/// 其他事项
			/// </summary>
			public readonly static Field OTHER_MATTERS = new Field("OTHER_MATTERS", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "其他事项");
            /// <summary>
			/// 是否组织踏勘
			/// </summary>
			public readonly static Field RECONNAISSANCE = new Field("RECONNAISSANCE", "JT_SUBGRADE_TENDER_FILE", "是否组织踏勘");
            /// <summary>
			/// 踏勘时间
			/// </summary>
			public readonly static Field RECONNAISSANCE_TIME = new Field("RECONNAISSANCE_TIME", "JT_SUBGRADE_TENDER_FILE", "踏勘时间");
            /// <summary>
			/// 踏勘地点
			/// </summary>
			public readonly static Field RECONNAISSANCE_ADDRESS = new Field("RECONNAISSANCE_ADDRESS", "JT_SUBGRADE_TENDER_FILE", "踏勘地点");
            /// <summary>
			/// 是否召开投标预备会
			/// </summary>
			public readonly static Field PREPARATORY_MEETING = new Field("PREPARATORY_MEETING", "JT_SUBGRADE_TENDER_FILE", "是否召开投标预备会");
            /// <summary>
			/// 召开投标预备会时间
			/// </summary>
			public readonly static Field PREPARATORY_MEETING_TIME = new Field("PREPARATORY_MEETING_TIME", "JT_SUBGRADE_TENDER_FILE", "召开投标预备会时间");
            /// <summary>
			/// 召开投标预备会地点
			/// </summary>
			public readonly static Field PREPARATORY_MEETING_ADDRESS = new Field("PREPARATORY_MEETING_ADDRESS", "JT_SUBGRADE_TENDER_FILE", "召开投标预备会地点");
            /// <summary>
			/// 交通工具
			/// </summary>
			public readonly static Field VEHICLE = new Field("VEHICLE", "JT_SUBGRADE_TENDER_FILE", "交通工具");
            /// <summary>
			/// 其他发布媒体1
			/// </summary>
			public readonly static Field MEDIA1 = new Field("MEDIA1", "JT_SUBGRADE_TENDER_FILE", "其他发布媒体1");
            /// <summary>
			/// 其他发布媒体2
			/// </summary>
			public readonly static Field MEDIA2 = new Field("MEDIA2", "JT_SUBGRADE_TENDER_FILE", "其他发布媒体2");
            /// <summary>
			/// 其他
			/// </summary>
			public readonly static Field OTHER = new Field("OTHER", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "其他");
            /// <summary>
			/// 资金落实情况
			/// </summary>
			public readonly static Field FUND_IMPLEMENTATION = new Field("FUND_IMPLEMENTATION", "JT_SUBGRADE_TENDER_FILE", "资金落实情况");
            /// <summary>
			/// 总计划开工日期
			/// </summary>
			public readonly static Field BEGIN_ALL_DATE = new Field("BEGIN_ALL_DATE", "JT_SUBGRADE_TENDER_FILE", "总计划开工日期");
            /// <summary>
			/// 计划交工日期
			/// </summary>
			public readonly static Field END_DATE = new Field("END_DATE", "JT_SUBGRADE_TENDER_FILE", "计划交工日期");
            /// <summary>
			/// 本标段的安全目标
			/// </summary>
			public readonly static Field SECURITY_TARGET = new Field("SECURITY_TARGET", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "本标段的安全目标");
            /// <summary>
			/// 投标保证金递交截止时间
			/// </summary>
			public readonly static Field MARGIN_TIME = new Field("MARGIN_TIME", "JT_SUBGRADE_TENDER_FILE", "投标保证金递交截止时间");
            /// <summary>
			/// 招标人账户
			/// </summary>
			public readonly static Field MARGIN_NAME = new Field("MARGIN_NAME", "JT_SUBGRADE_TENDER_FILE", "招标人账户");
            /// <summary>
			/// 招标人账号
			/// </summary>
			public readonly static Field MARGIN_NUMBER = new Field("MARGIN_NUMBER", "JT_SUBGRADE_TENDER_FILE", "招标人账号");
            /// <summary>
			/// 招标人开户行
			/// </summary>
			public readonly static Field MARGIN_BANK = new Field("MARGIN_BANK", "JT_SUBGRADE_TENDER_FILE", "招标人开户行");
            /// <summary>
			/// 近年完成的类似项目的年份要求
			/// </summary>
			public readonly static Field PROJECT_YEAR_REQUIRED_TIME = new Field("PROJECT_YEAR_REQUIRED_TIME", "JT_SUBGRADE_TENDER_FILE", "近年完成的类似项目的年份要求");
            /// <summary>
			/// 近年发生的诉讼及仲裁情况的年份要求
			/// </summary>
			public readonly static Field LITIGATION_YEAR_REQUIRED_TIME = new Field("LITIGATION_YEAR_REQUIRED_TIME", "JT_SUBGRADE_TENDER_FILE", "近年发生的诉讼及仲裁情况的年份要求");
            /// <summary>
			/// 监督部门名称
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_NAME = new Field("SUPERVISE_DEPT_NAME", "JT_SUBGRADE_TENDER_FILE", "监督部门名称");
            /// <summary>
			/// 监督部门联系电话
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_TELE = new Field("SUPERVISE_DEPT_TELE", "JT_SUBGRADE_TENDER_FILE", "监督部门联系电话");
            /// <summary>
			/// 监督部门地址
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ADDRESS = new Field("SUPERVISE_DEPT_ADDRESS", "JT_SUBGRADE_TENDER_FILE", "监督部门地址");
            /// <summary>
			/// 监督部门邮编
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_ZIP_CODE = new Field("SUPERVISE_DEPT_ZIP_CODE", "JT_SUBGRADE_TENDER_FILE", "监督部门邮编");
            /// <summary>
			/// 评标委员会人数
			/// </summary>
			public readonly static Field ALL_EXPERT_NUM = new Field("ALL_EXPERT_NUM", "JT_SUBGRADE_TENDER_FILE", "评标委员会人数");
            /// <summary>
			/// 招标人代表人数
			/// </summary>
			public readonly static Field TENDERER_NUM = new Field("TENDERER_NUM", "JT_SUBGRADE_TENDER_FILE", "招标人代表人数");
            /// <summary>
			/// 专家人数
			/// </summary>
			public readonly static Field EXPERT_NUM = new Field("EXPERT_NUM", "JT_SUBGRADE_TENDER_FILE", "专家人数");
            /// <summary>
			/// 资质最低条件
			/// </summary>
			public readonly static Field MINIMUM_QUALIFICATIONS = new Field("MINIMUM_QUALIFICATIONS", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "资质最低条件");
            /// <summary>
			/// 财务最低要求
			/// </summary>
			public readonly static Field FINANCIAL_REQUIRE = new Field("FINANCIAL_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "财务最低要求");
            /// <summary>
			/// 业绩最低要求
			/// </summary>
			public readonly static Field ACHIEVEMENT_REQUIRE = new Field("ACHIEVEMENT_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "业绩最低要求");
            /// <summary>
			/// 信誉最低要求
			/// </summary>
			public readonly static Field REPUTATION_REQUIRE = new Field("REPUTATION_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "信誉最低要求");
            /// <summary>
			/// 评标委员会推荐中标候选人人数
			/// </summary>
			public readonly static Field WIN_CANDIDATE_NUM = new Field("WIN_CANDIDATE_NUM", "JT_SUBGRADE_TENDER_FILE", "评标委员会推荐中标候选人人数");
            /// <summary>
			/// 评标办法评审因素和评审标准
			/// </summary>
			public readonly static Field EVALUATING_METHOD_STANDARD = new Field("EVALUATING_METHOD_STANDARD", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "评标办法评审因素和评审标准");
            /// <summary>
			/// 发包人
			/// </summary>
			public readonly static Field SUBC_NAME = new Field("SUBC_NAME", "JT_SUBGRADE_TENDER_FILE", "发包人");
            /// <summary>
			/// 发包人地址
			/// </summary>
			public readonly static Field SUBC_NAME_ADDRESS = new Field("SUBC_NAME_ADDRESS", "JT_SUBGRADE_TENDER_FILE", "发包人地址");
            /// <summary>
			/// 发包人邮政编码
			/// </summary>
			public readonly static Field SUBC_ZIP_CODE = new Field("SUBC_ZIP_CODE", "JT_SUBGRADE_TENDER_FILE", "发包人邮政编码");
            /// <summary>
			/// 材料名称
			/// </summary>
			public readonly static Field MATERIAL = new Field("MATERIAL", "JT_SUBGRADE_TENDER_FILE", "材料名称");
            /// <summary>
			/// 项目专用合同条款
			/// </summary>
			public readonly static Field CONTRACT_CLAUSE = new Field("CONTRACT_CLAUSE", "JT_SUBGRADE_TENDER_FILE", "项目专用合同条款");
            /// <summary>
			/// 争议的最终解决方式
			/// </summary>
			public readonly static Field DISPUTE_RESOLUTION = new Field("DISPUTE_RESOLUTION", "JT_SUBGRADE_TENDER_FILE", "争议的最终解决方式");
            /// <summary>
			/// 仲裁委员会名称
			/// </summary>
			public readonly static Field ARBITRATION_COMMISSION = new Field("ARBITRATION_COMMISSION", "JT_SUBGRADE_TENDER_FILE", "仲裁委员会名称");
            /// <summary>
			/// 单据所列费用
			/// </summary>
			public readonly static Field DOCUMENT_CHARGES = new Field("DOCUMENT_CHARGES", "JT_SUBGRADE_TENDER_FILE", "单据所列费用");
            /// <summary>
			/// 进度付款证书最低限额
			/// </summary>
			public readonly static Field MINIMUM_LIMIT = new Field("MINIMUM_LIMIT", "JT_SUBGRADE_TENDER_FILE", "进度付款证书最低限额");
            /// <summary>
			/// 工程量清单
			/// </summary>
			public readonly static Field BILL_OF_QUANTITIES = new Field("BILL_OF_QUANTITIES", "JT_SUBGRADE_TENDER_FILE", "工程量清单");
            /// <summary>
			/// 图纸
			/// </summary>
			public readonly static Field DRAWING = new Field("DRAWING", "JT_SUBGRADE_TENDER_FILE", "图纸");
            /// <summary>
			/// 技术规范
			/// </summary>
			public readonly static Field TECHNOLOGY_STANDARD = new Field("TECHNOLOGY_STANDARD", "JT_SUBGRADE_TENDER_FILE", "技术规范");
            /// <summary>
			/// 补充技术规范
			/// </summary>
			public readonly static Field SUPPLY_TECHNICAL_STANDARD = new Field("SUPPLY_TECHNICAL_STANDARD", "JT_SUBGRADE_TENDER_FILE", "补充技术规范");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_SUBGRADE_TENDER_FILE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_SUBGRADE_TENDER_FILE", "公共服务平台标识码");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_SUBGRADE_TENDER_FILE", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_SUBGRADE_TENDER_FILE", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_SUBGRADE_TENDER_FILE", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_SUBGRADE_TENDER_FILE", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_SUBGRADE_TENDER_FILE", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_SUBGRADE_TENDER_FILE", "M_TM");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_SUBGRADE_TENDER_FILE", "数据时间戳");
            /// <summary>
			/// 项目起点位于
			/// </summary>
			public readonly static Field PROJECT_START = new Field("PROJECT_START", "JT_SUBGRADE_TENDER_FILE", "项目起点位于");
            /// <summary>
			/// 起点桩号
			/// </summary>
			public readonly static Field MILEAGE_START = new Field("MILEAGE_START", "JT_SUBGRADE_TENDER_FILE", "起点桩号");
            /// <summary>
			/// 项目终点位于
			/// </summary>
			public readonly static Field PROJECT_END = new Field("PROJECT_END", "JT_SUBGRADE_TENDER_FILE", "项目终点位于");
            /// <summary>
			/// 终点桩号
			/// </summary>
			public readonly static Field MILEAGE_END = new Field("MILEAGE_END", "JT_SUBGRADE_TENDER_FILE", "终点桩号");
            /// <summary>
			/// 全长（公里）
			/// </summary>
			public readonly static Field SPAN = new Field("SPAN", "JT_SUBGRADE_TENDER_FILE", "全长（公里）");
            /// <summary>
			/// 施工监理的合同段数量
			/// </summary>
			public readonly static Field CONTRACT_SECTION = new Field("CONTRACT_SECTION", "JT_SUBGRADE_TENDER_FILE", "施工监理的合同段数量");
            /// <summary>
			/// 施工监理的合同段内容
			/// </summary>
			public readonly static Field CONTRACT_NAME_OR_NUM = new Field("CONTRACT_NAME_OR_NUM", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "施工监理的合同段内容");
            /// <summary>
			/// 本次招标合同段名称
			/// </summary>
			public readonly static Field THIS_CONTRACT_SECTION = new Field("THIS_CONTRACT_SECTION", "JT_SUBGRADE_TENDER_FILE", "本次招标合同段名称");
            /// <summary>
			/// 监理服务期
			/// </summary>
			public readonly static Field PERIOD_SERVICE = new Field("PERIOD_SERVICE", "JT_SUBGRADE_TENDER_FILE", "监理服务期");
            /// <summary>
			/// 准备阶段
			/// </summary>
			public readonly static Field SEEDTIME = new Field("SEEDTIME", "JT_SUBGRADE_TENDER_FILE", "准备阶段");
            /// <summary>
			/// 施工阶段
			/// </summary>
			public readonly static Field CONSTRUCTION_TIME = new Field("CONSTRUCTION_TIME", "JT_SUBGRADE_TENDER_FILE", "施工阶段");
            /// <summary>
			/// 缺陷责任期阶段
			/// </summary>
			public readonly static Field DEFECT_LIABILITY_PERIOD = new Field("DEFECT_LIABILITY_PERIOD", "JT_SUBGRADE_TENDER_FILE", "缺陷责任期阶段");
            /// <summary>
			/// 建设单位的管理机构
			/// </summary>
			public readonly static Field CONST_MANAGEMENT = new Field("CONST_MANAGEMENT", "JT_SUBGRADE_TENDER_FILE", "建设单位的管理机构");
            /// <summary>
			/// 监督部门联系电话
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_PHONE = new Field("SUPERVISE_DEPT_PHONE", "JT_SUBGRADE_TENDER_FILE", "监督部门联系电话");
            /// <summary>
			/// 监督部门传真
			/// </summary>
			public readonly static Field SUPERVISE_DEPT_FAX = new Field("SUPERVISE_DEPT_FAX", "JT_SUBGRADE_TENDER_FILE", "监督部门传真");
            /// <summary>
			/// 项目说明
			/// </summary>
			public readonly static Field PROJECT_DESCRIPTION = new Field("PROJECT_DESCRIPTION", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "项目说明");
            /// <summary>
			/// 主要工程数量表
			/// </summary>
			public readonly static Field MAIN_ENGINEER_QUANTITY_LIST = new Field("MAIN_ENGINEER_QUANTITY_LIST", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "主要工程数量表");
            /// <summary>
			/// 地理位置示意图
			/// </summary>
			public readonly static Field SKETCH_MAP = new Field("SKETCH_MAP", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "地理位置示意图");
            /// <summary>
			/// 施工工期及监理服务时间
			/// </summary>
			public readonly static Field PERIOD_SERVICE_TIME = new Field("PERIOD_SERVICE_TIME", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "施工工期及监理服务时间");
            /// <summary>
			/// 总监理工程师最低限度资历要求
			/// </summary>
			public readonly static Field QUALIFICATION_REQUIRE = new Field("QUALIFICATION_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "总监理工程师最低限度资历要求");
            /// <summary>
			/// 交通工具最低要求
			/// </summary>
			public readonly static Field VEHICLE_REQUIRE = new Field("VEHICLE_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "交通工具最低要求");
            /// <summary>
			/// 立项审批情况
			/// </summary>
			public readonly static Field PROJECT_APPROVAL = new Field("PROJECT_APPROVAL", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "立项审批情况");
            /// <summary>
			/// 资金组成及到位情况
			/// </summary>
			public readonly static Field FULLY_FUNDED = new Field("FULLY_FUNDED", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "资金组成及到位情况");
            /// <summary>
			/// 监理合同段名称
			/// </summary>
			public readonly static Field BID_SECTION_NAME = new Field("BID_SECTION_NAME", "JT_SUBGRADE_TENDER_FILE", "监理合同段名称");
            /// <summary>
			/// 其他监理人员最低限度资历要求
			/// </summary>
			public readonly static Field SUPER_MIN_REQUIRE = new Field("SUPER_MIN_REQUIRE", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "其他监理人员最低限度资历要求");
            /// <summary>
			/// 监理规范
			/// </summary>
			public readonly static Field SUPERVISION_STANDARD = new Field("SUPERVISION_STANDARD", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "监理规范");
            /// <summary>
			/// 工程专用规范
			/// </summary>
			public readonly static Field ENGINEERING_SPECIFICATIONS = new Field("ENGINEERING_SPECIFICATIONS", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "工程专用规范");
            /// <summary>
			/// 技术规范
			/// </summary>
			public readonly static Field TECHNICAL_SPECIFICATIONS = new Field("TECHNICAL_SPECIFICATIONS", "JT_SUBGRADE_TENDER_FILE",DbType.AnsiString, null, "技术规范");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_SUBGRADE_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_SUBGRADE_TENDER_FILE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_SUBGRADE_TENDER_FILE", "");
        }
        #endregion
	}
}