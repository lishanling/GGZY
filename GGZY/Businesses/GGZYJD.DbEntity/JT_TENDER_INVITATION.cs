...
{
    /// <summary>
    /// 实体类JT_TENDER_INVITATION。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("JT_TENDER_INVITATION")]
    [Serializable]
    public partial class JT_TENDER_INVITATION : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "JT_TENDER_INVITATION");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "JT_TENDER_INVITATION", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "JT_TENDER_INVITATION", "统一交易标识码");
            /// <summary>
			/// 投标资格
			/// </summary>
			public readonly static Field BID_QUALIFICATION = new Field("BID_QUALIFICATION", "JT_TENDER_INVITATION",DbType.AnsiString, null, "投标资格");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "JT_TENDER_INVITATION", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "JT_TENDER_INVITATION", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_CODE = new Field("BIDDER_CODE", "JT_TENDER_INVITATION", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "JT_TENDER_INVITATION", "投标人角色");
            /// <summary>
			/// 招标文件/资格预审文件获取时间
			/// </summary>
			public readonly static Field TENDER_DOC_GET_TIME = new Field("TENDER_DOC_GET_TIME", "JT_TENDER_INVITATION", "招标文件/资格预审文件获取时间");
            /// <summary>
			/// 招标文件/资格预审文件获取方法
			/// </summary>
			public readonly static Field TENDER_DOC_GET_METHOD = new Field("TENDER_DOC_GET_METHOD", "JT_TENDER_INVITATION",DbType.AnsiString, null, "招标文件/资格预审文件获取方法");
            /// <summary>
			/// 投标文件/资审申请文件递交截止时间
			/// </summary>
			public readonly static Field BID_DOC_REFER_END_TIME = new Field("BID_DOC_REFER_END_TIME", "JT_TENDER_INVITATION", "投标文件/资审申请文件递交截止时间");
            /// <summary>
			/// 投标文件/资审申请文件递交方法
			/// </summary>
			public readonly static Field BID_DOC_REFER_METHOD = new Field("BID_DOC_REFER_METHOD", "JT_TENDER_INVITATION",DbType.AnsiString, null, "投标文件/资审申请文件递交方法");
            /// <summary>
			/// 回复截止时间
			/// </summary>
			public readonly static Field BID_INVITE_END_TIME = new Field("BID_INVITE_END_TIME", "JT_TENDER_INVITATION", "回复截止时间");
            /// <summary>
			/// 投标邀请发出时间
			/// </summary>
			public readonly static Field BID_INVITE_ISSUE_TIME = new Field("BID_INVITE_ISSUE_TIME", "JT_TENDER_INVITATION", "投标邀请发出时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "JT_TENDER_INVITATION", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "JT_TENDER_INVITATION", "公共服务平台标识码");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "JT_TENDER_INVITATION", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "JT_TENDER_INVITATION", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "JT_TENDER_INVITATION", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "JT_TENDER_INVITATION", "M_CREATEBY");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "JT_TENDER_INVITATION", "M_CREATE_TM");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "JT_TENDER_INVITATION", "M_TM");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "JT_TENDER_INVITATION", "数据时间戳");
            /// <summary>
			/// 投标邀请性质
			/// </summary>
			public readonly static Field BID_INVITE_ISSUE_NATURE = new Field("BID_INVITE_ISSUE_NATURE", "JT_TENDER_INVITATION", "投标邀请性质");
            /// <summary>
			/// 招标文件获取开始时间
			/// </summary>
			public readonly static Field DOC_GET_START_TIME = new Field("DOC_GET_START_TIME", "JT_TENDER_INVITATION", "招标文件获取开始时间");
            /// <summary>
			/// 招标文件获取截止时间
			/// </summary>
			public readonly static Field DOC_GET_END_TIME = new Field("DOC_GET_END_TIME", "JT_TENDER_INVITATION", "招标文件获取截止时间");
            /// <summary>
			/// 投标邀请发布责任人
			/// </summary>
			public readonly static Field BULLETIN_DUTY = new Field("BULLETIN_DUTY", "JT_TENDER_INVITATION", "投标邀请发布责任人");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "JT_TENDER_INVITATION", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "JT_TENDER_INVITATION", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "JT_TENDER_INVITATION", "");
        }
        #endregion
	}
}