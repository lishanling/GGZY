...
{
    /// <summary>
    /// 实体类ZJ_TENDER_FILE_CLARI_MODI。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("ZJ_TENDER_FILE_CLARI_MODI")]
    [Serializable]
    public partial class ZJ_TENDER_FILE_CLARI_MODI : JdEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "ZJ_TENDER_FILE_CLARI_MODI");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "ZJ_TENDER_FILE_CLARI_MODI", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "ZJ_TENDER_FILE_CLARI_MODI", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODES = new Field("UNIFIED_DEAL_CODES", "ZJ_TENDER_FILE_CLARI_MODI", "统一交易标识码");
            /// <summary>
			/// 文件编号
			/// </summary>
			public readonly static Field DOC_NO = new Field("DOC_NO", "ZJ_TENDER_FILE_CLARI_MODI", "文件编号");
            /// <summary>
			/// 投标资格
			/// </summary>
			public readonly static Field BID_QUALIFICATION = new Field("BID_QUALIFICATION", "ZJ_TENDER_FILE_CLARI_MODI",DbType.AnsiString, null, "投标资格");
            /// <summary>
			/// 投标文件递交截止时间
			/// </summary>
			public readonly static Field BID_DOC_REFER_END_TIME = new Field("BID_DOC_REFER_END_TIME", "ZJ_TENDER_FILE_CLARI_MODI", "投标文件递交截止时间");
            /// <summary>
			/// 投标有效期
			/// </summary>
			public readonly static Field VALID_PERIOD = new Field("VALID_PERIOD", "ZJ_TENDER_FILE_CLARI_MODI", "投标有效期");
            /// <summary>
			/// 投标文件递交方法
			/// </summary>
			public readonly static Field BID_DOC_REFER_METHOD = new Field("BID_DOC_REFER_METHOD", "ZJ_TENDER_FILE_CLARI_MODI",DbType.AnsiString, null, "投标文件递交方法");
            /// <summary>
			/// 投标保证金缴纳方式
			/// </summary>
			public readonly static Field MARGIN_PAY_TYPE = new Field("MARGIN_PAY_TYPE", "ZJ_TENDER_FILE_CLARI_MODI", "投标保证金缴纳方式");
            /// <summary>
			/// 投标保证金金额
			/// </summary>
			public readonly static Field MARGIN_AMOUNT = new Field("MARGIN_AMOUNT", "ZJ_TENDER_FILE_CLARI_MODI", "投标保证金金额");
            /// <summary>
			/// 投标保证金币种代码
			/// </summary>
			public readonly static Field MARGIN_CURRENCY = new Field("MARGIN_CURRENCY", "ZJ_TENDER_FILE_CLARI_MODI", "投标保证金币种代码");
            /// <summary>
			/// 投标保证金单位
			/// </summary>
			public readonly static Field MARGIN_AMOUNT_UNIT = new Field("MARGIN_AMOUNT_UNIT", "ZJ_TENDER_FILE_CLARI_MODI", "投标保证金单位");
            /// <summary>
			/// 控制价（最高限价）
			/// </summary>
			public readonly static Field CONTROL_PRICE = new Field("CONTROL_PRICE", "ZJ_TENDER_FILE_CLARI_MODI", "控制价（最高限价）");
            /// <summary>
			/// 控制价币种代码
			/// </summary>
			public readonly static Field CONTROL_PRICE_CURRENCY = new Field("CONTROL_PRICE_CURRENCY", "ZJ_TENDER_FILE_CLARI_MODI", "控制价币种代码");
            /// <summary>
			/// 控制价单位
			/// </summary>
			public readonly static Field CONTROL_PRICE_UNIT = new Field("CONTROL_PRICE_UNIT", "ZJ_TENDER_FILE_CLARI_MODI", "控制价单位");
            /// <summary>
			/// 评标办法
			/// </summary>
			public readonly static Field EVALUATING_METHOD = new Field("EVALUATING_METHOD", "ZJ_TENDER_FILE_CLARI_MODI",DbType.AnsiString, null, "评标办法");
            /// <summary>
			/// 开标时间
			/// </summary>
			public readonly static Field BID_OPEN_TIME = new Field("BID_OPEN_TIME", "ZJ_TENDER_FILE_CLARI_MODI", "开标时间");
            /// <summary>
			/// 开标地点
			/// </summary>
			public readonly static Field BID_OPEN_PLACE = new Field("BID_OPEN_PLACE", "ZJ_TENDER_FILE_CLARI_MODI", "开标地点");
            /// <summary>
			/// 开标方式
			/// </summary>
			public readonly static Field BID_OPEN_TYPE = new Field("BID_OPEN_TYPE", "ZJ_TENDER_FILE_CLARI_MODI",DbType.AnsiString, null, "开标方式");
            /// <summary>
			/// 资格审查方式
			/// </summary>
			public readonly static Field QUAL_TYPE = new Field("QUAL_TYPE", "ZJ_TENDER_FILE_CLARI_MODI", "资格审查方式");
            /// <summary>
			/// 答疑澄清时间
			/// </summary>
			public readonly static Field CLARIFY_TIME = new Field("CLARIFY_TIME", "ZJ_TENDER_FILE_CLARI_MODI", "答疑澄清时间");
            /// <summary>
			/// 是否延期
			/// </summary>
			public readonly static Field IS_POSTPONE = new Field("IS_POSTPONE", "ZJ_TENDER_FILE_CLARI_MODI", "是否延期");
            /// <summary>
			/// 延期后开标时间
			/// </summary>
			public readonly static Field POST_OPEN_TIME = new Field("POST_OPEN_TIME", "ZJ_TENDER_FILE_CLARI_MODI", "延期后开标时间");
            /// <summary>
			/// 延期后开标地点
			/// </summary>
			public readonly static Field POST_OPEN_ADDRESS = new Field("POST_OPEN_ADDRESS", "ZJ_TENDER_FILE_CLARI_MODI", "延期后开标地点");
            /// <summary>
			/// 对文件澄清与修改的主要内容
			/// </summary>
			public readonly static Field CLARIFY_CONTENT = new Field("CLARIFY_CONTENT", "ZJ_TENDER_FILE_CLARI_MODI",DbType.AnsiString, null, "对文件澄清与修改的主要内容");
            /// <summary>
			/// 递交时间
			/// </summary>
			public readonly static Field SUBMIT_TIME = new Field("SUBMIT_TIME", "ZJ_TENDER_FILE_CLARI_MODI", "递交时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "ZJ_TENDER_FILE_CLARI_MODI", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "ZJ_TENDER_FILE_CLARI_MODI", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "ZJ_TENDER_FILE_CLARI_MODI", "数据时间戳");
            /// <summary>
			/// 数据自增长ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "ZJ_TENDER_FILE_CLARI_MODI", "数据自增长ID");
            /// <summary>
			/// 数据DATA_KEY
			/// </summary>
			public readonly static Field DATA_KEY = new Field("DATA_KEY", "ZJ_TENDER_FILE_CLARI_MODI", "数据DATA_KEY");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "ZJ_TENDER_FILE_CLARI_MODI", "数据来源");
            /// <summary>
			/// M_CREATEBY
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "ZJ_TENDER_FILE_CLARI_MODI", "M_CREATEBY");
            /// <summary>
			/// M_TM
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "ZJ_TENDER_FILE_CLARI_MODI", "M_TM");
            /// <summary>
			/// M_CREATE_TM
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "ZJ_TENDER_FILE_CLARI_MODI", "M_CREATE_TM");
            /// <summary>
			/// 文件名称
			/// </summary>
			public readonly static Field DOC_NAME = new Field("DOC_NAME", "ZJ_TENDER_FILE_CLARI_MODI", "文件名称");
            /// <summary>
			/// 文件源URL
			/// </summary>
			public readonly static Field URL = new Field("URL", "ZJ_TENDER_FILE_CLARI_MODI", "文件源URL");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "ZJ_TENDER_FILE_CLARI_MODI", "价款形式代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "ZJ_TENDER_FILE_CLARI_MODI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "ZJ_TENDER_FILE_CLARI_MODI", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "ZJ_TENDER_FILE_CLARI_MODI", "");
            /// <summary>
			/// 范本编号
			/// </summary>
			public readonly static Field TEMPLATE_NO = new Field("TEMPLATE_NO", "ZJ_TENDER_FILE_CLARI_MODI", "范本编号");
        }
        #endregion
	}
}