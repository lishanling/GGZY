...
namespace GGZY.Services.FuWu
{
       	...
       	protected WhereClipBuilder ConditionBuilder(BLACK_LIST model)
	{
		WhereClipBuilder condition = new WhereClipBuilder();
				...
				{
				  condition.And(BLACK_LIST._.M_IS_HISTORY==(model.M_IS_HISTORY));
				}
				if(model.M_CREATEBY!=null)
				{
				  condition.And(BLACK_LIST._.M_CREATEBY==(model.M_CREATEBY));
				}
				if(model.M_CREATE_TM!=null)
				{
				  condition.And(BLACK_LIST._.M_CREATE_TM==(model.M_CREATE_TM));
				}
				if(!string.IsNullOrWhiteSpace(model.M_VERSION))
				{
				  condition.And(BLACK_LIST._.M_VERSION.Contain(model.M_VERSION));
				}
		return condition;
	}
        #endregion
