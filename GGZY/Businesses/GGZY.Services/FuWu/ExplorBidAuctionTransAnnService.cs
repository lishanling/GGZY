...
{
    public partial class ExplorBidAuctionTransAnnService 
    {
        /// <summary>
        ...
        /// <returns></returns>
        public object JD_KYQ_ExplorBidAuctionTransAnn(string projectCode)
        {
            var obj = FromSql(
                    @"SELECT A.NA_APP_NAME,A.INVEST_PROJECT_CODE,URL,IN_BUY_KIND,B.TEXT AS IN_BUY_KIND_TEXT,IN_MINE_COME,C.TEXT AS IN_MINE_COME_TEXT
