...
{
    public partial class MiningBidAucTransResAnnService 
    {
        /// <summary>
        /// 监督平台门户 项目监督信息 土地使用权  结果公示  采矿矿权交易结果公示
        /// </summary>
        /// <param name="projectCode"></param>
        /// <returns></returns>
        public object JD_KYQ_MiningBidAuctionTransResAnn(string projectCode)
        {
            var obj = FromSql(
                    @"SELECT A.NA_APP_NAME,A.URL,A.IN_BUY_KIND,B.TEXT AS IN_BUY_KIND_TEXT,QT_PLAN_YEARS,QT_TOTAL_AREA,NA_GEOGRAPHY_POSITION
                            ...
                            FROM MINING_BID_AUC_TRANS_RES_ANN A
