...
namespace GGZY.Services.Infrastructure.Model.JianDu
{
    ...
    /// </summary>
    [Serializable]
    public partial class TSupervisePointResultModel
    {
        #region Model
        ...
        /// 招标编号
        /// </summary>
        [Display(Name = "招标编号", Order = 50)]
        public string ENTITY_TENDER_PROJECT_CODE { get; set; }
        /// <summary>
        /// 监督点触发日期
        /// </summary>
        [Display(Name = "监督点触发日期", Order = 60)]
        ...
        /// 监督点名称（触发监督点）
        /// </summary>
        [Display(Name = "触发监督点", Order = 80)]
        public string SPNAME { get; set; }
        /// <summary>
        /// 招标项目名称
        /// </summary>
        [Display(Name = "招标项目名称", Order = 90)]
