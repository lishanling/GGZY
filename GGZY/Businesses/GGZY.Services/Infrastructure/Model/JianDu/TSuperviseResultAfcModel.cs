...
namespace GGZY.Services.Infrastructure.Model.JianDu
{
    ...
    /// </summary>
    [Serializable]
    public partial class TSuperviseResultAfcModel
    {
        ...
        /// 监察名称
        /// </summary>
        [Display(Name = "监察点", Order = 10)]
        public string SUPERVISE_NAME { get; set; }
        /// <summary>
        /// 监察类型
        /// </summary>
        [Display(Name = "监察点类型", Order = 20)]
        public string SUPERVISE_TYPE { get; set; }
        /// <summary>
        /// 监察方式
        /// </summary>
        [Display(Name = "监察方式", Order = 30)]
        ...
        /// 实体记录招标项目编号
        /// </summary>
        [Display(Name = "招标计划编号", Order = 40)]
        public string ENTITY_TENDER_PROJECT_CODE { get; set; }
        /// <summary>
        /// 实体记录招标项目名称
        /// </summary>
        [Display(Name = "招标计划名称", Order = 50)]
