...
{
    public partial class TTPunishRecordModel
    {
        ...
        public string PUNISH_TIME_FORMAT => string.IsNullOrEmpty(PUNISH_TIME) ? "" : Convert.ToDateTime(PUNISH_TIME).ToString("yyyy-MM-dd HH:mm:ss");
        /// <summary>
        /// 处罚部门名称(组织机构)
        /// </summary>
