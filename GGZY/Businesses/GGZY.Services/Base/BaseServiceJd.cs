...
{
    public class BaseServiceJd<TModel> :BaseService where TModel:Entity
    {
        ...
        public virtual int Update(TModel entity,DbTrans tran = null)
        {
            if(tran !=null){
                return tran.Update(entity);
            }
        ...
        {
            return FirstOrNull(condition.ToWhereClip());
        }
