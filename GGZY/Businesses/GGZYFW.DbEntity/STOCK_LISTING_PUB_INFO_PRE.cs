...
{
    /// <summary>
    /// 实体类STOCK_LISTING_PUB_INFO_PRE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("STOCK_LISTING_PUB_INFO_PRE")]
    [Serializable]
    public partial class STOCK_LISTING_PUB_INFO_PRE : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "STOCK_LISTING_PUB_INFO_PRE");
            /// <summary>
			/// 项目名称
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "STOCK_LISTING_PUB_INFO_PRE", "项目名称");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "STOCK_LISTING_PUB_INFO_PRE", "项目编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "STOCK_LISTING_PUB_INFO_PRE", "统一交易标识码");
            /// <summary>
			/// 项目分类代码
			/// </summary>
			public readonly static Field PROJECT_CLASSIFY_CODE = new Field("PROJECT_CLASSIFY_CODE", "STOCK_LISTING_PUB_INFO_PRE", "项目分类代码");
            /// <summary>
			/// 转让方名称
			/// </summary>
			public readonly static Field SELLER_NAME = new Field("SELLER_NAME", "STOCK_LISTING_PUB_INFO_PRE", "转让方名称");
            /// <summary>
			/// 转让方类别
			/// </summary>
			public readonly static Field SELLER_TYPE = new Field("SELLER_TYPE", "STOCK_LISTING_PUB_INFO_PRE", "转让方类别");
            /// <summary>
			/// 转让方代码
			/// </summary>
			public readonly static Field SELLER_CODE = new Field("SELLER_CODE", "STOCK_LISTING_PUB_INFO_PRE", "转让方代码");
            /// <summary>
			/// 转让方角色
			/// </summary>
			public readonly static Field SELLER_ROLE = new Field("SELLER_ROLE", "STOCK_LISTING_PUB_INFO_PRE", "转让方角色");
            /// <summary>
			/// 转让行为批准单位
			/// </summary>
			public readonly static Field AUTHORIZE_UNIT = new Field("AUTHORIZE_UNIT", "STOCK_LISTING_PUB_INFO_PRE", "转让行为批准单位");
            /// <summary>
			/// 转让比例
			/// </summary>
			public readonly static Field TOTAL_PERCENT = new Field("TOTAL_PERCENT", "STOCK_LISTING_PUB_INFO_PRE", "转让比例");
            /// <summary>
			/// 挂牌价格
			/// </summary>
			public readonly static Field PROJECT_PRICE = new Field("PROJECT_PRICE", "STOCK_LISTING_PUB_INFO_PRE", "挂牌价格");
            /// <summary>
			/// 挂牌期间
			/// </summary>
			public readonly static Field PUBLISH_DURATION = new Field("PUBLISH_DURATION", "STOCK_LISTING_PUB_INFO_PRE", "挂牌期间");
            /// <summary>
			/// 挂牌日期
			/// </summary>
			public readonly static Field PUBLISH_DATE = new Field("PUBLISH_DATE", "STOCK_LISTING_PUB_INFO_PRE", "挂牌日期");
            /// <summary>
			/// 是否自动延期
			/// </summary>
			public readonly static Field POST_PONE = new Field("POST_PONE", "STOCK_LISTING_PUB_INFO_PRE", "是否自动延期");
            /// <summary>
			/// 选择的竞价交易方式
			/// </summary>
			public readonly static Field PRE_EXCHANGE_TYPE = new Field("PRE_EXCHANGE_TYPE", "STOCK_LISTING_PUB_INFO_PRE", "选择的竞价交易方式");
            /// <summary>
			/// 管理层是否有收购意向
			/// </summary>
			public readonly static Field MANAGEMENT_INTENT = new Field("MANAGEMENT_INTENT", "STOCK_LISTING_PUB_INFO_PRE", "管理层是否有收购意向");
            /// <summary>
			/// 标的企业原股东是否放弃行使优先购买权
			/// </summary>
			public readonly static Field GIVEUP_PRIORITY = new Field("GIVEUP_PRIORITY", "STOCK_LISTING_PUB_INFO_PRE", "标的企业原股东是否放弃行使优先购买权");
            /// <summary>
			/// 重要信息披露
			/// </summary>
			public readonly static Field IMPORTANT_INFO = new Field("IMPORTANT_INFO", "STOCK_LISTING_PUB_INFO_PRE",DbType.AnsiString, null, "重要信息披露");
            /// <summary>
			/// 受让方资格条件
			/// </summary>
			public readonly static Field BUYER_POSTULATE = new Field("BUYER_POSTULATE", "STOCK_LISTING_PUB_INFO_PRE",DbType.AnsiString, null, "受让方资格条件");
            /// <summary>
			/// 与转让相关的其他条件
			/// </summary>
			public readonly static Field OTHER_CONDITIONS = new Field("OTHER_CONDITIONS", "STOCK_LISTING_PUB_INFO_PRE",DbType.AnsiString, null, "与转让相关的其他条件");
            /// <summary>
			/// 在交易机构网站进行挂牌信息披露的链接
			/// </summary>
			public readonly static Field PROJECT_URL = new Field("PROJECT_URL", "STOCK_LISTING_PUB_INFO_PRE",DbType.AnsiString, null, "在交易机构网站进行挂牌信息披露的链接");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "STOCK_LISTING_PUB_INFO_PRE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "STOCK_LISTING_PUB_INFO_PRE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "STOCK_LISTING_PUB_INFO_PRE", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 价格币种代码
			/// </summary>
			public readonly static Field CURRENCY_CODE = new Field("CURRENCY_CODE", "STOCK_LISTING_PUB_INFO_PRE", "价格币种代码");
            /// <summary>
			/// 价格单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "STOCK_LISTING_PUB_INFO_PRE", "价格单位");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "STOCK_LISTING_PUB_INFO_PRE", "");
            /// <summary>
			/// 获批日期
			/// </summary>
			public readonly static Field M_GET_TM = new Field("M_GET_TM", "STOCK_LISTING_PUB_INFO_PRE", "获批日期");
            /// <summary>
			/// 产权转让行为的决策及批准情况
			/// </summary>
			public readonly static Field M_TRANSFER_RESULT = new Field("M_TRANSFER_RESULT", "STOCK_LISTING_PUB_INFO_PRE", "产权转让行为的决策及批准情况");
            /// <summary>
			/// 转让标的所在地区
			/// </summary>
			public readonly static Field M_ZONE = new Field("M_ZONE", "STOCK_LISTING_PUB_INFO_PRE", "转让标的所在地区");
        }
        #endregion
	}
}