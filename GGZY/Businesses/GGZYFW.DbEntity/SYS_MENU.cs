...
namespace GGZYFW.DbEntity
{
    ...
    [Table("SYS_MENU")]
    [Serializable]
    public partial class SYS_MENU : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 
			/// </summary>
			public readonly static Field MENUID = new Field("MENUID", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			...
			/// 
			/// </summary>
			public readonly static Field MNAME = new Field("MNAME", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ORDERID = new Field("ORDERID", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field NAVIGATEURI = new Field("NAVIGATEURI", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field COMMANDPATH = new Field("COMMANDPATH", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field COMMANDCLASS = new Field("COMMANDCLASS", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IMAGEPATH = new Field("IMAGEPATH", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ISDEFAULT = new Field("ISDEFAULT", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ISEANBLED = new Field("ISEANBLED", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ISURL = new Field("ISURL", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ARGS = new Field("ARGS", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ISDISPLAY = new Field("ISDISPLAY", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field OPTYPES = new Field("OPTYPES", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field NHEIGHT = new Field("NHEIGHT", "SYS_MENU", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field NWIDTH = new Field("NWIDTH", "SYS_MENU", "");
        }
        #endregion
	}
}