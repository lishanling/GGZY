...
{
    /// <summary>
    /// 实体类T_EC2_TENDERAGENCYINFO。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("T_EC2_TENDERAGENCYINFO")]
    [Serializable]
    public partial class T_EC2_TENDERAGENCYINFO : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "T_EC2_TENDERAGENCYINFO");
            /// <summary>
			/// 招标代理机构代码类型
			/// </summary>
			public readonly static Field TENDERAGENCYCODETYPE = new Field("TENDERAGENCYCODETYPE", "T_EC2_TENDERAGENCYINFO", "招标代理机构代码类型");
            /// <summary>
			/// 招标代理机构代码
			/// </summary>
			public readonly static Field TENDERAGENCYCODE = new Field("TENDERAGENCYCODE", "T_EC2_TENDERAGENCYINFO", "招标代理机构代码");
            /// <summary>
			/// 招标代理机构名称
			/// </summary>
			public readonly static Field TENDERAGENCYNAME = new Field("TENDERAGENCYNAME", "T_EC2_TENDERAGENCYINFO", "招标代理机构名称");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDERPROJECTCODE = new Field("TENDERPROJECTCODE", "T_EC2_TENDERAGENCYINFO", "招标项目编号");
            /// <summary>
			/// 法人代表/负责人姓名
			/// </summary>
			public readonly static Field ARTIFICIALPERSON = new Field("ARTIFICIALPERSON", "T_EC2_TENDERAGENCYINFO", "法人代表/负责人姓名");
            /// <summary>
			/// 法人代表/负责人证件类型
			/// </summary>
			public readonly static Field ARTIFICIALPERSONCODETYPE = new Field("ARTIFICIALPERSONCODETYPE", "T_EC2_TENDERAGENCYINFO", "法人代表/负责人证件类型");
            /// <summary>
			/// 法人代表/负责人身份证件号
			/// </summary>
			public readonly static Field ARTIFICIALPERSONCODE = new Field("ARTIFICIALPERSONCODE", "T_EC2_TENDERAGENCYINFO", "法人代表/负责人身份证件号");
            /// <summary>
			/// 机构联系电话
			/// </summary>
			public readonly static Field CONTACTNUMBER = new Field("CONTACTNUMBER", "T_EC2_TENDERAGENCYINFO", "机构联系电话");
            /// <summary>
			/// 国别/地区
			/// </summary>
			public readonly static Field COUNTRYREGION = new Field("COUNTRYREGION", "T_EC2_TENDERAGENCYINFO", "国别/地区");
            /// <summary>
			/// 单位性质
			/// </summary>
			public readonly static Field UNITNATURE = new Field("UNITNATURE", "T_EC2_TENDERAGENCYINFO", "单位性质");
            /// <summary>
			/// 行政区域代码
			/// </summary>
			public readonly static Field REGIONCODE = new Field("REGIONCODE", "T_EC2_TENDERAGENCYINFO", "行政区域代码");
            /// <summary>
			/// 行业代码
			/// </summary>
			public readonly static Field INDUSTRYCODE = new Field("INDUSTRYCODE", "T_EC2_TENDERAGENCYINFO", "行业代码");
            /// <summary>
			/// 营业执照号码
			/// </summary>
			public readonly static Field LICNUMBER = new Field("LICNUMBER", "T_EC2_TENDERAGENCYINFO", "营业执照号码");
            /// <summary>
			/// CA证书编号
			/// </summary>
			public readonly static Field CACODE = new Field("CACODE", "T_EC2_TENDERAGENCYINFO", "CA证书编号");
            /// <summary>
			/// 税务登记号
			/// </summary>
			public readonly static Field TAXNUMBER = new Field("TAXNUMBER", "T_EC2_TENDERAGENCYINFO", "税务登记号");
            /// <summary>
			/// 资信等级
			/// </summary>
			public readonly static Field CREDITRATE = new Field("CREDITRATE", "T_EC2_TENDERAGENCYINFO", "资信等级");
            /// <summary>
			/// 开户银行
			/// </summary>
			public readonly static Field OPENINGBANK = new Field("OPENINGBANK", "T_EC2_TENDERAGENCYINFO", "开户银行");
            /// <summary>
			/// 基本账户账号
			/// </summary>
			public readonly static Field BASICACCOUNT = new Field("BASICACCOUNT", "T_EC2_TENDERAGENCYINFO", "基本账户账号");
            /// <summary>
			/// 注册资本
			/// </summary>
			public readonly static Field REGCAPITAL = new Field("REGCAPITAL", "T_EC2_TENDERAGENCYINFO", "注册资本");
            /// <summary>
			/// 注册资本币种
			/// </summary>
			public readonly static Field REGCAPCURRENCY = new Field("REGCAPCURRENCY", "T_EC2_TENDERAGENCYINFO", "注册资本币种");
            /// <summary>
			/// 注册资本单位
			/// </summary>
			public readonly static Field REGUNIT = new Field("REGUNIT", "T_EC2_TENDERAGENCYINFO", "注册资本单位");
            /// <summary>
			/// 信息申报责任人姓名
			/// </summary>
			public readonly static Field INFOREPORTERNAME = new Field("INFOREPORTERNAME", "T_EC2_TENDERAGENCYINFO", "信息申报责任人姓名");
            /// <summary>
			/// 信息申报责任人证件类型
			/// </summary>
			public readonly static Field INFOREPORTERCODETYPE = new Field("INFOREPORTERCODETYPE", "T_EC2_TENDERAGENCYINFO", "信息申报责任人证件类型");
            /// <summary>
			/// 信息申报责任人证件号码
			/// </summary>
			public readonly static Field INFOREPORTERCODE = new Field("INFOREPORTERCODE", "T_EC2_TENDERAGENCYINFO", "信息申报责任人证件号码");
            /// <summary>
			/// 信息申报责任人联系电话
			/// </summary>
			public readonly static Field INFOREPORTERCONTACTNUMBER = new Field("INFOREPORTERCONTACTNUMBER", "T_EC2_TENDERAGENCYINFO", "信息申报责任人联系电话");
            /// <summary>
			/// 联系地址
			/// </summary>
			public readonly static Field CONTACTADDRESS = new Field("CONTACTADDRESS", "T_EC2_TENDERAGENCYINFO", "联系地址");
            /// <summary>
			/// 邮政编码
			/// </summary>
			public readonly static Field ZIPCODE = new Field("ZIPCODE", "T_EC2_TENDERAGENCYINFO", "邮政编码");
            /// <summary>
			/// 电子邮箱
			/// </summary>
			public readonly static Field EMAIL = new Field("EMAIL", "T_EC2_TENDERAGENCYINFO", "电子邮箱");
            /// <summary>
			/// 主体类型
			/// </summary>
			public readonly static Field PARTICIPANTTYPE = new Field("PARTICIPANTTYPE", "T_EC2_TENDERAGENCYINFO", "主体类型");
            /// <summary>
			/// 交易平台验证人员
			/// </summary>
			public readonly static Field PLATFVERIFIER = new Field("PLATFVERIFIER", "T_EC2_TENDERAGENCYINFO", "交易平台验证人员");
            /// <summary>
			/// 交易平台验证时间
			/// </summary>
			public readonly static Field PLATFVERIFIERTIME = new Field("PLATFVERIFIERTIME", "T_EC2_TENDERAGENCYINFO", "交易平台验证时间");
            /// <summary>
			/// 交易平台数据验证时间
			/// </summary>
			public readonly static Field VERIFYTIME = new Field("VERIFYTIME", "T_EC2_TENDERAGENCYINFO", "交易平台数据验证时间");
            /// <summary>
			/// 交易平台标识码
			/// </summary>
			public readonly static Field PLATFORMCODE = new Field("PLATFORMCODE", "T_EC2_TENDERAGENCYINFO", "交易平台标识码");
            /// <summary>
			/// 交易平台名称
			/// </summary>
			public readonly static Field PLATFORMNAME = new Field("PLATFORMNAME", "T_EC2_TENDERAGENCYINFO", "交易平台名称");
            /// <summary>
			/// 交易平台数据验证责任人姓名
			/// </summary>
			public readonly static Field EXAMINERNAME = new Field("EXAMINERNAME", "T_EC2_TENDERAGENCYINFO", "交易平台数据验证责任人姓名");
            /// <summary>
			/// 交易平台数据验证责任人证件类型
			/// </summary>
			public readonly static Field EXAMINERCODETYPE = new Field("EXAMINERCODETYPE", "T_EC2_TENDERAGENCYINFO", "交易平台数据验证责任人证件类型");
            /// <summary>
			/// 交易平台数据验证责任人证件号码
			/// </summary>
			public readonly static Field EXAMINERCODE = new Field("EXAMINERCODE", "T_EC2_TENDERAGENCYINFO", "交易平台数据验证责任人证件号码");
            /// <summary>
			/// 组织机构证书附件
			/// </summary>
			public readonly static Field ORGANIZATIONATTACHMENTCODE = new Field("ORGANIZATIONATTACHMENTCODE", "T_EC2_TENDERAGENCYINFO",DbType.AnsiString, null, "组织机构证书附件");
            /// <summary>
			/// 营业执照附件
			/// </summary>
			public readonly static Field LICATTACHMENTCODE = new Field("LICATTACHMENTCODE", "T_EC2_TENDERAGENCYINFO",DbType.AnsiString, null, "营业执照附件");
            /// <summary>
			/// 税务登记附件
			/// </summary>
			public readonly static Field TAXATTACHMENTCODE = new Field("TAXATTACHMENTCODE", "T_EC2_TENDERAGENCYINFO",DbType.AnsiString, null, "税务登记附件");
            /// <summary>
			/// 版本号
			/// </summary>
			public readonly static Field VERSION = new Field("VERSION", "T_EC2_TENDERAGENCYINFO", "版本号");
            /// <summary>
			/// 数据源
			/// </summary>
			public readonly static Field DATA_SOURCE = new Field("DATA_SOURCE", "T_EC2_TENDERAGENCYINFO", "数据源");
            /// <summary>
			/// 数据时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "T_EC2_TENDERAGENCYINFO", "数据时间");
        }
        #endregion
	}
}