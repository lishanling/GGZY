...
namespace GGZYFW.DbEntity
{
    ...
    /// </summary>
    [Table("LEGAL_PERSON_BASE")]
    [Serializable]
    public partial class LEGAL_PERSON_BASE : FwEntity
    {
        #region Model
		...
		public string M_ATT_LICENSE_CERT_DOC
		{
			...
			set
			{
				this.OnPropertyValueChange(_.M_ATT_LICENSE_CERT_DOC, _M_ATT_LICENSE_CERT_DOC, value);
		...
		public string M_ATT_ORGAN_CERT_DOC
		{
			...
			set
			{
				this.OnPropertyValueChange(_.M_ATT_ORGAN_CERT_DOC, _M_ATT_ORGAN_CERT_DOC, value);
		...
		public string M_ATT_TAX_CERT_DOC
		{
			...
			set
			{
				this.OnPropertyValueChange(_.M_ATT_TAX_CERT_DOC, _M_ATT_TAX_CERT_DOC, value);
		...
		public string M_ATT_BASE_ACCOUNT_DOC
		{
			...
			set
			{
				this.OnPropertyValueChange(_.M_ATT_BASE_ACCOUNT_DOC, _M_ATT_BASE_ACCOUNT_DOC, value);
        ...
        public override Field[] GetFields()
        {
            return new Field[] {
				...
				_.M_ID,
				_.M_USER_ID,
				_.M_ATT_LICENSE_CERT_DOC,
				_.M_ATT_ORGAN_CERT_DOC,
				_.M_ATT_TAX_CERT_DOC,
				_.M_ATT_BASE_ACCOUNT_DOC,
        ...
        public override object[] GetValues()
        {
            return new object[] {
				...
				this._M_ID,
				this._M_USER_ID,
				this._M_ATT_LICENSE_CERT_DOC,
				this._M_ATT_ORGAN_CERT_DOC,
				this._M_ATT_TAX_CERT_DOC,
				this._M_ATT_BASE_ACCOUNT_DOC,
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "LEGAL_PERSON_BASE");
            /// <summary>
			/// 法人名称
			/// </summary>
			public readonly static Field LEGAL_NAME = new Field("LEGAL_NAME", "LEGAL_PERSON_BASE", "法人名称");
            /// <summary>
			/// 法人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "LEGAL_PERSON_BASE", "法人类别");
            /// <summary>
			/// 法人代码
			/// </summary>
			public readonly static Field LEGAL_CODE = new Field("LEGAL_CODE", "LEGAL_PERSON_BASE", "法人代码");
            /// <summary>
			/// 法人角色
			/// </summary>
			public readonly static Field LEGAL_ROLE = new Field("LEGAL_ROLE", "LEGAL_PERSON_BASE", "法人角色");
            /// <summary>
			/// 营业执照号码
			/// </summary>
			public readonly static Field LICENSE_NO = new Field("LICENSE_NO", "LEGAL_PERSON_BASE", "营业执照号码");
            /// <summary>
			/// 营业执照失效日期
			/// </summary>
			public readonly static Field LICENSE_END_DATE = new Field("LICENSE_END_DATE", "LEGAL_PERSON_BASE", "营业执照失效日期");
            /// <summary>
			/// 国税税务登记证证号
			/// </summary>
			public readonly static Field TAX_CERT_NO = new Field("TAX_CERT_NO", "LEGAL_PERSON_BASE", "国税税务登记证证号");
            /// <summary>
			/// 国税税务登记证失效日期
			/// </summary>
			public readonly static Field TAX_CERT_END_DATE = new Field("TAX_CERT_END_DATE", "LEGAL_PERSON_BASE", "国税税务登记证失效日期");
            /// <summary>
			/// 地税税务登记证证号
			/// </summary>
			public readonly static Field LOCAL_TAX_CERT_NO = new Field("LOCAL_TAX_CERT_NO", "LEGAL_PERSON_BASE", "地税税务登记证证号");
            /// <summary>
			/// 地税税务登记证失效日期
			/// </summary>
			public readonly static Field LOCAL_TAX_CERT_END_DATE = new Field("LOCAL_TAX_CERT_END_DATE", "LEGAL_PERSON_BASE", "地税税务登记证失效日期");
            /// <summary>
			/// 组织机构代码
			/// </summary>
			public readonly static Field ORGAN_NO = new Field("ORGAN_NO", "LEGAL_PERSON_BASE", "组织机构代码");
            /// <summary>
			/// 组织机构代码证失效日期
			/// </summary>
			public readonly static Field ORGAN_CERT_END_DATE = new Field("ORGAN_CERT_END_DATE", "LEGAL_PERSON_BASE", "组织机构代码证失效日期");
            /// <summary>
			/// 法定代表人姓名
			/// </summary>
			public readonly static Field LEGAL_REPRESENT = new Field("LEGAL_REPRESENT", "LEGAL_PERSON_BASE", "法定代表人姓名");
            /// <summary>
			/// 法人机构类别
			/// </summary>
			public readonly static Field LEGAL_TYPE = new Field("LEGAL_TYPE", "LEGAL_PERSON_BASE", "法人机构类别");
            /// <summary>
			/// 法人代表联系电话
			/// </summary>
			public readonly static Field REPRESENT_PHONE = new Field("REPRESENT_PHONE", "LEGAL_PERSON_BASE", "法人代表联系电话");
            /// <summary>
			/// 法人机构行业代码
			/// </summary>
			public readonly static Field LEGAL_INDUSTRY = new Field("LEGAL_INDUSTRY", "LEGAL_PERSON_BASE", "法人机构行业代码");
            /// <summary>
			/// 资信等级
			/// </summary>
			public readonly static Field CREDIT_RATE = new Field("CREDIT_RATE", "LEGAL_PERSON_BASE", "资信等级");
            /// <summary>
			/// 国别/地区
			/// </summary>
			public readonly static Field COUNTRY_REGION = new Field("COUNTRY_REGION", "LEGAL_PERSON_BASE", "国别/地区");
            /// <summary>
			/// 法人机构地址
			/// </summary>
			public readonly static Field LEGAL_UNIT_ADDRESS = new Field("LEGAL_UNIT_ADDRESS", "LEGAL_PERSON_BASE", "法人机构地址");
            /// <summary>
			/// 行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "LEGAL_PERSON_BASE", "行政区域代码");
            /// <summary>
			/// 注册地-省
			/// </summary>
			public readonly static Field REGISTER_PROVINCE = new Field("REGISTER_PROVINCE", "LEGAL_PERSON_BASE", "注册地-省");
            /// <summary>
			/// 注册地-市
			/// </summary>
			public readonly static Field REGISTER_CITY = new Field("REGISTER_CITY", "LEGAL_PERSON_BASE", "注册地-市");
            /// <summary>
			/// 基本户开户银行
			/// </summary>
			public readonly static Field BASIC_BANK = new Field("BASIC_BANK", "LEGAL_PERSON_BASE", "基本户开户银行");
            /// <summary>
			/// 基本户开户支行号
			/// </summary>
			public readonly static Field BASIC_BRANCH_BANK = new Field("BASIC_BRANCH_BANK", "LEGAL_PERSON_BASE", "基本户开户支行号");
            /// <summary>
			/// 基本户账号
			/// </summary>
			public readonly static Field BASIC_ACCOUNT_NO = new Field("BASIC_ACCOUNT_NO", "LEGAL_PERSON_BASE", "基本户账号");
            /// <summary>
			/// 基本户账户名称
			/// </summary>
			public readonly static Field BASIC_ACCOUNT_NAME = new Field("BASIC_ACCOUNT_NAME", "LEGAL_PERSON_BASE", "基本户账户名称");
            /// <summary>
			/// 注册资本
			/// </summary>
			public readonly static Field REG_CAPITAL = new Field("REG_CAPITAL", "LEGAL_PERSON_BASE", "注册资本");
            /// <summary>
			/// 注册资本币种
			/// </summary>
			public readonly static Field REG_CAP_CURRENCY = new Field("REG_CAP_CURRENCY", "LEGAL_PERSON_BASE", "注册资本币种");
            /// <summary>
			/// 注册资本单位
			/// </summary>
			public readonly static Field REG_UNIT = new Field("REG_UNIT", "LEGAL_PERSON_BASE", "注册资本单位");
            /// <summary>
			/// 联系人
			/// </summary>
			public readonly static Field LEGAL_CONTACT = new Field("LEGAL_CONTACT", "LEGAL_PERSON_BASE", "联系人");
            /// <summary>
			/// 联系人电话
			/// </summary>
			public readonly static Field LEGAL_CONTACT_PHONE = new Field("LEGAL_CONTACT_PHONE", "LEGAL_PERSON_BASE", "联系人电话");
            /// <summary>
			/// 联系人地址
			/// </summary>
			public readonly static Field LEGAL_CONTACT_ADDRESS = new Field("LEGAL_CONTACT_ADDRESS", "LEGAL_PERSON_BASE", "联系人地址");
            /// <summary>
			/// 单位网站
			/// </summary>
			public readonly static Field LEGAL_WEB = new Field("LEGAL_WEB", "LEGAL_PERSON_BASE", "单位网站");
            /// <summary>
			/// 邮政编码
			/// </summary>
			public readonly static Field LEGAL_ZIP_CODE = new Field("LEGAL_ZIP_CODE", "LEGAL_PERSON_BASE", "邮政编码");
            /// <summary>
			/// 电子邮箱
			/// </summary>
			public readonly static Field LEGAL_EMAIL = new Field("LEGAL_EMAIL", "LEGAL_PERSON_BASE", "电子邮箱");
            /// <summary>
			/// 法人业务状态
			/// </summary>
			public readonly static Field LEGAL_STATUS = new Field("LEGAL_STATUS", "LEGAL_PERSON_BASE", "法人业务状态");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "LEGAL_PERSON_BASE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "LEGAL_PERSON_BASE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "LEGAL_PERSON_BASE", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 主键ID 自增
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "LEGAL_PERSON_BASE", "主键ID 自增");
            /// <summary>
			/// 用户关联ID
			/// </summary>
			public readonly static Field M_USER_ID = new Field("M_USER_ID", "LEGAL_PERSON_BASE", "用户关联ID");
            /// <summary>
			/// 营业执照副本扫描件
			/// </summary>
			public readonly static Field M_ATT_LICENSE_CERT_DOC = new Field("M_ATT_LICENSE_CERT_DOC", "LEGAL_PERSON_BASE", "营业执照副本扫描件");
            /// <summary>
			/// 组织机构代码证扫描件
			/// </summary>
			public readonly static Field M_ATT_ORGAN_CERT_DOC = new Field("M_ATT_ORGAN_CERT_DOC", "LEGAL_PERSON_BASE", "组织机构代码证扫描件");
            /// <summary>
			/// 税务登记证（国税和地税）扫描件
			/// </summary>
			public readonly static Field M_ATT_TAX_CERT_DOC = new Field("M_ATT_TAX_CERT_DOC", "LEGAL_PERSON_BASE", "税务登记证（国税和地税）扫描件");
            /// <summary>
			/// 基本户开户许可证扫描件
			/// </summary>
			public readonly static Field M_ATT_BASE_ACCOUNT_DOC = new Field("M_ATT_BASE_ACCOUNT_DOC", "LEGAL_PERSON_BASE", "基本户开户许可证扫描件");
            /// <summary>
			/// 资质证书副本扫描件
			/// </summary>
			public readonly static Field M_ATT_QUAL_CART_DOC = new Field("M_ATT_QUAL_CART_DOC", "LEGAL_PERSON_BASE", "资质证书副本扫描件");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "LEGAL_PERSON_BASE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "LEGAL_PERSON_BASE", "");
        }
        #endregion
	}
}