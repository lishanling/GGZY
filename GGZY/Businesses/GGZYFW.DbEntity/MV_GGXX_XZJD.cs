...
namespace GGZYFW.DbEntity
{
    ...
    [Table("MV_GGXX_XZJD")]
    [Serializable]
    public partial class MV_GGXX_XZJD : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 
			/// </summary>
			public readonly static Field PROJECT_CATEGORY = new Field("PROJECT_CATEGORY", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field KIND = new Field("KIND", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_TYPE = new Field("PROJECT_TYPE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROTYPE_TEXT = new Field("PROTYPE_TEXT", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field NAME = new Field("NAME", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TITLE = new Field("TITLE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field GGTYPE = new Field("GGTYPE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AREANAME = new Field("AREANAME", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PLATFORM_NAME = new Field("PLATFORM_NAME", "MV_GGXX_XZJD", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TM = new Field("TM", "MV_GGXX_XZJD", "");
        }
        #endregion
	}
}