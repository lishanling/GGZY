...
namespace GGZYFW.DbEntity
{
    ...
    [Table("BLACK_LIST")]
    [Serializable]
    public partial class BLACK_LIST : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "BLACK_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "BLACK_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "BLACK_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "BLACK_LIST", "");
        }
        #endregion
	}
}