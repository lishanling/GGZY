...
namespace GGZYFW.DbEntity
{
	...
	[Serializable]
	public partial class T_USER_TRADEPLATFORM : FwEntity
	{
		#region Model
		private decimal? _ID;
		...
		{
			get { return _IS_THREE; }
			set
			{
				this.OnPropertyValueChange(_.IS_THREE, _IS_THREE, value);
				this._IS_THREE = value;
			}
		}
		#endregion
		...
		public class _
		{
			...
			/// 
			/// </summary>
			public readonly static Field IS_THREE = new Field("IS_THREE", "T_USER_TRADEPLATFORM", "");
		}
		#endregion
	}
}