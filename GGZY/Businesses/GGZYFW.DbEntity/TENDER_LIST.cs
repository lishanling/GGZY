...
{
    /// <summary>
    /// 实体类TENDER_LIST。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TENDER_LIST")]
    [Serializable]
    public partial class TENDER_LIST : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TENDER_LIST");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "TENDER_LIST", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "TENDER_LIST", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "TENDER_LIST", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "TENDER_LIST", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "TENDER_LIST", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "TENDER_LIST", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "TENDER_LIST", "投标人角色");
            /// <summary>
			/// 投标单位项目负责人
			/// </summary>
			public readonly static Field BID_MANAGER = new Field("BID_MANAGER", "TENDER_LIST", "投标单位项目负责人");
            /// <summary>
			/// 标书下载时间
			/// </summary>
			public readonly static Field BID_DOC_DOWNLOAD_TIME = new Field("BID_DOC_DOWNLOAD_TIME", "TENDER_LIST", "标书下载时间");
            /// <summary>
			/// 保证金递交方式
			/// </summary>
			public readonly static Field MARGIN_PAY_FORM = new Field("MARGIN_PAY_FORM", "TENDER_LIST", "保证金递交方式");
            /// <summary>
			/// 保证金递交时间
			/// </summary>
			public readonly static Field MARGIN_RECEIVE_TIME = new Field("MARGIN_RECEIVE_TIME", "TENDER_LIST", "保证金递交时间");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "TENDER_LIST", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "TENDER_LIST", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 联合体联系人（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_NAME = new Field("UNION_CONTACT_NAME", "TENDER_LIST",DbType.AnsiString, null, "联合体联系人（如有）");
            /// <summary>
			/// 联合体联系电话（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_PHONE = new Field("UNION_CONTACT_PHONE", "TENDER_LIST", "联合体联系电话（如有）");
            /// <summary>
			/// 投标人信息版本
			/// </summary>
			public readonly static Field BIDDER_INFO_VERSION = new Field("BIDDER_INFO_VERSION", "TENDER_LIST", "投标人信息版本");
            /// <summary>
			/// 投标报价金额
			/// </summary>
			public readonly static Field BID_PRICE = new Field("BID_PRICE", "TENDER_LIST", "投标报价金额");
            /// <summary>
			/// 投标报价币种
			/// </summary>
			public readonly static Field PRICE_CURRENCY = new Field("PRICE_CURRENCY", "TENDER_LIST", "投标报价币种");
            /// <summary>
			/// 投标报价单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "TENDER_LIST", "投标报价单位");
            /// <summary>
			/// 投标工期
			/// </summary>
			public readonly static Field TIME_LIMIT = new Field("TIME_LIMIT", "TENDER_LIST", "投标工期");
            /// <summary>
			/// 投标文件递交时间
			/// </summary>
			public readonly static Field CHECKIN_TIME = new Field("CHECKIN_TIME", "TENDER_LIST", "投标文件递交时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TENDER_LIST", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TENDER_LIST", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TENDER_LIST", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "TENDER_LIST", "");
            /// <summary>
			/// ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "TENDER_LIST", "ID");
            /// <summary>
			/// ??????
			/// </summary>
			public readonly static Field M_CREATOR = new Field("M_CREATOR", "TENDER_LIST", "??????");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "TENDER_LIST", "");
            /// <summary>
			/// 标注金额单位是否被更新过，1表示更新过
			/// </summary>
			public readonly static Field M_MONEY_UPDATE = new Field("M_MONEY_UPDATE", "TENDER_LIST", "标注金额单位是否被更新过，1表示更新过");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TEST1 = new Field("TEST1", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TEST2 = new Field("TEST2", "TENDER_LIST", "");
            /// <summary>
			/// 项目负责人证件号码
			/// </summary>
			public readonly static Field PM_CODE = new Field("PM_CODE", "TENDER_LIST", "项目负责人证件号码");
            /// <summary>
			/// 项目负责人相关证书和编号
			/// </summary>
			public readonly static Field PM_CERTIFICATES = new Field("PM_CERTIFICATES", "TENDER_LIST",DbType.AnsiString, null, "项目负责人相关证书和编号");
            /// <summary>
			/// 是否失信人
			/// </summary>
			public readonly static Field IS_LOST = new Field("IS_LOST", "TENDER_LIST", "是否失信人");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "TENDER_LIST", "价款形式代码");
            /// <summary>
			/// 费率或其它类型报价
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "TENDER_LIST", "费率或其它类型报价");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "TENDER_LIST", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "TENDER_LIST", "");
            /// <summary>
			/// 是否提交保证金
			/// </summary>
			public readonly static Field IS_COMMIT_MARGIN = new Field("IS_COMMIT_MARGIN", "TENDER_LIST", "是否提交保证金");
            /// <summary>
			/// 投标人企业注册所在地
			/// </summary>
			public readonly static Field BIDDER_REGION_CODE = new Field("BIDDER_REGION_CODE", "TENDER_LIST", "投标人企业注册所在地");
            /// <summary>
			/// 投标人企业性质
			/// </summary>
			public readonly static Field BIDDER_PROPERTY = new Field("BIDDER_PROPERTY", "TENDER_LIST", "投标人企业性质");
            /// <summary>
			/// 投标操作人员
			/// </summary>
			public readonly static Field BIDDER_OPERATION_PERSON = new Field("BIDDER_OPERATION_PERSON", "TENDER_LIST", "投标操作人员");
            /// <summary>
			/// 投标操作人员身份证
			/// </summary>
			public readonly static Field BIDDER_OPERATION_PERSON_ID = new Field("BIDDER_OPERATION_PERSON_ID", "TENDER_LIST", "投标操作人员身份证");
            /// <summary>
			/// 投标操作人联系方式
			/// </summary>
			public readonly static Field BIDDER_OPERATION_PERSON_CON = new Field("BIDDER_OPERATION_PERSON_CON", "TENDER_LIST", "投标操作人联系方式");
            /// <summary>
			/// 投标人是否入围评审
			/// </summary>
			public readonly static Field IS_REVIEW_SHORTLISTED = new Field("IS_REVIEW_SHORTLISTED", "TENDER_LIST", "投标人是否入围评审");
            /// <summary>
			/// 招标文件购买订单号
			/// </summary>
			public readonly static Field PURCHASE_ORDER_NUMBER = new Field("PURCHASE_ORDER_NUMBER", "TENDER_LIST", "招标文件购买订单号");
        }
        #endregion
	}
}