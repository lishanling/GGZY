...
{
    /// <summary>
    /// 实体类SUPERVISION_ATTACHMENTS。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SUPERVISION_ATTACHMENTS")]
    [Serializable]
    public partial class SUPERVISION_ATTACHMENTS : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SUPERVISION_ATTACHMENTS");
            /// <summary>
			/// 附件关联数据集标识符
			/// </summary>
			public readonly static Field ATTACHMENT_SET_CODE = new Field("ATTACHMENT_SET_CODE", "SUPERVISION_ATTACHMENTS",DbType.AnsiString, null, "附件关联数据集标识符");
            /// <summary>
			/// 关联附件数量
			/// </summary>
			public readonly static Field ATTACHMENT_COUNT = new Field("ATTACHMENT_COUNT", "SUPERVISION_ATTACHMENTS", "关联附件数量");
            /// <summary>
			/// 附件名称
			/// </summary>
			public readonly static Field ATTACHMENT_NAME = new Field("ATTACHMENT_NAME", "SUPERVISION_ATTACHMENTS", "附件名称");
            /// <summary>
			/// 附件类型
			/// </summary>
			public readonly static Field ATTACHMENT_TYPE = new Field("ATTACHMENT_TYPE", "SUPERVISION_ATTACHMENTS", "附件类型");
            /// <summary>
			/// 附件文件名
			/// </summary>
			public readonly static Field ATTACHMENT_FILE_NAME = new Field("ATTACHMENT_FILE_NAME", "SUPERVISION_ATTACHMENTS", "附件文件名");
            /// <summary>
			/// 附件URL地址
			/// </summary>
			public readonly static Field URL = new Field("URL", "SUPERVISION_ATTACHMENTS", "附件URL地址");
        }
        #endregion
	}
}