...
{
    /// <summary>
    /// 实体类MV_ALLRESULT。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("MV_ALLRESULT")]
    [Serializable]
    public partial class MV_ALLRESULT : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "MV_ALLRESULT");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TYPE = new Field("TYPE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field SECTION_CODE = new Field("SECTION_CODE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AMOUNT = new Field("AMOUNT", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AREACODE = new Field("AREACODE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field AREANAME = new Field("AREANAME", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field KIND = new Field("KIND", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TABLE = new Field("M_TABLE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field EVALUATION_RESULT = new Field("EVALUATION_RESULT", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field RECKON_AMOUNT = new Field("RECKON_AMOUNT", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_TYPE = new Field("PROJECT_TYPE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TENDER_MODE = new Field("TENDER_MODE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field ORGANIZE_FORM = new Field("ORGANIZE_FORM", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field BULLETIN_TYPE = new Field("BULLETIN_TYPE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field LISTING_TYPE = new Field("LISTING_TYPE", "MV_ALLRESULT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IN_BUY_KIND = new Field("IN_BUY_KIND", "MV_ALLRESULT", "");
        }
        #endregion
	}
}