...
namespace GGZYFW.DbEntity
{
    ...
    [Serializable]
    public partial class TENDER_FILE_BUYYER_INFO : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "TENDER_FILE_BUYYER_INFO", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "TENDER_FILE_BUYYER_INFO", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "TENDER_FILE_BUYYER_INFO", "统一交易标识码");
            /// <summary>
			/// 招标文件购买途径
			/// </summary>
			public readonly static Field PURCHASE_WAY = new Field("PURCHASE_WAY", "TENDER_FILE_BUYYER_INFO", "招标文件购买途径");
            /// <summary>
			/// 招标文件购买方式
			/// </summary>
			public readonly static Field PURCHASE_MODE = new Field("PURCHASE_MODE", "TENDER_FILE_BUYYER_INFO", "招标文件购买方式");
            /// <summary>
			/// 招标文件购买金额
			/// </summary>
			public readonly static Field PURCHASE_MONEY = new Field("PURCHASE_MONEY", "TENDER_FILE_BUYYER_INFO", "招标文件购买金额");
            /// <summary>
			/// 招标文件购买订单号
			/// </summary>
			public readonly static Field PURCHASE_ORDER_NUMBER = new Field("PURCHASE_ORDER_NUMBER", "TENDER_FILE_BUYYER_INFO", "招标文件购买订单号");
            /// <summary>
			/// 招标文件购买账号
			/// </summary>
			public readonly static Field PURCHASE_ACCOUNT = new Field("PURCHASE_ACCOUNT", "TENDER_FILE_BUYYER_INFO", "招标文件购买账号");
            /// <summary>
			/// 招标文件购买时间
			/// </summary>
			public readonly static Field PURCHASE_TIME = new Field("PURCHASE_TIME", "TENDER_FILE_BUYYER_INFO", "招标文件购买时间");
            /// <summary>
			/// 招标文件购买IP地址
			/// </summary>
			public readonly static Field PURCHASE_IP = new Field("PURCHASE_IP", "TENDER_FILE_BUYYER_INFO", "招标文件购买IP地址");
            /// <summary>
			/// 招标文件购买浏览器信息
			/// </summary>
			public readonly static Field PURCHASE_BROWSER = new Field("PURCHASE_BROWSER", "TENDER_FILE_BUYYER_INFO", "招标文件购买浏览器信息");
            /// <summary>
			/// 招标文件下载IP地址
			/// </summary>
			public readonly static Field DOWNLOAD_IP = new Field("DOWNLOAD_IP", "TENDER_FILE_BUYYER_INFO", "招标文件下载IP地址");
            /// <summary>
			/// 招标文件下载浏览器信息
			/// </summary>
			public readonly static Field DOWNLOAD_BROWSER = new Field("DOWNLOAD_BROWSER", "TENDER_FILE_BUYYER_INFO", "招标文件下载浏览器信息");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TENDER_FILE_BUYYER_INFO", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TENDER_FILE_BUYYER_INFO", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TENDER_FILE_BUYYER_INFO", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "TENDER_FILE_BUYYER_INFO", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "TENDER_FILE_BUYYER_INFO", "公共服务平台标识码");
        }
        #endregion
	}
}