...
namespace GGZYFW.DbEntity
{
	...
	[Serializable]
	public partial class BD_VIOLATION_POINT_DETAIL : FwEntity
	{
		#region Model
		private decimal? _ID;
		...
		public class _
		{
			...
			/// 招标项目类型
			/// </summary>
			public readonly static Field RESULT_MSG = new Field("RESULT_MSG", "BD_VIOLATION_POINT_DETAIL", "招标项目类型");
			/// <summary>
			/// 违规概率
			/// </summary>
			...
			/// 
			/// </summary>
			public readonly static Field CHECK_TIME = new Field("CHECK_TIME", "BD_VIOLATION_POINT_DETAIL", "");
			/// <summary>
			/// 排序
			/// </summary>
