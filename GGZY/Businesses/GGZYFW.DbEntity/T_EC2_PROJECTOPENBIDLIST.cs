...
{
    /// <summary>
    /// 实体类T_EC2_PROJECTOPENBIDLIST。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("T_EC2_PROJECTOPENBIDLIST")]
    [Serializable]
    public partial class T_EC2_PROJECTOPENBIDLIST : FwEntity
    {
        #region Model
		private string _PROJECTOPENBIDLISTCODE;
		...
		/// 开标明细（工程）编号
		/// </summary>
		public string PROJECTOPENBIDLISTCODE
		{
			get{ return _PROJECTOPENBIDLISTCODE; }
			set
			{
				this.OnPropertyValueChange(_.PROJECTOPENBIDLISTCODE, _PROJECTOPENBIDLISTCODE, value);
				this._PROJECTOPENBIDLISTCODE = value;
			}
		}
		/// <summary>
		/// 开标记录编号
		...
		public string PMNAME
		{
			...
			set
			{
				this.OnPropertyValueChange(_.PMNAME, _PMNAME, value);
				this._PMNAME = value;
			}
		}
		/// <summary>
		/// 项目经理证件类型
		/// </summary>
		public string PMCODETYPE
		{
			get{ return _PMCODETYPE; }
			set
			{
				this.OnPropertyValueChange(_.PMCODETYPE, _PMCODETYPE, value);
				this._PMCODETYPE = value;
			}
		}
		/// <summary>
		/// 项目经理证件号码
		...
		public string PMCODE
		{
			...
			set
			{
				this.OnPropertyValueChange(_.PMCODE, _PMCODE, value);
				this._PMCODE = value;
			}
		}
		/// <summary>
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "T_EC2_PROJECTOPENBIDLIST");
            /// <summary>
			/// 开标明细（工程）编号
			/// </summary>
			public readonly static Field PROJECTOPENBIDLISTCODE = new Field("PROJECTOPENBIDLISTCODE", "T_EC2_PROJECTOPENBIDLIST", "开标明细（工程）编号");
            /// <summary>
			/// 开标记录编号
			/// </summary>
			public readonly static Field OPENBIDRECORDCODE = new Field("OPENBIDRECORDCODE", "T_EC2_PROJECTOPENBIDLIST", "开标记录编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BIDSECTIONCODE = new Field("BIDSECTIONCODE", "T_EC2_PROJECTOPENBIDLIST", "标段（包）编号");
            /// <summary>
			/// 是否联合体
			/// </summary>
			public readonly static Field ISUNION = new Field("ISUNION", "T_EC2_PROJECTOPENBIDLIST", "是否联合体");
            /// <summary>
			/// 联合体代码类型
			/// </summary>
			public readonly static Field UNIONCODETYPE = new Field("UNIONCODETYPE", "T_EC2_PROJECTOPENBIDLIST", "联合体代码类型");
            /// <summary>
			/// 联合体代码
			/// </summary>
			public readonly static Field UNIONCODE = new Field("UNIONCODE", "T_EC2_PROJECTOPENBIDLIST", "联合体代码");
            /// <summary>
			/// 联合体名称
			/// </summary>
			public readonly static Field UNIONNAME = new Field("UNIONNAME", "T_EC2_PROJECTOPENBIDLIST",DbType.AnsiString, null, "联合体名称");
            /// <summary>
			/// 联合体成员基本信息版本号
			/// </summary>
			public readonly static Field UNIONMEMBERBASICINFOVERSION = new Field("UNIONMEMBERBASICINFOVERSION", "T_EC2_PROJECTOPENBIDLIST",DbType.AnsiString, null, "联合体成员基本信息版本号");
            /// <summary>
			/// 投标人代码类型
			/// </summary>
			public readonly static Field BIDDERCODETYPE = new Field("BIDDERCODETYPE", "T_EC2_PROJECTOPENBIDLIST", "投标人代码类型");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDERCODE = new Field("BIDDERCODE", "T_EC2_PROJECTOPENBIDLIST", "投标人代码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDERNAME = new Field("BIDDERNAME", "T_EC2_PROJECTOPENBIDLIST", "投标人名称");
            /// <summary>
			/// 投标人基本信息版本号
			/// </summary>
			public readonly static Field BIDDERBASICINFOVERSION = new Field("BIDDERBASICINFOVERSION", "T_EC2_PROJECTOPENBIDLIST", "投标人基本信息版本号");
            /// <summary>
			/// 工期
			/// </summary>
			public readonly static Field DURATION = new Field("DURATION", "T_EC2_PROJECTOPENBIDLIST",DbType.AnsiString, null, "工期");
            /// <summary>
			/// 投标报价金额
			/// </summary>
			public readonly static Field BIDAMOUNT = new Field("BIDAMOUNT", "T_EC2_PROJECTOPENBIDLIST", "投标报价金额");
            /// <summary>
			/// 金额币种
			/// </summary>
			public readonly static Field CURRENCYCODE = new Field("CURRENCYCODE", "T_EC2_PROJECTOPENBIDLIST", "金额币种");
            /// <summary>
			/// 金额单位
			/// </summary>
			public readonly static Field PRICEUNIT = new Field("PRICEUNIT", "T_EC2_PROJECTOPENBIDLIST", "金额单位");
            /// <summary>
			/// 其他类型投标报价
			/// </summary>
			public readonly static Field OTHERBIDPRICE = new Field("OTHERBIDPRICE", "T_EC2_PROJECTOPENBIDLIST",DbType.AnsiString, null, "其他类型投标报价");
            /// <summary>
			/// 项目经理姓名
			/// </summary>
			public readonly static Field PMNAME = new Field("PMNAME", "T_EC2_PROJECTOPENBIDLIST", "项目经理姓名");
            /// <summary>
			/// 项目经理证件类型
			/// </summary>
			public readonly static Field PMCODETYPE = new Field("PMCODETYPE", "T_EC2_PROJECTOPENBIDLIST", "项目经理证件类型");
            /// <summary>
			/// 项目经理证件号码
			/// </summary>
			public readonly static Field PMCODE = new Field("PMCODE", "T_EC2_PROJECTOPENBIDLIST", "项目经理证件号码");
            /// <summary>
			/// 其他开标内容
			/// </summary>
			public readonly static Field OTHEROPENBIDCONTENT = new Field("OTHEROPENBIDCONTENT", "T_EC2_PROJECTOPENBIDLIST",DbType.AnsiString, null, "其他开标内容");
            /// <summary>
			/// 版本号
			/// </summary>
			public readonly static Field VERSION = new Field("VERSION", "T_EC2_PROJECTOPENBIDLIST", "版本号");
            /// <summary>
			/// 是否公开
			/// </summary>
			public readonly static Field ISOPEN = new Field("ISOPEN", "T_EC2_PROJECTOPENBIDLIST", "是否公开");
            /// <summary>
			/// 公开类型
			/// </summary>
			public readonly static Field OPENTYPE = new Field("OPENTYPE", "T_EC2_PROJECTOPENBIDLIST", "公开类型");
            /// <summary>
			/// 交易平台数据验证责任人姓名
			/// </summary>
			public readonly static Field EXAMINERNAME = new Field("EXAMINERNAME", "T_EC2_PROJECTOPENBIDLIST", "交易平台数据验证责任人姓名");
            /// <summary>
			/// 交易平台数据验证责任人证件类型
			/// </summary>
			public readonly static Field EXAMINERCODETYPE = new Field("EXAMINERCODETYPE", "T_EC2_PROJECTOPENBIDLIST", "交易平台数据验证责任人证件类型");
            /// <summary>
			/// 交易平台数据验证责任人证件号码
			/// </summary>
			public readonly static Field EXAMINERCODE = new Field("EXAMINERCODE", "T_EC2_PROJECTOPENBIDLIST", "交易平台数据验证责任人证件号码");
            /// <summary>
			/// 交易平台数据验证时间
			/// </summary>
			public readonly static Field VERIFYTIME = new Field("VERIFYTIME", "T_EC2_PROJECTOPENBIDLIST", "交易平台数据验证时间");
            /// <summary>
			/// 数据源
			/// </summary>
			public readonly static Field DATA_SOURCE = new Field("DATA_SOURCE", "T_EC2_PROJECTOPENBIDLIST", "数据源");
            /// <summary>
			/// 数据时间
			/// </summary>
			public readonly static Field CREATE_TIME = new Field("CREATE_TIME", "T_EC2_PROJECTOPENBIDLIST", "数据时间");
        }
        #endregion
	}
}