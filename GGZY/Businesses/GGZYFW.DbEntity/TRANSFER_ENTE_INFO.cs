...
{
    /// <summary>
    /// 实体类TRANSFER_ENTE_INFO。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TRANSFER_ENTE_INFO")]
    [Serializable]
    public partial class TRANSFER_ENTE_INFO : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TRANSFER_ENTE_INFO");
            /// <summary>
			/// 转让标的企业名称
			/// </summary>
			public readonly static Field SUBJECT_COMPANY_NAME = new Field("SUBJECT_COMPANY_NAME", "TRANSFER_ENTE_INFO", "转让标的企业名称");
            /// <summary>
			/// 本次拟转让产（股）权比例（%）
			/// </summary>
			public readonly static Field SELL_PERCENT = new Field("SELL_PERCENT", "TRANSFER_ENTE_INFO", "本次拟转让产（股）权比例（%）");
            /// <summary>
			/// 标的企业社会信用代码/组织机构代码
			/// </summary>
			public readonly static Field SUBJECT_COMPANY_CODE = new Field("SUBJECT_COMPANY_CODE", "TRANSFER_ENTE_INFO", "标的企业社会信用代码/组织机构代码");
            /// <summary>
			/// 转让标的企业所在地区
			/// </summary>
			public readonly static Field ZONE = new Field("ZONE", "TRANSFER_ENTE_INFO", "转让标的企业所在地区");
            /// <summary>
			/// 转让标的企业所属行业码
			/// </summary>
			public readonly static Field INDUSTRY_CODE = new Field("INDUSTRY_CODE", "TRANSFER_ENTE_INFO", "转让标的企业所属行业码");
            /// <summary>
			/// 转让标的企业经济类型
			/// </summary>
			public readonly static Field ECONOMY_TYPE = new Field("ECONOMY_TYPE", "TRANSFER_ENTE_INFO", "转让标的企业经济类型");
            /// <summary>
			/// 转让标的企业职工人数
			/// </summary>
			public readonly static Field EMPLOYEE_QUANTITY = new Field("EMPLOYEE_QUANTITY", "TRANSFER_ENTE_INFO", "转让标的企业职工人数");
            /// <summary>
			/// 转让标的企业是否含有国有划拨土地
			/// </summary>
			public readonly static Field HAS_CONTAIN_GROUND = new Field("HAS_CONTAIN_GROUND", "TRANSFER_ENTE_INFO", "转让标的企业是否含有国有划拨土地");
            /// <summary>
			/// 审计年度（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_YEAR = new Field("LAST_AUDIT_YEAR", "TRANSFER_ENTE_INFO", "审计年度（上年度）");
            /// <summary>
			/// 审计机构（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_UNIT = new Field("LAST_AUDIT_UNIT", "TRANSFER_ENTE_INFO", "审计机构（上年度）");
            /// <summary>
			/// 资产总额（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_ASSET = new Field("LAST_AUDIT_ASSET", "TRANSFER_ENTE_INFO", "资产总额（上年度）");
            /// <summary>
			/// 负债总额（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_DEBT = new Field("LAST_AUDIT_DEBT", "TRANSFER_ENTE_INFO", "负债总额（上年度）");
            /// <summary>
			/// 净资产（所有者权益）（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_EQUITY = new Field("LAST_AUDIT_EQUITY", "TRANSFER_ENTE_INFO", "净资产（所有者权益）（上年度）");
            /// <summary>
			/// 营业收入（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_EARNING = new Field("LAST_AUDIT_EARNING", "TRANSFER_ENTE_INFO", "营业收入（上年度）");
            /// <summary>
			/// 利润总额（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_PROFIT = new Field("LAST_AUDIT_PROFIT", "TRANSFER_ENTE_INFO", "利润总额（上年度）");
            /// <summary>
			/// 净利润（上年度）
			/// </summary>
			public readonly static Field LAST_AUDIT_NETPROFIT = new Field("LAST_AUDIT_NETPROFIT", "TRANSFER_ENTE_INFO", "净利润（上年度）");
            /// <summary>
			/// 报表日期
			/// </summary>
			public readonly static Field FINANCE_REPORT_DATE = new Field("FINANCE_REPORT_DATE", "TRANSFER_ENTE_INFO", "报表日期");
            /// <summary>
			/// 报表类型
			/// </summary>
			public readonly static Field FINANCE_REPORT_TYPE = new Field("FINANCE_REPORT_TYPE", "TRANSFER_ENTE_INFO", "报表类型");
            /// <summary>
			/// 资产总额
			/// </summary>
			public readonly static Field TOTAL_CAPITAL = new Field("TOTAL_CAPITAL", "TRANSFER_ENTE_INFO", "资产总额");
            /// <summary>
			/// 负债总额
			/// </summary>
			public readonly static Field TOTAL_DEBT = new Field("TOTAL_DEBT", "TRANSFER_ENTE_INFO", "负债总额");
            /// <summary>
			/// 净资产（所有者权益）
			/// </summary>
			public readonly static Field OWENERSHIP_INTEREST = new Field("OWENERSHIP_INTEREST", "TRANSFER_ENTE_INFO", "净资产（所有者权益）");
            /// <summary>
			/// 营业收入
			/// </summary>
			public readonly static Field BUSINESS_INCOME = new Field("BUSINESS_INCOME", "TRANSFER_ENTE_INFO", "营业收入");
            /// <summary>
			/// 利润总额
			/// </summary>
			public readonly static Field BUSINESS_PROFIT = new Field("BUSINESS_PROFIT", "TRANSFER_ENTE_INFO", "利润总额");
            /// <summary>
			/// 净利润
			/// </summary>
			public readonly static Field NET_PROFIT = new Field("NET_PROFIT", "TRANSFER_ENTE_INFO", "净利润");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TRANSFER_ENTE_INFO", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TRANSFER_ENTE_INFO", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TRANSFER_ENTE_INFO", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "TRANSFER_ENTE_INFO", "项目编号");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "TRANSFER_ENTE_INFO", "");
            /// <summary>
			/// 监督正式披露ID
			/// </summary>
			public readonly static Field M_PRE_ID = new Field("M_PRE_ID", "TRANSFER_ENTE_INFO", "监督正式披露ID");
            /// <summary>
			/// 标的编号
			/// </summary>
			public readonly static Field BID_CODE = new Field("BID_CODE", "TRANSFER_ENTE_INFO", "标的编号");
            /// <summary>
			/// 分类版本代码
			/// </summary>
			public readonly static Field CLASS_VER_CODE = new Field("CLASS_VER_CODE", "TRANSFER_ENTE_INFO", "分类版本代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "TRANSFER_ENTE_INFO", "");
        }
        #endregion
	}
}