...
{
    /// <summary>
    /// 实体类PROJECT_ATTACHMENTS。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("PROJECT_ATTACHMENTS")]
    [Serializable]
    public partial class PROJECT_ATTACHMENTS : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "PROJECT_ATTACHMENTS");
            /// <summary>
			/// 附件关联数据集标识符
			/// </summary>
			public readonly static Field ATTACHMENT_SET_CODE = new Field("ATTACHMENT_SET_CODE", "PROJECT_ATTACHMENTS",DbType.AnsiString, null, "附件关联数据集标识符");
            /// <summary>
			/// 关联附件数量
			/// </summary>
			public readonly static Field ATTACHMENT_COUNT = new Field("ATTACHMENT_COUNT", "PROJECT_ATTACHMENTS", "关联附件数量");
            /// <summary>
			/// 附件名称
			/// </summary>
			public readonly static Field ATTACHMENT_NAME = new Field("ATTACHMENT_NAME", "PROJECT_ATTACHMENTS", "附件名称");
            /// <summary>
			/// 附件类型
			/// </summary>
			public readonly static Field ATTACHMENT_TYPE = new Field("ATTACHMENT_TYPE", "PROJECT_ATTACHMENTS", "附件类型");
            /// <summary>
			/// 附件文件名
			/// </summary>
			public readonly static Field ATTACHMENT_FILE_NAME = new Field("ATTACHMENT_FILE_NAME", "PROJECT_ATTACHMENTS", "附件文件名");
            /// <summary>
			/// 附件URL地址
			/// </summary>
			public readonly static Field URL = new Field("URL", "PROJECT_ATTACHMENTS", "附件URL地址");
        }
        #endregion
	}
}