...
{
    /// <summary>
    /// 实体类BIDDER_CREDIT_INFO。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("BIDDER_CREDIT_INFO")]
    [Serializable]
    public partial class BIDDER_CREDIT_INFO : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "BIDDER_CREDIT_INFO");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "BIDDER_CREDIT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "BIDDER_CREDIT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "BIDDER_CREDIT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "BIDDER_CREDIT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "BIDDER_CREDIT_INFO", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "BIDDER_CREDIT_INFO", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "BIDDER_CREDIT_INFO", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "BIDDER_CREDIT_INFO", "统一交易标识码");
            /// <summary>
			/// 投标人名称
			/// </summary>
			public readonly static Field BIDDER_NAME = new Field("BIDDER_NAME", "BIDDER_CREDIT_INFO", "投标人名称");
            /// <summary>
			/// 投标人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "BIDDER_CREDIT_INFO", "投标人类别");
            /// <summary>
			/// 投标人代码
			/// </summary>
			public readonly static Field BIDDER_ORG_CODE = new Field("BIDDER_ORG_CODE", "BIDDER_CREDIT_INFO", "投标人代码");
            /// <summary>
			/// 投标人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "BIDDER_CREDIT_INFO", "投标人角色");
            /// <summary>
			/// 联合体名称（如有）
			/// </summary>
			public readonly static Field UNION_ENTERPRISE_NAME = new Field("UNION_ENTERPRISE_NAME", "BIDDER_CREDIT_INFO", "联合体名称（如有）");
            /// <summary>
			/// 联合体组织机构代码证（联合体招标时填写）
			/// </summary>
			public readonly static Field UNION_ORGAN_SET_CODE = new Field("UNION_ORGAN_SET_CODE", "BIDDER_CREDIT_INFO", "联合体组织机构代码证（联合体招标时填写）");
            /// <summary>
			/// 联合体联系人（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_NAME = new Field("UNION_CONTACT_NAME", "BIDDER_CREDIT_INFO", "联合体联系人（如有）");
            /// <summary>
			/// 联合体联系电话（如有）
			/// </summary>
			public readonly static Field UNION_CONTACT_PHONE = new Field("UNION_CONTACT_PHONE", "BIDDER_CREDIT_INFO", "联合体联系电话（如有）");
            /// <summary>
			/// 应用信用分系统名称
			/// </summary>
			public readonly static Field SCORE_SYSTEM_NAME = new Field("SCORE_SYSTEM_NAME", "BIDDER_CREDIT_INFO", "应用信用分系统名称");
            /// <summary>
			/// 应用信用分年份
			/// </summary>
			public readonly static Field SCORE_YEAR = new Field("SCORE_YEAR", "BIDDER_CREDIT_INFO", "应用信用分年份");
            /// <summary>
			/// 应用信用分季度
			/// </summary>
			public readonly static Field SCORE_QUARTER = new Field("SCORE_QUARTER", "BIDDER_CREDIT_INFO", "应用信用分季度");
            /// <summary>
			/// 应用信用分月份
			/// </summary>
			public readonly static Field SCORE_MONTH = new Field("SCORE_MONTH", "BIDDER_CREDIT_INFO", "应用信用分月份");
            /// <summary>
			/// 应用信用分天
			/// </summary>
			public readonly static Field SCORE_DAY = new Field("SCORE_DAY", "BIDDER_CREDIT_INFO", "应用信用分天");
            /// <summary>
			/// 信用分数
			/// </summary>
			public readonly static Field SCORE = new Field("SCORE", "BIDDER_CREDIT_INFO", "信用分数");
            /// <summary>
			/// 信用排名(本项目所有投标人)
			/// </summary>
			public readonly static Field PROJECT_RANK = new Field("PROJECT_RANK", "BIDDER_CREDIT_INFO", "信用排名(本项目所有投标人)");
            /// <summary>
			/// 信用排名(全省企业)
			/// </summary>
			public readonly static Field PROVINCE_RANK = new Field("PROVINCE_RANK", "BIDDER_CREDIT_INFO", "信用排名(全省企业)");
            /// <summary>
			/// 备注
			/// </summary>
			public readonly static Field REMARK = new Field("REMARK", "BIDDER_CREDIT_INFO",DbType.AnsiString, null, "备注");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "BIDDER_CREDIT_INFO", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "BIDDER_CREDIT_INFO", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "BIDDER_CREDIT_INFO", "数据时间戳");
            /// <summary>
			/// 交易平台或发布工具标识码
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "BIDDER_CREDIT_INFO", "交易平台或发布工具标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "BIDDER_CREDIT_INFO", "公共服务平台标识码");
        }
        #endregion
	}
}