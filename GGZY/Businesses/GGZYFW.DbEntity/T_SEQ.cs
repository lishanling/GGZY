...
namespace GGZYFW.DbEntity
{
    ...
    [Table("T_SEQ")]
    [Serializable]
    public partial class T_SEQ : FwEntity
    {
        #region Model
		private decimal? _ID;
        ...
        public class _
        {
			...
			/// 表名
			/// </summary>
			public readonly static Field TB_NAME = new Field("TB_NAME", "T_SEQ", "表名");
            /// <summary>
			/// 字段名
			/// </summary>
			public readonly static Field FNAME = new Field("FNAME", "T_SEQ", "字段名");
            /// <summary>
			/// 值
			/// </summary>
			public readonly static Field VAL = new Field("VAL", "T_SEQ", "值");
            /// <summary>
			/// 当前日期(yyyyMMdd)
			/// </summary>
			public readonly static Field CUR_DATE = new Field("CUR_DATE", "T_SEQ", "当前日期(yyyyMMdd)");
        }
        #endregion
	}
}