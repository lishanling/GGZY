...
{
	/// <summary>
	/// 实体类MV_TJ_ALLRESULT_XZJD。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Table("MV_TJ_ALLRESULT_XZJD")]
	[Serializable]
	public partial class MV_TJ_ALLRESULT_XZJD : FwEntity
	{
		#region Model
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "MV_TJ_ALLRESULT_XZJD");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field SECTION_CODE = new Field("SECTION_CODE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field AMOUNT = new Field("AMOUNT", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field AREACODE = new Field("AREACODE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field AREANAME = new Field("AREANAME", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field KIND = new Field("KIND", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TABLE = new Field("M_TABLE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field EVALUATION_RESULT = new Field("EVALUATION_RESULT", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field RECKON_AMOUNT = new Field("RECKON_AMOUNT", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_TYPE = new Field("PROJECT_TYPE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field TENDER_MODE = new Field("TENDER_MODE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field ORGANIZE_FORM = new Field("ORGANIZE_FORM", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field BULLETIN_TYPE = new Field("BULLETIN_TYPE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field LISTING_TYPE = new Field("LISTING_TYPE", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field IN_BUY_KIND = new Field("IN_BUY_KIND", "MV_TJ_ALLRESULT_XZJD", "");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "MV_TJ_ALLRESULT_XZJD", "");
		}
		#endregion
	}
}