...
{
    /// <summary>
    /// 实体类T_GQ_PUBLISH。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("T_GQ_PUBLISH")]
    [Serializable]
    public partial class T_GQ_PUBLISH : FwEntity
    {
        #region Model
		...
		private string _DELAY_MAX;
		private decimal? _DELAY_PEROID;
		private string _PUBLISH_DESC;
		...
		{
			get{ return _DELAY_MAX; }
			set
			{
				this.OnPropertyValueChange(_.DELAY_MAX, _DELAY_MAX, value);
		...
		{
			get{ return _PUBLISH_DESC; }
			set
			{
				this.OnPropertyValueChange(_.PUBLISH_DESC, _PUBLISH_DESC, value);
				this._PUBLISH_DESC = value;
			}
		}
		/// <summary>
		/// 交易方式
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "T_GQ_PUBLISH");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_NO = new Field("PROJECT_NO", "T_GQ_PUBLISH", "项目编号");
            /// <summary>
			/// 项目名称
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "T_GQ_PUBLISH", "项目名称");
            /// <summary>
			/// 挂牌价格
			/// </summary>
			public readonly static Field PROJECT_PRICE = new Field("PROJECT_PRICE", "T_GQ_PUBLISH", "挂牌价格");
            /// <summary>
			/// 交易价款支付方式
			/// </summary>
			public readonly static Field PAY_MODE = new Field("PAY_MODE", "T_GQ_PUBLISH", "交易价款支付方式");
            /// <summary>
			/// 分期支付要求
			/// </summary>
			public readonly static Field PAY_MODE_PART = new Field("PAY_MODE_PART", "T_GQ_PUBLISH",DbType.AnsiString, null, "分期支付要求");
            /// <summary>
			/// 挂牌公告期
			/// </summary>
			public readonly static Field PUBLISH_DAYSN3 = new Field("PUBLISH_DAYSN3", "T_GQ_PUBLISH", "挂牌公告期");
            /// <summary>
			/// 挂牌开始时间
			/// </summary>
			public readonly static Field PUBLISH_START_TIME = new Field("PUBLISH_START_TIME", "T_GQ_PUBLISH", "挂牌开始时间");
            /// <summary>
			/// 挂牌截止时间
			/// </summary>
			public readonly static Field PUBLISH_END_TIME = new Field("PUBLISH_END_TIME", "T_GQ_PUBLISH", "挂牌截止时间");
            /// <summary>
			/// 是否延牌
			/// </summary>
			public readonly static Field PUBLISH_DELAY_FLAG = new Field("PUBLISH_DELAY_FLAG", "T_GQ_PUBLISH", "是否延牌");
            /// <summary>
			/// 延牌规则
			/// </summary>
			public readonly static Field DELAY_MAX = new Field("DELAY_MAX", "T_GQ_PUBLISH", "延牌规则");
            /// <summary>
			/// 延牌周期（工作日）
			/// </summary>
			public readonly static Field DELAY_PEROID = new Field("DELAY_PEROID", "T_GQ_PUBLISH", "延牌周期（工作日）");
            /// <summary>
			/// 权重报价或招投标实施方案的主要内容
			/// </summary>
			public readonly static Field PUBLISH_DESC = new Field("PUBLISH_DESC", "T_GQ_PUBLISH",DbType.AnsiString, null, "权重报价或招投标实施方案的主要内容");
            /// <summary>
			/// 交易方式
			/// </summary>
			public readonly static Field PUBLISH_DEAL_WAY = new Field("PUBLISH_DEAL_WAY", "T_GQ_PUBLISH", "交易方式");
            /// <summary>
			/// 保证金类型
			/// </summary>
			public readonly static Field BAIL_TYPE = new Field("BAIL_TYPE", "T_GQ_PUBLISH", "保证金类型");
            /// <summary>
			/// 保证金金额
			/// </summary>
			public readonly static Field BAIL = new Field("BAIL", "T_GQ_PUBLISH", "保证金金额");
            /// <summary>
			/// 保证金交纳形式
			/// </summary>
			public readonly static Field BAIL_PAYMETHOD = new Field("BAIL_PAYMETHOD", "T_GQ_PUBLISH", "保证金交纳形式");
            /// <summary>
			/// 保证金交纳时间
			/// </summary>
			public readonly static Field BAIL_DEAD_TIME = new Field("BAIL_DEAD_TIME", "T_GQ_PUBLISH", "保证金交纳时间");
            /// <summary>
			/// 保证金监管账户信息
			/// </summary>
			public readonly static Field BAIL_BANK_NO = new Field("BAIL_BANK_NO", "T_GQ_PUBLISH", "保证金监管账户信息");
            /// <summary>
			/// 是否涉及优先购买权
			/// </summary>
			public readonly static Field HAS_PRIORITY = new Field("HAS_PRIORITY", "T_GQ_PUBLISH", "是否涉及优先购买权");
            /// <summary>
			/// 是否允许联合受让
			/// </summary>
			public readonly static Field UNIT_TRANSFER = new Field("UNIT_TRANSFER", "T_GQ_PUBLISH", "是否允许联合受让");
            /// <summary>
			/// 受让方资格条件
			/// </summary>
			public readonly static Field BUY_CONDITIONS = new Field("BUY_CONDITIONS", "T_GQ_PUBLISH",DbType.AnsiString, null, "受让方资格条件");
            /// <summary>
			/// 意向受让方需要提交的材料
			/// </summary>
			public readonly static Field SUBMIT_FILES = new Field("SUBMIT_FILES", "T_GQ_PUBLISH",DbType.AnsiString, null, "意向受让方需要提交的材料");
            /// <summary>
			/// 备注（保证内容）
			/// </summary>
			public readonly static Field BAIL_CONTENT = new Field("BAIL_CONTENT", "T_GQ_PUBLISH",DbType.AnsiString, null, "备注（保证内容）");
            /// <summary>
			/// 备注（处置方法）
			/// </summary>
			public readonly static Field BAIL_CONTENT_DEAL = new Field("BAIL_CONTENT_DEAL", "T_GQ_PUBLISH",DbType.AnsiString, null, "备注（处置方法）");
            /// <summary>
			/// 备注（重大事项及其他披露内容）
			/// </summary>
			public readonly static Field IMPORTANT = new Field("IMPORTANT", "T_GQ_PUBLISH",DbType.AnsiString, null, "备注（重大事项及其他披露内容）");
            /// <summary>
			/// 备注（与转让相关的其他条件)
			/// </summary>
			public readonly static Field SELL_CONDITIONS = new Field("SELL_CONDITIONS", "T_GQ_PUBLISH",DbType.AnsiString, null, "备注（与转让相关的其他条件)");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_INDUSTRIESTYPE = new Field("M_INDUSTRIESTYPE", "T_GQ_PUBLISH", "");
            /// <summary>
			/// 公告内容
			/// </summary>
			public readonly static Field M_NOTICECONTENT = new Field("M_NOTICECONTENT", "T_GQ_PUBLISH",DbType.AnsiString, null, "公告内容");
            /// <summary>
			/// 公告类型
			/// </summary>
			public readonly static Field M_BULLETINTYPE = new Field("M_BULLETINTYPE", "T_GQ_PUBLISH", "公告类型");
            /// <summary>
			/// 公告性质
			/// </summary>
			public readonly static Field M_NOTICENATURE = new Field("M_NOTICENATURE", "T_GQ_PUBLISH", "公告性质");
            /// <summary>
			/// 公告发布时间
			/// </summary>
			public readonly static Field M_NOTICESENDTIME = new Field("M_NOTICESENDTIME", "T_GQ_PUBLISH", "公告发布时间");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_AREACODE = new Field("M_AREACODE", "T_GQ_PUBLISH", "");
            /// <summary>
			/// 公告标题
			/// </summary>
			public readonly static Field M_ANNOUNCEMENT_TITLE = new Field("M_ANNOUNCEMENT_TITLE", "T_GQ_PUBLISH", "公告标题");
            /// <summary>
			/// 控制价（最高限价）（如有）
			/// </summary>
			public readonly static Field CONTROLPRICE = new Field("CONTROLPRICE", "T_GQ_PUBLISH", "控制价（最高限价）（如有）");
            /// <summary>
			/// 数据来源名称
			/// </summary>
			public readonly static Field DATASOURCENAME = new Field("DATASOURCENAME", "T_GQ_PUBLISH", "数据来源名称");
            /// <summary>
			/// 数据来源编码
			/// </summary>
			public readonly static Field DATASOURCECODE = new Field("DATASOURCECODE", "T_GQ_PUBLISH", "数据来源编码");
        }
        #endregion
	}
}