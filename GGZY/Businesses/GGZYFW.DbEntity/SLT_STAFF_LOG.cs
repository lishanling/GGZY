...
{
    /// <summary>
    /// 实体类SLT_STAFF_LOG。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("SLT_STAFF_LOG")]
    [Serializable]
    public partial class SLT_STAFF_LOG : FwEntity
    {
        #region Model
		private string _ID;
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "SLT_STAFF_LOG");
            /// <summary>
			/// 人员ID
			/// </summary>
			public readonly static Field ID = new Field("ID", "SLT_STAFF_LOG", "人员ID");
            /// <summary>
			/// 姓名
			/// </summary>
			public readonly static Field NAME = new Field("NAME", "SLT_STAFF_LOG", "姓名");
            /// <summary>
			/// 企业信用社代码
			/// </summary>
			public readonly static Field ORGCODE = new Field("ORGCODE", "SLT_STAFF_LOG", "企业信用社代码");
            /// <summary>
			/// 身份证号（已加密，解密方式见后文）
			/// </summary>
			public readonly static Field IDCARD = new Field("IDCARD", "SLT_STAFF_LOG", "身份证号（已加密，解密方式见后文）");
            /// <summary>
			/// 出生年月（yyyy-MM）
			/// </summary>
			public readonly static Field BIRTHDATE = new Field("BIRTHDATE", "SLT_STAFF_LOG", "出生年月（yyyy-MM）");
            /// <summary>
			/// 职称
			/// </summary>
			public readonly static Field PROTITLE = new Field("PROTITLE", "SLT_STAFF_LOG", "职称");
            /// <summary>
			/// 工作年限
			/// </summary>
			public readonly static Field WORKYEAR = new Field("WORKYEAR", "SLT_STAFF_LOG", "工作年限");
            /// <summary>
			/// 证书名称（多个以，分割）
			/// </summary>
			public readonly static Field QUALIFYNAME = new Field("QUALIFYNAME", "SLT_STAFF_LOG", "证书名称（多个以，分割）");
            /// <summary>
			/// 证书级别（多个以，分割）
			/// </summary>
			public readonly static Field QUALIFYLEVEL = new Field("QUALIFYLEVEL", "SLT_STAFF_LOG", "证书级别（多个以，分割）");
            /// <summary>
			/// 证书编号（多个以，分割）
			/// </summary>
			public readonly static Field QUALIFYNO = new Field("QUALIFYNO", "SLT_STAFF_LOG", "证书编号（多个以，分割）");
            /// <summary>
			/// 毕业学校（多个以，分割）
			/// </summary>
			public readonly static Field SCHOOL = new Field("SCHOOL", "SLT_STAFF_LOG", "毕业学校（多个以，分割）");
            /// <summary>
			/// 专业（多个以，分割）
			/// </summary>
			public readonly static Field MAJOR = new Field("MAJOR", "SLT_STAFF_LOG", "专业（多个以，分割）");
            /// <summary>
			/// 学历（多个以，分割）
			/// </summary>
			public readonly static Field EDUCATE = new Field("EDUCATE", "SLT_STAFF_LOG", "学历（多个以，分割）");
            /// <summary>
			/// 同步日期
			/// </summary>
			public readonly static Field SYNCDATA = new Field("SYNCDATA", "SLT_STAFF_LOG", "同步日期");
            /// <summary>
			/// 同步时间
			/// </summary>
			public readonly static Field SYNCTIME = new Field("SYNCTIME", "SLT_STAFF_LOG", "同步时间");
        }
        #endregion
	}
}