...
namespace GGZYFW.DbEntity
{
	...
	[Serializable]
	public partial class BD_VIOLATION_RECORD : FwEntity
	{
		#region Model
		private string _ID;
		...
		public class _
		{
			...
			/// 
			/// </summary>
			public readonly static Field RESULT_DATA = new Field("RESULT_DATA", "BD_VIOLATION_RECORD", DbType.AnsiString, null, "");
			/// <summary>
			/// 违规率
			/// </summary>
