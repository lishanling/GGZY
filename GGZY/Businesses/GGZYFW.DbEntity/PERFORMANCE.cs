...
{
    /// <summary>
    /// 实体类PERFORMANCE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("PERFORMANCE")]
    [Serializable]
    public partial class PERFORMANCE : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "PERFORMANCE");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "PERFORMANCE", "");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "PERFORMANCE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "PERFORMANCE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "PERFORMANCE", "统一交易标识码");
            /// <summary>
			/// 履约情况报告名称
			/// </summary>
			public readonly static Field PERFORMANCE_REPORT_NAME = new Field("PERFORMANCE_REPORT_NAME", "PERFORMANCE", "履约情况报告名称");
            /// <summary>
			/// 业主/招标人名称
			/// </summary>
			public readonly static Field TENDERER_NAME = new Field("TENDERER_NAME", "PERFORMANCE", "业主/招标人名称");
            /// <summary>
			/// 业主/招标人代码
			/// </summary>
			public readonly static Field TENDERER_CODE = new Field("TENDERER_CODE", "PERFORMANCE", "业主/招标人代码");
            /// <summary>
			/// 履约人名称
			/// </summary>
			public readonly static Field PERFORMANCE_PARTY_NAME = new Field("PERFORMANCE_PARTY_NAME", "PERFORMANCE", "履约人名称");
            /// <summary>
			/// 履约人代码
			/// </summary>
			public readonly static Field PERFORMANCE_PARTY_CODE = new Field("PERFORMANCE_PARTY_CODE", "PERFORMANCE", "履约人代码");
            /// <summary>
			/// 合同结算金额
			/// </summary>
			public readonly static Field SETTLE_PRICE = new Field("SETTLE_PRICE", "PERFORMANCE", "合同结算金额");
            /// <summary>
			/// 合同完成时间
			/// </summary>
			public readonly static Field FINISH_TIME = new Field("FINISH_TIME", "PERFORMANCE", "合同完成时间");
            /// <summary>
			/// 合同变更内容
			/// </summary>
			public readonly static Field CONTRACT_CHANGE_CONTENT = new Field("CONTRACT_CHANGE_CONTENT", "PERFORMANCE",DbType.AnsiString, null, "合同变更内容");
            /// <summary>
			/// 实际履约期限
			/// </summary>
			public readonly static Field ACTUALLY_PERIOD = new Field("ACTUALLY_PERIOD", "PERFORMANCE", "实际履约期限");
            /// <summary>
			/// 履约内容
			/// </summary>
			public readonly static Field PERFORMANCE_CONTENT = new Field("PERFORMANCE_CONTENT", "PERFORMANCE",DbType.AnsiString, null, "履约内容");
            /// <summary>
			/// 履约报告出具时间
			/// </summary>
			public readonly static Field REPORT_ISSUE_TIME = new Field("REPORT_ISSUE_TIME", "PERFORMANCE", "履约报告出具时间");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "PERFORMANCE", "交易系统标识码");
            /// <summary>
			/// 交易服务系统标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "PERFORMANCE", "交易服务系统标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "PERFORMANCE", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATOR = new Field("M_CREATOR", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "PERFORMANCE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "PERFORMANCE", "");
        }
        #endregion
	}
}