...
{
    /// <summary>
    /// 实体类TENDER_CANDIDATE。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TENDER_CANDIDATE")]
    [Serializable]
    public partial class TENDER_CANDIDATE : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TENDER_CANDIDATE");
            /// <summary>
			/// 招标项目编号
			/// </summary>
			public readonly static Field TENDER_PROJECT_CODE = new Field("TENDER_PROJECT_CODE", "TENDER_CANDIDATE", "招标项目编号");
            /// <summary>
			/// 标段（包）编号
			/// </summary>
			public readonly static Field BID_SECTION_CODE = new Field("BID_SECTION_CODE", "TENDER_CANDIDATE", "标段（包）编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "TENDER_CANDIDATE", "统一交易标识码");
            /// <summary>
			/// 中标候选人名称
			/// </summary>
			public readonly static Field WIN_CANDIDATE_NAME = new Field("WIN_CANDIDATE_NAME", "TENDER_CANDIDATE", "中标候选人名称");
            /// <summary>
			/// 中标候选人类别
			/// </summary>
			public readonly static Field BIDDER_CODE_TYPE = new Field("BIDDER_CODE_TYPE", "TENDER_CANDIDATE", "中标候选人类别");
            /// <summary>
			/// 中标候选人代码
			/// </summary>
			public readonly static Field WIN_CANDIDATE_CODE = new Field("WIN_CANDIDATE_CODE", "TENDER_CANDIDATE", "中标候选人代码");
            /// <summary>
			/// 中标候选人角色
			/// </summary>
			public readonly static Field BIDDER_ROLE = new Field("BIDDER_ROLE", "TENDER_CANDIDATE", "中标候选人角色");
            /// <summary>
			/// 中标候选人排名
			/// </summary>
			public readonly static Field WIN_CANDIDATE_ORDER = new Field("WIN_CANDIDATE_ORDER", "TENDER_CANDIDATE", "中标候选人排名");
            /// <summary>
			/// 是否采用下浮率
			/// </summary>
			public readonly static Field IS_FLOAT_RATE = new Field("IS_FLOAT_RATE", "TENDER_CANDIDATE", "是否采用下浮率");
            /// <summary>
			/// 评分结果
			/// </summary>
			public readonly static Field EVALUATION_RESULT = new Field("EVALUATION_RESULT", "TENDER_CANDIDATE",DbType.AnsiString, null, "评分结果");
            /// <summary>
			/// 投标价格
			/// </summary>
			public readonly static Field BID_PRICE = new Field("BID_PRICE", "TENDER_CANDIDATE", "投标价格");
            /// <summary>
			/// 评标价格
			/// </summary>
			public readonly static Field EVALUATION_PRICE = new Field("EVALUATION_PRICE", "TENDER_CANDIDATE", "评标价格");
            /// <summary>
			/// 中标价格
			/// </summary>
			public readonly static Field WIN_PRICE = new Field("WIN_PRICE", "TENDER_CANDIDATE", "中标价格");
            /// <summary>
			/// 价格币种代码
			/// </summary>
			public readonly static Field PRICE_CURRENCY = new Field("PRICE_CURRENCY", "TENDER_CANDIDATE", "价格币种代码");
            /// <summary>
			/// 价格单位
			/// </summary>
			public readonly static Field PRICE_UINT = new Field("PRICE_UINT", "TENDER_CANDIDATE", "价格单位");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TENDER_CANDIDATE", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TENDER_CANDIDATE", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TENDER_CANDIDATE", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "TENDER_CANDIDATE", "");
            /// <summary>
			/// ID
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "TENDER_CANDIDATE", "ID");
            /// <summary>
			/// ??????
			/// </summary>
			public readonly static Field M_CREATOR = new Field("M_CREATOR", "TENDER_CANDIDATE", "??????");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 其他类型投标报价
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "TENDER_CANDIDATE",DbType.AnsiString, null, "其他类型投标报价");
            /// <summary>
			/// 质量
			/// </summary>
			public readonly static Field QUALITY = new Field("QUALITY", "TENDER_CANDIDATE",DbType.AnsiString, null, "质量");
            /// <summary>
			/// 评标情况
			/// </summary>
			public readonly static Field EVALUATION_STATUS = new Field("EVALUATION_STATUS", "TENDER_CANDIDATE",DbType.AnsiString, null, "评标情况");
            /// <summary>
			/// 中标候选人响应招标文件的资格能力条件
			/// </summary>
			public readonly static Field WIN_CANDIDATE_QUALIFICATION = new Field("WIN_CANDIDATE_QUALIFICATION", "TENDER_CANDIDATE",DbType.AnsiString, null, "中标候选人响应招标文件的资格能力条件");
            /// <summary>
			/// 标注金额单位是否被更新过，1表示更新过
			/// </summary>
			public readonly static Field M_MONEY_UPDATE = new Field("M_MONEY_UPDATE", "TENDER_CANDIDATE", "标注金额单位是否被更新过，1表示更新过");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "TENDER_CANDIDATE", "价款形式代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "TENDER_CANDIDATE", "");
            /// <summary>
			/// 中标候选人人企业注册所在地
			/// </summary>
			public readonly static Field BIDDER_REGION_CODE = new Field("BIDDER_REGION_CODE", "TENDER_CANDIDATE", "中标候选人人企业注册所在地");
            /// <summary>
			/// 中标候选人企业性质
			/// </summary>
			public readonly static Field BIDDER_PROPERTY = new Field("BIDDER_PROPERTY", "TENDER_CANDIDATE", "中标候选人企业性质");
        }
        #endregion
	}
}