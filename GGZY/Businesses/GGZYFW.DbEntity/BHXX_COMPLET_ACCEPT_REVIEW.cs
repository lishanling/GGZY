...
{
    /// <summary>
    /// 实体类BHXX_COMPLET_ACCEPT_REVIEW。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("BHXX_COMPLET_ACCEPT_REVIEW")]
    [Serializable]
    public partial class BHXX_COMPLET_ACCEPT_REVIEW : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "BHXX_COMPLET_ACCEPT_REVIEW");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "BHXX_COMPLET_ACCEPT_REVIEW", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "BHXX_COMPLET_ACCEPT_REVIEW", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "BHXX_COMPLET_ACCEPT_REVIEW", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "BHXX_COMPLET_ACCEPT_REVIEW", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "BHXX_COMPLET_ACCEPT_REVIEW", "");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "BHXX_COMPLET_ACCEPT_REVIEW", "项目编号");
            /// <summary>
			/// 项目名称
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "BHXX_COMPLET_ACCEPT_REVIEW", "项目名称");
            /// <summary>
			/// 项目代码
			/// </summary>
			public readonly static Field INVEST_PROJECT_CODE = new Field("INVEST_PROJECT_CODE", "BHXX_COMPLET_ACCEPT_REVIEW", "项目代码");
            /// <summary>
			/// 竣工验收备案编号
			/// </summary>
			public readonly static Field PROJECT_FINISH_CHECK_NUM = new Field("PROJECT_FINISH_CHECK_NUM", "BHXX_COMPLET_ACCEPT_REVIEW", "竣工验收备案编号");
            /// <summary>
			/// 施工许可证编号
			/// </summary>
			public readonly static Field BUILDER_LICENCE_NUM = new Field("BUILDER_LICENCE_NUM", "BHXX_COMPLET_ACCEPT_REVIEW", "施工许可证编号");
            /// <summary>
			/// 实际造价（万元）
			/// </summary>
			public readonly static Field FACT_COST = new Field("FACT_COST", "BHXX_COMPLET_ACCEPT_REVIEW", "实际造价（万元）");
            /// <summary>
			/// 实际面积（平方米）
			/// </summary>
			public readonly static Field FACT_AREA = new Field("FACT_AREA", "BHXX_COMPLET_ACCEPT_REVIEW", "实际面积（平方米）");
            /// <summary>
			/// 长度（米）
			/// </summary>
			public readonly static Field LENGTH = new Field("LENGTH", "BHXX_COMPLET_ACCEPT_REVIEW", "长度（米）");
            /// <summary>
			/// 跨度（米）
			/// </summary>
			public readonly static Field SPAN = new Field("SPAN", "BHXX_COMPLET_ACCEPT_REVIEW", "跨度（米）");
            /// <summary>
			/// 实际建设规模
			/// </summary>
			public readonly static Field FACT_SIZE = new Field("FACT_SIZE", "BHXX_COMPLET_ACCEPT_REVIEW", "实际建设规模");
            /// <summary>
			/// 结构体系
			/// </summary>
			public readonly static Field PROJECT_STRUCTURE_TYPE_NUM = new Field("PROJECT_STRUCTURE_TYPE_NUM", "BHXX_COMPLET_ACCEPT_REVIEW", "结构体系");
            /// <summary>
			/// 实际开工日期
			/// </summary>
			public readonly static Field BEGIN_DATE = new Field("BEGIN_DATE", "BHXX_COMPLET_ACCEPT_REVIEW", "实际开工日期");
            /// <summary>
			/// 实际竣工验收备案日期
			/// </summary>
			public readonly static Field END_DATE = new Field("END_DATE", "BHXX_COMPLET_ACCEPT_REVIEW", "实际竣工验收备案日期");
            /// <summary>
			/// 备注
			/// </summary>
			public readonly static Field REMARK = new Field("REMARK", "BHXX_COMPLET_ACCEPT_REVIEW", "备注");
            /// <summary>
			/// 信息审核部门
			/// </summary>
			public readonly static Field CHECK_DEPART_NAME = new Field("CHECK_DEPART_NAME", "BHXX_COMPLET_ACCEPT_REVIEW", "信息审核部门");
            /// <summary>
			/// 信息审核人
			/// </summary>
			public readonly static Field CHECK_PERSON_NAME = new Field("CHECK_PERSON_NAME", "BHXX_COMPLET_ACCEPT_REVIEW", "信息审核人");
            /// <summary>
			/// 数据来源
			/// </summary>
			public readonly static Field DATA_SOURCE = new Field("DATA_SOURCE", "BHXX_COMPLET_ACCEPT_REVIEW", "数据来源");
            /// <summary>
			/// 数据等级
			/// </summary>
			public readonly static Field DATA_LEVEL = new Field("DATA_LEVEL", "BHXX_COMPLET_ACCEPT_REVIEW", "数据等级");
        }
        #endregion
	}
}