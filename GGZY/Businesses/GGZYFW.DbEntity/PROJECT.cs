...
namespace GGZYFW.DbEntity
{
    ...
    [Table("PROJECT")]
    [Serializable]
    public partial class PROJECT : FwEntity
    {
        #region Model
		...
		private string _M_PROJECT_APPROVAL_FILE;
		...
		/// 立项批复文件（项目审批核准文件）
		/// </summary>
		public string M_PROJECT_APPROVAL_FILE
		{
			get{ return _M_PROJECT_APPROVAL_FILE; }
			set
			{
				this.OnPropertyValueChange(_.M_PROJECT_APPROVAL_FILE, _M_PROJECT_APPROVAL_FILE, value);
				this._M_PROJECT_APPROVAL_FILE = value;
			}
		}
		/// <summary>
		/// 项目类型
        ...
        public class _
        {
			...
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "PROJECT", "");
            /// <summary>
			/// 立项批复文件（项目审批核准文件）
			/// </summary>
			public readonly static Field M_PROJECT_APPROVAL_FILE = new Field("M_PROJECT_APPROVAL_FILE", "PROJECT", "立项批复文件（项目审批核准文件）");
            /// <summary>
			/// 项目类型
			/// </summary>
			...
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "PROJECT", "");
            /// <summary>
			/// 项目类别关联代码
			/// </summary>
			public readonly static Field RELATE_CODE = new Field("RELATE_CODE", "PROJECT", "项目类别关联代码");
            /// <summary>
			/// 分类版本代码
			/// </summary>
			public readonly static Field CLASS_VER_CODE = new Field("CLASS_VER_CODE", "PROJECT", "分类版本代码");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field TRADE_PLAT = new Field("TRADE_PLAT", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT = new Field("PUB_SERVICE_PLAT", "PROJECT", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "PROJECT", "");
            /// <summary>
			/// 信息录入人员
			/// </summary>
			public readonly static Field OPERATION_NAME = new Field("OPERATION_NAME", "PROJECT", "信息录入人员");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field IS_DELETE = new Field("IS_DELETE", "PROJECT", "");
        }
        #endregion
	}
}