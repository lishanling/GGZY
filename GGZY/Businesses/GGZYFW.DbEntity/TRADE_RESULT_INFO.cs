...
{
    /// <summary>
    /// 实体类TRADE_RESULT_INFO。(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Table("TRADE_RESULT_INFO")]
    [Serializable]
    public partial class TRADE_RESULT_INFO : FwEntity
    {
        #region Model
        ...
        public class _
        {
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*", "TRADE_RESULT_INFO");
            /// <summary>
			/// 项目名称
			/// </summary>
			public readonly static Field PROJECT_NAME = new Field("PROJECT_NAME", "TRADE_RESULT_INFO", "项目名称");
            /// <summary>
			/// 项目编号
			/// </summary>
			public readonly static Field PROJECT_CODE = new Field("PROJECT_CODE", "TRADE_RESULT_INFO", "项目编号");
            /// <summary>
			/// 统一交易标识码
			/// </summary>
			public readonly static Field UNIFIED_DEAL_CODE = new Field("UNIFIED_DEAL_CODE", "TRADE_RESULT_INFO", "统一交易标识码");
            /// <summary>
			/// 交易方式
			/// </summary>
			public readonly static Field EXCHANGE_TYPE = new Field("EXCHANGE_TYPE", "TRADE_RESULT_INFO", "交易方式");
            /// <summary>
			/// 受让方名称
			/// </summary>
			public readonly static Field SELLER_NAME = new Field("SELLER_NAME", "TRADE_RESULT_INFO", "受让方名称");
            /// <summary>
			/// 受让方代码
			/// </summary>
			public readonly static Field SELLER_CODE = new Field("SELLER_CODE", "TRADE_RESULT_INFO", "受让方代码");
            /// <summary>
			/// 受让方类别
			/// </summary>
			public readonly static Field SELLER_TYPE = new Field("SELLER_TYPE", "TRADE_RESULT_INFO", "受让方类别");
            /// <summary>
			/// 受让方角色
			/// </summary>
			public readonly static Field SELLER_ROLE = new Field("SELLER_ROLE", "TRADE_RESULT_INFO", "受让方角色");
            /// <summary>
			/// 转让标的评估值或账面净值
			/// </summary>
			public readonly static Field OBJECT_EVALUATE_VALUE = new Field("OBJECT_EVALUATE_VALUE", "TRADE_RESULT_INFO", "转让标的评估值或账面净值");
            /// <summary>
			/// 成交金额
			/// </summary>
			public readonly static Field TRADE_VALUE = new Field("TRADE_VALUE", "TRADE_RESULT_INFO", "成交金额");
            /// <summary>
			/// 成交日期
			/// </summary>
			public readonly static Field TRADE_DATE = new Field("TRADE_DATE", "TRADE_RESULT_INFO", "成交日期");
            /// <summary>
			/// 在交易机构网站进行挂牌信息披露的链接
			/// </summary>
			public readonly static Field PROJECT_URL = new Field("PROJECT_URL", "TRADE_RESULT_INFO", "在交易机构网站进行挂牌信息披露的链接");
            /// <summary>
			/// 交易系统标识码
			/// </summary>
			public readonly static Field PLATFORM_CODE = new Field("PLATFORM_CODE", "TRADE_RESULT_INFO", "交易系统标识码");
            /// <summary>
			/// 公共服务平台标识码
			/// </summary>
			public readonly static Field PUB_SERVICE_PLAT_CODE = new Field("PUB_SERVICE_PLAT_CODE", "TRADE_RESULT_INFO", "公共服务平台标识码");
            /// <summary>
			/// 数据时间戳
			/// </summary>
			public readonly static Field DATA_TIMESTAMP = new Field("DATA_TIMESTAMP", "TRADE_RESULT_INFO", "数据时间戳");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_KEY = new Field("M_KEY", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_DATA_SOURCE = new Field("M_DATA_SOURCE", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_TM = new Field("M_TM", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 成交金额币种代码
			/// </summary>
			public readonly static Field CURRENCY_CODE = new Field("CURRENCY_CODE", "TRADE_RESULT_INFO", "成交金额币种代码");
            /// <summary>
			/// 成交金额单位
			/// </summary>
			public readonly static Field PRICE_UNIT = new Field("PRICE_UNIT", "TRADE_RESULT_INFO", "成交金额单位");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_ID = new Field("M_ID", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_IS_HISTORY = new Field("M_IS_HISTORY", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATEBY = new Field("M_CREATEBY", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_CREATE_TM = new Field("M_CREATE_TM", "TRADE_RESULT_INFO", "");
            /// <summary>
			/// 实际打款日期
			/// </summary>
			public readonly static Field M_ACTUAL_TM = new Field("M_ACTUAL_TM", "TRADE_RESULT_INFO", "实际打款日期");
            /// <summary>
			/// 是否分期付款
			/// </summary>
			public readonly static Field M_IS_INSTALMENT = new Field("M_IS_INSTALMENT", "TRADE_RESULT_INFO", "是否分期付款");
            /// <summary>
			/// 首付款金额
			/// </summary>
			public readonly static Field M_DOWN_PAY = new Field("M_DOWN_PAY", "TRADE_RESULT_INFO", "首付款金额");
            /// <summary>
			/// 首付款金额单位
			/// </summary>
			public readonly static Field M_DOWN_UNIT = new Field("M_DOWN_UNIT", "TRADE_RESULT_INFO", "首付款金额单位");
            /// <summary>
			/// 附件
			/// </summary>
			public readonly static Field M_ATTACHMENT = new Field("M_ATTACHMENT", "TRADE_RESULT_INFO", "附件");
            /// <summary>
			/// 组织签约ID
			/// </summary>
			public readonly static Field M_PRE_ID = new Field("M_PRE_ID", "TRADE_RESULT_INFO", "组织签约ID");
            /// <summary>
			/// 标的编号
			/// </summary>
			public readonly static Field BID_CODE = new Field("BID_CODE", "TRADE_RESULT_INFO", "标的编号");
            /// <summary>
			/// 标的名称
			/// </summary>
			public readonly static Field BID_NAME = new Field("BID_NAME", "TRADE_RESULT_INFO", "标的名称");
            /// <summary>
			/// 标的所在行政区域代码
			/// </summary>
			public readonly static Field REGION_CODE = new Field("REGION_CODE", "TRADE_RESULT_INFO", "标的所在行政区域代码");
            /// <summary>
			/// 交易发生行政区域代码
			/// </summary>
			public readonly static Field TRA_PLACE_CODE = new Field("TRA_PLACE_CODE", "TRADE_RESULT_INFO", "交易发生行政区域代码");
            /// <summary>
			/// 交易机构名称
			/// </summary>
			public readonly static Field TRA_AGENCY_NAME = new Field("TRA_AGENCY_NAME", "TRADE_RESULT_INFO", "交易机构名称");
            /// <summary>
			/// 交易机构代码
			/// </summary>
			public readonly static Field TRA_AGENCY_CODE = new Field("TRA_AGENCY_CODE", "TRADE_RESULT_INFO", "交易机构代码");
            /// <summary>
			/// 价款形式代码
			/// </summary>
			public readonly static Field PRICE_FORM_CODE = new Field("PRICE_FORM_CODE", "TRADE_RESULT_INFO", "价款形式代码");
            /// <summary>
			/// 其它类型成交结果
			/// </summary>
			public readonly static Field OTHER_BID_PRICE = new Field("OTHER_BID_PRICE", "TRADE_RESULT_INFO", "其它类型成交结果");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field M_VERSION = new Field("M_VERSION", "TRADE_RESULT_INFO", "");
        }
        #endregion
	}
}