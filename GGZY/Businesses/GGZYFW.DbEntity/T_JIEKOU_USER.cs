...
namespace GGZYFW.DbEntity
{
    ...
    [Table("T_JIEKOU_USER")]
    [Serializable]
    public partial class T_JIEKOU_USER : FwEntity
    {
        #region Model
		private decimal? _ID;
		...
		public string IS_TRANS
		{
			...
			set
			{
				this.OnPropertyValueChange(_.IS_TRANS, _IS_TRANS, value);
        ...
        public class _
        {
			...
			/// 是否转2.0上报，1表示已启用2.0上报
			/// </summary>
			public readonly static Field IS_TRANS = new Field("IS_TRANS", "T_JIEKOU_USER", "是否转2.0上报，1表示已启用2.0上报");
        }
        #endregion
	}
}