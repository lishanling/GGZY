...
namespace GGZY.JianDu.Controllers
{
    ...
    /// 异议处理结果备案
    /// </summary>
    public partial class JdRecordHandleResultController
    {
        /// <summary>
        /// 保存或提交
        /// </summary>
        ...
        /// <returns></returns>
        [ValidateInput(false)]
        public ActionResult SaveOrSubmit(RECORD_REVIEW review, RECORD_HANDLE_RESULT record_biddoc,
            List<UploadResData_ReviewRequest> attachments)
        {
            ...
            var data = Jd.RecordHandleResultService.SaveOrSubmit(tender_project, review, record_biddoc, attachments);
            return JResult(data);
        }
    }
}