...
{
    public partial class JdRecordContractController
    {
        /// <summary>
        /// 保存或提交
        /// </summary>
        ...
        /// <returns></returns>
        [ValidateInput(false)]
        public ActionResult SaveOrSubmit(RECORD_REVIEW review, RECORD_CONTRACT record_biddoc,
            List<UploadResData_ReviewRequest> attachments)
        {
            ...
            var data = Jd.RecordContractService.SaveOrSubmit(tender_project, review, record_biddoc, attachments);
            return JResult(data);
        }
    }
}