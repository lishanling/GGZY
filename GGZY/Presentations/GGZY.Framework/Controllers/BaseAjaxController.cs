...
namespace GGZY.Framework.Controllers
{
    ...
    /// 基础Controller
    /// </summary>
    public partial class BaseAjaxController : Controller
    {
        #region Properties
        /// <summary>
        /// 身份认证管理器
        ...
        protected bool IsJdRequest =>
            ...
            Request.RawUrl?.IndexOf("jdportal", StringComparison.CurrentCultureIgnoreCase) > -1 ||//测试环境门户二级站点路径
            Request.RawUrl?.IndexOf("bigdata", StringComparison.CurrentCultureIgnoreCase) > -1 ||//大数据
            Request.RawUrl?.IndexOf("/jd/", StringComparison.CurrentCultureIgnoreCase) > -1;//测试站点后台二级站点路径
        ...
        protected bool IsFwRequest =>
            ...
            Request.RawUrl?.IndexOf("fwportal", StringComparison.CurrentCultureIgnoreCase) > -1 ||//测试环境门户二级站点路径
            Request.RawUrl?.IndexOf("/fw/", StringComparison.CurrentCultureIgnoreCase) > -1;//测试站点后台二级站点路径
